...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[530,0,498,813],[1686,0,408,732],[1030,511,544,357],[0,876,2376,129],[2378,485,376,497],[0,0,528,874],[2096,0,607,483],[1030,0,654,509]]},
		{name:"index_atlas_P_3", frames: [[377,0,2377,64],[2397,752,80,80],[377,66,2377,64],[1336,768,80,80],[377,132,2377,64],[1703,656,81,80],[1786,656,81,80],[377,198,2377,64],[1620,656,81,81],[848,746,80,81],[377,264,2377,64],[1499,768,79,79],[1418,768,79,80],[2240,330,287,323],[1935,330,303,322],[685,330,316,414],[2831,438,30,28],[2831,417,51,19],[930,746,69,77],[2397,655,74,95],[0,650,210,171],[2693,588,131,197],[1003,645,241,154],[2256,655,139,157],[0,497,321,151],[2831,166,46,175],[685,746,161,100],[2083,743,141,142],[2693,330,136,256],[2784,324,25,4],[2784,311,24,11],[2831,343,52,39],[2756,311,26,12],[1003,330,366,313],[0,0,375,495],[2863,438,23,21],[2831,384,33,31],[1935,655,319,86],[1620,743,316,86],[1620,330,313,324],[2756,166,63,143],[1246,645,88,171],[2756,0,120,164],[377,330,306,445],[1371,330,247,436],[212,650,139,177],[2529,330,162,517],[1938,743,143,143]]}
];
...
(lib.CampanaNotificacion = function() {
	this.initialize(ss["index_atlas_P_3"]);
	this.gotoAndStop(27);
}).prototype = p = new cjs.Sprite();
...
(lib.ojos_p = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_2
	this.instance = new lib.CejaPinocho();
	this.instance.setTransform(12,-9,0.5,0.5);

	this.instance_1 = new lib.CejaPinocho();
	this.instance_1.setTransform(-7,-7,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1,p:{y:-7}},{t:this.instance,p:{y:-9}}]}).to({state:[{t:this.instance_1,p:{y:-7}},{t:this.instance,p:{y:-9}}]},44).to({state:[{t:this.instance_1,p:{y:-7}},{t:this.instance,p:{y:-9}}]},3).to({state:[{t:this.instance_1,p:{y:-6}},{t:this.instance,p:{y:-8}}]},3).wait(3));

	// Capa_9
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhJAtIgHAAIALAAIgEAAgAhxgJQAAgFACgBIADgBIACgDIAAgGIABgEIAEgCIADgDIABgFQABgCADgBQAEgDADABQADACAAAGIAAAEIABAAIAJgBQAOgBAHAEQAGAEAEAGQADACADAEIABAFQgrABgeADIgFABgAAsgPIAGgOQAEgJAFgDQACgBAIAAQAJgBAFABQAJACACAHQAHABAFAFIADAGIAFAKIAAABIhIABIACgGg");
	this.shape.setTransform(11.3875,4.525);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhGAaIgoAAIgEAAIAAgRQAAgEACgBIAEgBIABgDIABgGIABgEIADgCIADgDIACgFQAAgCADgBQAFgDADACQACABAAAGIAAAFIABgBIAJgBQAOgBAIAEQAFAEAEAGQAEABACAFIADAMIgBAGIgXAAIgJABIgDACIAAAAgAApAXIgDAAQABgHAFgMIAFgOQAEgJAFgCQACgBAIAAQAJgBAGABQAIACACAGQAHABAFAFIAEAGIAEAJIABANIAAADg");
	this.shape_1.setTransform(11.45,2.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(11.45,4.5516);
...
p.nominalBounds = new cjs.Rectangle(-7,-9,32,18.1);


(lib.ojos_a = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(5.2762,-6.285);

	// Capa_2
	this.instance = new lib.Ceja_1();
	this.instance.setTransform(12,-12,0.5,0.5);

	this.instance_1 = new lib.Ceja_1();
	this.instance_1.setTransform(-8,-10,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1,p:{y:-10}},{t:this.instance,p:{y:-12}}]}).to({state:[{t:this.instance_1,p:{y:-11}},{t:this.instance,p:{y:-13}}]},44).to({state:[{t:this.instance_1,p:{y:-10}},{t:this.instance,p:{y:-12}}]},3).wait(3));

	// Capa_8
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(12.825,5.4186);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Ah1ApIAKABQAKAAATADIAIABQgEACgJAAQgXAAgLgHgABWAFIgHAAIgTgCIgMAAQACgNANgHIAGgEIAEgEQADgDAFgBQALgCAIAGIAIAIIALAJQAHAHABAEIAAAEgAhxgSQgHgBgGABIABgDQADgHADgDQAGgEAFAAQABgHAIgEQADgBAJABIAMABIALADQAKAFAEAJIACAFIACAEQACAEABAHg");
	this.shape_1.setTransform(12.95,4.78);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAwAhIAAgBIABgYQADgOANgHIAFgDIAEgEQAEgDAFgCQALgBAHAGIAJAIIAKAJQAHAFABAFIAAAWIgCAJIgCAFIhMgKgAhAAWIg4AAIgHAAIAAgWIABgKIACgHQADgGAEgDQAFgFAFAAQACgHAHgDQAEgCAIABIAMACIAMADQAJAFAEAJIACAEIADAFQADAFgBANIgCAMIgBAGIgTAAg");
	this.shape_2.setTransform(12.825,4.33);
...
p.nominalBounds = new cjs.Rectangle(-8,-10.7,33.7,21.6);
...
if (reversed == null) { reversed = false; }
	...
	// mensajes
	this.instance = new lib.MensajePinocho();
	this.instance.setTransform(-75.5,-393.25,0.5,0.5);

	this.instance_1 = new lib.FotoPinocho_1();
	this.instance_1.setTransform(-92,-48,0.5,0.5);

	this.instance_2 = new lib.FotoAurora_1();
	this.instance_2.setTransform(-101,181,0.5,0.5);

	this.instance_3 = new lib.MensajePinocho();
	this.instance_3.setTransform(-73.5,-141.25,0.5,0.5);

	this.instance_4 = new lib.MensajeAurora();
	this.instance_4.setTransform(-72.5,-83.25,0.5,0.5);

	this.instance_5 = new lib.MensajePinocho();
	this.instance_5.setTransform(-74.5,-269.25,0.5,0.5);

	this.instance_6 = new lib.MensajeAurora();
	this.instance_6.setTransform(-73.5,-211.25,0.5,0.5);

	this.instance_7 = new lib.MensajeAurora();
	this.instance_7.setTransform(-74.5,-335.25,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mensajes, new cjs.Rectangle(-101,-393.2,197,821.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-80.25,-37.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-80.2,-37.7,160.5,75.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-52.5,-42.75,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CampanaNotificacion();
	this.instance.setTransform(-35.25,-35.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-35.2,-35.5,70.5,71);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PiernaAurora();
	this.instance.setTransform(-22,-50.25,0.5,0.5877);
...
p.nominalBounds = new cjs.Rectangle(-22,-50.2,44,100.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PiernaAurora();
	this.instance.setTransform(-22,-42.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-22,-42.7,44,85.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PiernaPinocho();
	this.instance.setTransform(-30,-41,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-30,-41,60,82);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-40.25,-25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-40.2,-25,80.5,50);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.BrazoDer_2_1();
	this.instance.setTransform(-60.25,-38.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-60.2,-38.5,120.5,77);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.BrazoDer_2();
	this.instance.setTransform(-124.5,-203.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-124.5,-203.2,249,406.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ViñetaGeppeto();
	this.instance.setTransform(145,-117.75,0.4434,0.4626,0,0,180);
...
p.nominalBounds = new cjs.Rectangle(-145,-117.7,290,235.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Cejag();
	this.instance.setTransform(27.5,-9.75,0.5,0.5,0,0,180);

	this.instance_1 = new lib.Cejag();
	this.instance_1.setTransform(-27.5,-9.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-27.5,-9.7,55,19.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-17.25,-19.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-17.2,-19.2,34.5,38.5);


(lib.Interpolación31_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance_1 = new lib.FondoBusNube();
	this.instance_1.setTransform(-138.75,-111.75,0.5,0.5);

	this.instance_2 = new lib.Nube();
	this.instance_2.setTransform(-151.75,-120.75,0.5,0.5);
...
(lib.Interpolación30_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance_1 = new lib.Ubicación();
	this.instance_1.setTransform(-10.25,-10.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-10.2,-10.2,71.5,71.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-34.75,-39.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-34.7,-39.2,69.5,78.5);


(lib.Interpolación18_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.AlaDerecha();
	this.instance.setTransform(-71.75,-80.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-71.7,-80.7,143.5,161.5);


(lib.Interpolación16_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.AlaIzqpng();
	this.instance.setTransform(-75.75,-80.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-75.7,-80.5,151.5,161);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_1 = new lib.Pendulo();
	this.instance_1.setTransform(-15.75,-35.75,0.5,0.5);
...
(lib.Interpolación1_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance_2 = new lib.Ceja();
	this.instance_2.setTransform(-6.25,-1,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-6.2,-1,12.5,2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(16.5,6.25);

	this.instance_2 = new lib.Interpolación23("synched",0);
	this.instance_2.setTransform(17.35,6.25);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E79782").s().p("AgOATIgLgDQgJACgFAAQgFgBgDgGQgDgFAAgGQAAgHAEgHQAEgGAGgCQAHgCAQAEQAQAFAPAAIANAAQAHABAFADQAJAGgBAJQAAAKgKAGQgFADgOAAQgXAAgNgEg");
	this.shape.setTransform(28.555,8.1545);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_2},{t:this.instance_1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo2_1, new cjs.Rectangle(-1,-1,35.3,14.6), null);
...
(lib.Interpolación30_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-25.75,-44.25,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(80));

	// Brazo.png
	this.instance_1 = new lib.Interpolación1("synched",0);
	this.instance_1.setTransform(-12.3,4.8,1,1,0,0,0,14.2,-5.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:14.9992},39).to({rotation:0},40).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-48.9,-44.2,92.69999999999999,88.5);


(lib.ojos_g = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(19.3979,-12.8397);

	// Capa_2
	this.instance = new lib.Cejag();
	this.instance.setTransform(51,-24,0.5,0.5,0,0,180);

	this.instance_1 = new lib.Cejag();
	this.instance_1.setTransform(-4,-24,0.5,0.5);

	this.instance_2 = new lib.Interpolación2("synched",0);
	this.instance_2.setTransform(23.5,-14.25);
	this.instance_2._off = true;

	this.instance_3 = new lib.Interpolación4("synched",0);
	this.instance_3.setTransform(23.5,-12.25);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.instance_2}]},42).to({state:[{t:this.instance_3}]},7).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(42).to({_off:false},0).to({_off:true,y:-12.25},7).wait(1));

	// Capa_5
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(22.025,5.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(21.975,5.1278);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(22.4535,5.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[]},2).to({state:[{t:this.shape_1}]},41).to({state:[{t:this.shape_2}]},3).to({state:[{t:this.shape}]},3).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-4,-24,50.7,34.8);
...
if (reversed == null) { reversed = false; }
	...
	// ojos_g
	this.instance = new lib.ojos_g();
	this.instance.setTransform(144,65.4,1,1,0,0,0,22,5.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50));

	// BrazoIzq_1.png
	this.instance_1 = new lib.Interpolación34("synched",0);
	this.instance_1.setTransform(198.25,131.75,1,1,0,0,0,68,-25);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:6.7175},24).to({rotation:0},25).wait(1));

	// Geppeto.png
	this.instance_2 = new lib.Geppeto();
	this.instance_2.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(50));

	// BrazoDer.png
	this.instance_3 = new lib.Interpolación33("synched",0);
	this.instance_3.setTransform(130.3,118.95,1,1,0,0,0,33.8,-34.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regY:-34.7,rotation:6.7175,x:132.25,y:116.2},24).to({regY:-34.8,rotation:0,x:130.3,y:118.95},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,264,437);
...
if (reversed == null) { reversed = false; }
	...
	// RuedaBus.png
	this.instance = new lib.Interpolación30_1("synched",0);
	this.instance.setTransform(10.25,10.25);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-4.75},39).to({y:10.25},40).to({y:-4.75},40).to({y:10.25},40).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-15,71.5,86.5);
...
if (reversed == null) { reversed = false; }
	...
	// ruedas2
	this.instance = new lib.ruedas2();
	this.instance.setTransform(127.55,-59.4,1,1,0,0,0,10.2,10.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(200));

	// Bus.png
	this.instance_1 = new lib.Fiscalia();
	this.instance_1.setTransform(17,-30,0.3658,0.3658);
...
p.nominalBounds = new cjs.Rectangle(17,-69.6,171.9,154.1);
...
(lib.constante_pinocho = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(56.25,108.5,1,1,0,0,0,-49,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:-5.4927,x:56.3},24).to({rotation:0,x:56.25},25).wait(1));
	...
	this.instance_2.setTransform(114.05,115,1,1,0,0,0,-23.2,4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-5.4927,x:114.4,y:109.45},24).to({rotation:0,x:114.05,y:115},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,179.6,222.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(95.85,199.55,1.2018,1.313,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:182.2},24).to({y:199.55},25).to({y:153.05},50).to({y:199.55},125).wait(1));

	// mascara_celular (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-105.375,3.15);

	// mensajes
	this.instance_1 = new lib.mensajes();
	this.instance_1.setTransform(-107.5,252.25);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:181.25},24).wait(25).to({y:-8.75},50).wait(126));

	// Celular.png
	this.instance_2 = new lib.Celular();
	this.instance_2.setTransform(-208,-180,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-208,-180,453.4,646.3);


(lib.ceja = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-22.875,0.7211);

	// Capa_1 copia copia
	this.instance = new lib.Interpolación1_2("synched",0);
	this.instance.setTransform(-23.55,1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-0.05},24).to({y:1},25).wait(1));

	// Capa_1 copia
	this.instance_1 = new lib.Interpolación1_2("synched",0);
	this.instance_1.setTransform(6.25,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:0},24).to({y:1},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-29.7,-1,42.2,3);
...
if (reversed == null) { reversed = false; }
	...
	// ojos_a
	this.instance = new lib.ojos_a();
	this.instance.setTransform(125.5,59.6,1,1,0,0,0,12.8,5.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50));

	// CampanaNotificacion.png
	this.instance_1 = new lib.Interpolación31("synched",0);
	this.instance_1.setTransform(171.25,115.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({y:109.5},12).to({y:115.5},12).to({y:109.5},12).to({y:115.5},12).wait(1));

	// BrazoDer_1.png
	this.instance_2 = new lib.BrazoDer_1_1();
	this.instance_2.setTransform(73,93,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(50));

	// Aurora_1.png
	this.instance_3 = new lib.Boca();
	this.instance_3.setTransform(109,70,0.5,0.5);

	this.instance_4 = new lib.Aurora_1();
	...
	this.instance_5.setTransform(111,188.95,1,1,0,0,0,-22,-42.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({rotation:-14.9992,x:110.95},24).to({rotation:0,x:111},25).wait(1));

	// PiernaAurora.png
	this.instance_6 = new lib.Interpolación30("synched",0);
	this.instance_6.setTransform(136,181.05,1,1,0,0,0,-22,-50.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({rotation:14.9992},24).to({rotation:0},25).wait(1));

	// BrazoIzq_2.png
	this.instance_7 = new lib.BrazoIzq_2();
	this.instance_7.setTransform(106,93,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,206.5,289.5);
...
if (reversed == null) { reversed = false; }
	...
	// AlaIzq.png  
	this.instance = new lib.Interpolación16_1("synched",0);
	this.instance.setTransform(46.85,24.7,1,1,0,0,0,-25,21);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-24.9,rotation:-9.1877,x:46.95,y:24.75},24).to({regX:-25,rotation:0,x:46.85,y:24.7},25).wait(1));

	// AlaDerecha.png
	this.instance_1 = new lib.Interpolación18_1("synched",0);
	this.instance_1.setTransform(-58.15,20.95,1,1,0,0,0,18,17);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:17.9,rotation:7.9445,x:-58.2},24).to({regX:18,rotation:0,x:-58.15},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-155.8,-91.5,311.70000000000005,183.1);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_1 = new lib.Interpolación30_2("synched",0);
	this.instance_1.setTransform(7.9,4.75);

	this.instance_2 = new lib.Interpolación32("synched",0);
	this.instance_2.setTransform(7.3,4.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo1_1, new cjs.Rectangle(-1,-1,17.9,11.5), null);


(lib.nariz = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(0.85,7.1,0.8629,0.7684,0,15.3982,-164.6015,15.5,9.5);

	this.instance_1 = new lib.Símbolo2_1();
	this.instance_1.setTransform(2.05,7.2,0.709,0.7544,0,15.6062,-164.3932,31.9,12.8);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,regX:31.9,regY:12.8,scaleX:0.709,scaleY:0.7544,skewX:15.6062,skewY:-164.3932,x:2.05,y:7.2},6).wait(44));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},6).to({regX:32,regY:12.5,scaleX:1.3201,skewX:11.6108,skewY:-168.3893,x:2.7,y:7.6},18).to({x:2.05,y:7.15},5).wait(21));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-0.8,-2.9,47.5,19.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ceja();
	this.instance.setTransform(10.2,-77,1,1,0,0,0,6.2,1);

	this.instance_1 = new lib.Silueta6();
	this.instance_1.setTransform(-45.75,-121.75,0.5,0.5);

	this.instance_2 = new lib.Interpolación23_1("synched",0);
	this.instance_2.setTransform(17,-18,1,1,0,0,0,-29,17.5);

	this.instance_3 = new lib.BrazoDer();
	this.instance_3.setTransform(-59.75,-20.75,0.5,0.5);

	this.instance_4 = new lib.PeloAtras();
	this.instance_4.setTransform(-81.75,-136.75,0.5,0.5);

	this.instance_5 = new lib.alas();
	this.instance_5.setTransform(0.15,-30.95);
...
p.nominalBounds = new cjs.Rectangle(-147.7,-136.7,295.5,273.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:102.55,alpha:1},24).to({y:106.3},25).to({y:101.8},25).to({y:106.3},25).to({y:101.8},25).to({y:106.3},25).to({y:101.8},25).to({y:106.3},25).to({y:101.8},25).wait(1));

	// MergedLayer_1
	this.instance_1 = new lib.Interpolación31_1("synched",0);
	this.instance_1.setTransform(43.75,95.75);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1},24).to({y:99.75},200).wait(1));

	// Capa_4 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AqgKiQkYkYABmKQgBmJEYkXQEXkYGJABQGKgBEYEYQEWEXABGJQgBGKkWEYQkYEWmKABQmJgBkXkWg");
	mask.setTransform(-305.35,37.55);

	// celular
	this.celular = new lib.celular();
	this.celular.name = "celular";
	this.celular.setTransform(-256.05,32.35,0.4701,0.3858);
	this.celular.alpha = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.celular).to({alpha:1},24).wait(201));

	// biñeta
	this.instance_2 = new lib.Interpolación6("synched",0);
	this.instance_2.setTransform(-333,52.75);
	this.instance_2.alpha = 0;

	this.instance_3 = new lib.Interpolación7("synched",0);
	this.instance_3.setTransform(-333,52.75);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true,alpha:1},24).wait(201));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:false},24).to({startPosition:0},200).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-478,-65,673.5,285.5);


(lib.hada_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0},49).wait(1));
...
(lib.hada = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// hada_2
	this.hada_2 = new lib.hada_2();
	this.hada_2.name = "hada_2";

	this.timeline.addTween(cjs.Tween.get(this.hada_2).to({y:-9},49).to({y:0},50).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-147.7,-145.7,295.5,282.5);
...
if (reversed == null) { reversed = false; }
	...
	// ojos_p
	this.instance = new lib.ojos_p();
	this.instance.setTransform(112.1,52.75,1,1,0,0,0,11.5,4.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50));

	// nariz
	this.nariz = new lib.nariz();
	this.nariz.name = "nariz";
	this.nariz.setTransform(133.1,64.1,1,1,0,0,0,23.2,6.3);

	this.timeline.addTween(cjs.Tween.get(this.nariz).wait(50));

	// constante_pinocho
	this.instance_1 = new lib.constante_pinocho();
	this.instance_1.setTransform(88.8,111.2,1,1,0,0,0,88.8,111.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50));

	// PiernaPinocho.png
	this.instance_2 = new lib.Interpolación27("synched",0);
	this.instance_2.setTransform(107,204,1,1,0,0,0,-30,-41);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-29.9992,x:106.95},24).to({rotation:0,x:107},25).wait(1));

	// PiernaPinocho.png
	this.instance_3 = new lib.Interpolación28("synched",0);
	this.instance_3.setTransform(138,184,1,1,0,0,0,-30,-41);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:-29.9,rotation:14.9992,x:138.05,y:184.05},24).to({regX:-30,rotation:0,x:138,y:184},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,199.9,286);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_4 = function() {
		...
		*/
		_this.hada.hada_2.gotoAndPlay(1);
	}
	this.frame_5 = function() {
	...
	this.frame_7 = function() {
		...
		_this.mensaje_mc.gotoAndPlay(1);
			_this.mensaje_mc.celular.gotoAndPlay(1);
	...
	this.btnInteraccion.setTransform(512.6,365.15,1,1,0,0,0,-21.1,7.5);
	...
	this.mensaje_mc.setTransform(810.5,171.5,1,1,0,0,0,67.5,96);
	this.mensaje_mc._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mensaje_mc).wait(7).to({_off:false},0).wait(2));
	...
	this.geppetto.setTransform(1040.05,346.65,1,1,0,0,0,129.5,217.2);

	this.timeline.addTween(cjs.Tween.get(this.geppetto).wait(9));

	// pinocho
	this.instance_7 = new lib.BocaPinocho();
	this.instance_7.setTransform(252,292,0.5,0.5);

	this.pinocho = new lib.pinocho();
	this.pinocho.name = "pinocho";
	this.pinocho.setTransform(267.8,362,1,1,0,0,0,111.8,143);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.pinocho},{t:this.instance_7}]}).wait(9));

	// aurora
	this.aurora = new lib.aurora();
	this.aurora.name = "aurora";
	this.aurora.setTransform(482.8,364.8,1,1,0,0,0,102.8,140.8);

	this.timeline.addTween(cjs.Tween.get(this.aurora).wait(9));

	// hada
	this.hada = new lib.hada();
	this.hada.name = "hada";
	this.hada.setTransform(758.4,197.15,1.3429,1.3293);

	this.timeline.addTween(cjs.Tween.get(this.hada).to({_off:true},5).wait(4));

	// fondo
	this.instance_8 = new lib.pepe();
	this.instance_8.setTransform(55.45,343.9,1,1,0,0,180);

	this.instance_9 = new lib.reloj_1();
	this.instance_9.setTransform(92.1,124.95,0.8057,0.8057,0,0,0,77.8,-10);

	this.instance_10 = new lib.candelabro();
	this.instance_10.setTransform(676.55,65.15);

	this.instance_11 = new lib.Fondo();
	this.instance_11.setTransform(0,-7,0.5008,0.5053);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]}).wait(9));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1692075395454", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1692075395454", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1692075395455", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1692075395645", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1692075395645", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1692075395645", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1692075395645", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1692075395645", id:"Voice4"},
		{src:"sounds/interaccion.mp3?1692075395645", id:"interaccion"},
		{src:"sounds/intro.mp3?1692075395645", id:"intro"},
		{src:"sounds/BGM.mp3?1692075395645", id:"BGM"}
	],
	preloads: []
};
