...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,1007,2377,80],[0,876,2376,129],[0,0,528,874]]},
		{name:"index_atlas_P_3", frames: [[0,0,2377,80],[1647,1110,221,47],[874,1063,80,80],[0,82,2377,80],[2037,1084,188,68],[956,1063,80,80],[0,164,2377,80],[1550,885,173,223],[508,1064,81,80],[709,1063,81,80],[1370,738,116,144],[0,246,2377,80],[2227,1076,81,81],[792,1063,80,81],[1488,738,128,110],[0,328,2377,80],[1119,1063,79,79],[1038,1063,79,80],[1227,1038,194,104],[0,410,2377,80],[1725,885,172,223],[0,492,2377,80],[318,1064,188,67],[0,574,2377,80],[1423,1110,222,47],[0,656,2377,80],[938,738,287,323],[633,738,303,322],[0,738,316,414],[2170,1076,45,6],[2628,488,30,28],[2474,1137,51,19],[2474,1058,69,77],[633,1063,74,95],[2628,675,210,171],[2037,885,131,197],[2628,519,241,154],[2170,917,139,157],[1227,885,321,151],[2840,675,46,175],[2311,1051,161,100],[1227,738,141,142],[1899,885,136,256],[2660,488,25,4],[318,1133,24,11],[2628,447,52,39],[318,1146,26,12],[2527,1137,23,21],[2851,0,33,31],[318,738,313,324],[2311,738,63,143],[2474,885,88,171],[2311,885,120,164],[2379,0,306,445],[2379,447,247,436],[2687,0,162,517],[2170,738,139,177]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(306,208,0.5,0.5);

	this.instance_1 = new lib._8();
	this.instance_1.setTransform(311,169,0.5,0.5);

	this.instance_2 = new lib._7();
	this.instance_2.setTransform(311,82,0.5,0.5);

	this.instance_3 = new lib._6();
	this.instance_3.setTransform(272,38,0.5,0.5);

	this.instance_4 = new lib._5();
	this.instance_4.setTransform(222,0,0.5,0.5);

	this.instance_5 = new lib._4();
	this.instance_5.setTransform(85,13,0.5,0.5);

	this.instance_6 = new lib._3_2();
	this.instance_6.setTransform(22,82,0.5,0.5);

	this.instance_7 = new lib._2_2();
	this.instance_7.setTransform(13,174,0.5,0.5);

	this.instance_8 = new lib._1_2();
	this.instance_8.setTransform(0,213,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo5, new cjs.Rectangle(0,0,417,236.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#FF9737","#C1912A","#D9C3A3","#E9B817","#000000"],[0,0.655,0.953,1,1],0,0,0,0,0,73.4).s().p("AntIGQjRjRgEktQgEkqDNjXQDMjWElgEQEkgEDSDSQDRDRAEEtQAEEqjNDXQjMDWklAEIgJAAQkeAAjPjOg");
	this.shape.setTransform(0.0009,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.luz, new cjs.Rectangle(-70.7,-72.4,141.4,144.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1.45,-14.25,1.0252,1.0252,0,0,0,207.1,103.4);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:208.5,regY:118.2,scaleX:1.0287,scaleY:1.0287,x:0.05,y:1,alpha:0.125},0).wait(1).to({scaleX:1.0322,scaleY:1.0322,y:1.05,alpha:0.25},0).wait(1).to({scaleX:1.0357,scaleY:1.0357,y:1.1,alpha:0.375},0).wait(1).to({scaleX:1.0392,scaleY:1.0392,y:1.2,alpha:0.5},0).wait(1).to({scaleX:1.0448,scaleY:1.0448,y:1.25,alpha:0.6},0).wait(1).to({scaleX:1.0504,scaleY:1.0504,y:1.3,alpha:0.7},0).wait(1).to({scaleX:1.0559,scaleY:1.0559,y:1.4,alpha:0.8},0).wait(1).to({scaleX:1.0615,scaleY:1.0615,x:0.1,y:1.45,alpha:0.9},0).wait(1).to({scaleX:1.0671,scaleY:1.0671,y:1.6,alpha:1},0).wait(1).to({scaleX:1.0598,scaleY:1.0598,x:0.05,y:1.45},0).wait(1).to({scaleX:1.0525,scaleY:1.0525,y:1.35},0).wait(1).to({scaleX:1.0452,scaleY:1.0452,y:1.25},0).wait(1).to({scaleX:1.0378,scaleY:1.0378,y:1.1},0).wait(1).to({scaleX:1.0305,scaleY:1.0305,x:0,y:1},0).wait(1).to({scaleX:1.0244,scaleY:1.0244,x:0.05,y:0.95,alpha:0.8},0).wait(1).to({scaleX:1.0183,scaleY:1.0183,x:0,y:0.85,alpha:0.6},0).wait(1).to({scaleX:1.0122,scaleY:1.0122,y:0.75,alpha:0.4},0).wait(1).to({scaleX:1.0061,scaleY:1.0061,x:-0.05,y:0.65,alpha:0.2},0).wait(1).to({scaleX:1,scaleY:1,x:0,y:0.6,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-222.4,-124.5,444.9,252.3);
...
if (reversed == null) { reversed = false; }
	...
	// Aurora_1.png
	this.instance_3 = new lib.Boca_1();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_1 = new lib.Interpolación30_1("synched",0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-15,-55,0.5,0.5);

	this.instance_2 = new lib.SiluetaHada();
	this.instance_2.setTransform(-45.75,-121.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1}]}).wait(50));

	// BrazoIzq.png
	this.instance_3 = new lib.Interpolación23_1("synched",0);
	this.instance_3.setTransform(17,-18,1,1,0,0,0,-29,17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({startPosition:0},2).to({regY:17.4,rotation:5.8531,x:16.95,y:-18.15,startPosition:15},15).to({rotation:8.2644,y:-18.1,startPosition:0},7).to({regY:17.5,rotation:0,x:17,y:-18},25).wait(1));

	// Capa_2
	this.instance_4 = new lib.luz();
	this.instance_4.setTransform(66.45,-60,0.2894,0.2894);
	this.instance_4.alpha = 0.2188;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).wait(1).to({scaleX:0.8481,scaleY:0.8481,x:66.4786,y:-59.3929,alpha:0.2},0).wait(1).to({scaleX:1.4068,scaleY:1.4068,x:66.5071,y:-58.7857,alpha:0.18},0).wait(1).to({scaleX:1.9655,scaleY:1.9655,x:66.5357,y:-58.1786,alpha:0.16},0).wait(1).to({scaleX:2.5242,scaleY:2.5242,x:66.5643,y:-57.5714,alpha:0.14},0).wait(1).to({scaleX:3.0829,scaleY:3.0829,x:66.5929,y:-56.9643,alpha:0.12},0).wait(1).to({scaleX:3.6416,scaleY:3.6416,x:66.6214,y:-56.3571,alpha:0.1},0).wait(1).to({scaleX:4.2003,scaleY:4.2003,x:66.65,y:-55.75,alpha:0.08},0).wait(8).to({scaleX:0.2921,scaleY:0.2921,x:66.45,y:-60,alpha:0.2188},0).to({_off:true},1).wait(32));

	// BrazoDer.png
	this.instance_5 = new lib.BrazoDer();
	this.instance_5.setTransform(-59.75,-20.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(50));

	// Pelo-Atras.png
	this.instance_6 = new lib.PeloAtras();
	this.instance_6.setTransform(-81.75,-136.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(50));

	// alas
	this.instance_7 = new lib.alas();
	this.instance_7.setTransform(0.15,-30.95);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(50));

	// estrellas
	this.instance_8 = new lib.estrellas();
	this.instance_8.setTransform(0,-37.95,0.6911,0.6911);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(2).to({_off:false},0).wait(38).to({scaleX:1,scaleY:1,y:-57.45},0).to({alpha:0.0313},9).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-230.4,-359.8,594,608.2);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.hada_2).to({y:-3.05,alpha:1},25).to({y:-9},49).to({y:0},50).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.frame_12 = function() {
		...
		_this.pinocho.gotoAndPlay(1);
			_this.pinocho.nariz.gotoAndPlay(1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.adelanteEscena},{t:this.atrasEscena}]}).to({state:[{t:this.atrasEscena}]},13).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.prev,p:{x:97.3}},{t:this.next,p:{x:143.1}},{t:this.pressToStart}]}).to({state:[{t:this.playaudio,p:{x:38.65}},{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.pause,p:{x:31.65}},{t:this.prev,p:{x:97.2}},{t:this.next,p:{x:143}}]},1).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}},{t:this.nextescene}]},12).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_5}]},2).wait(4));
	...
	this.instance_10.setTransform(-1,534,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6}]},3).to({state:[]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1).to({regY:219.8,x:594,y:537.65,alpha:0.5},0).wait(1).to({y:537.8,alpha:1},0).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.geppetto).wait(14));

	// pinocho
	this.instance_12 = new lib.BocaPinocho();
	this.instance_12.setTransform(252,292,0.5,0.5);

	this.pinocho = new lib.pinocho();
	this.pinocho.name = "pinocho";
	this.pinocho.setTransform(267.8,362,1,1,0,0,0,111.8,143);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.pinocho},{t:this.instance_12}]}).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.aurora).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.hada).wait(5).to({_off:false},0).wait(8).to({y:213.35},0).wait(1));

	// fondo
	this.instance_13 = new lib.pepe();
	this.instance_13.setTransform(55.45,343.9,1,1,0,0,180);

	this.instance_14 = new lib.reloj_1();
	this.instance_14.setTransform(92.1,124.95,0.8057,0.8057,0,0,0,77.8,-10);

	this.instance_15 = new lib.candelabro();
	this.instance_15.setTransform(676.55,65.15);

	this.instance_16 = new lib.Fondo();
	this.instance_16.setTransform(0,-7,0.5008,0.5053);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13}]}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13}]},5).wait(9));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1692143295929", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1692143295929", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1692143295931", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1692143296114", id:"Voice0"},
		{src:"sounds/Voice9.mp3?1692143296114", id:"Voice9"},
		{src:"sounds/Voice1.mp3?1692143296114", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1692143296114", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1692143296114", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1692143296114", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1692143296114", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1692143296114", id:"Voice6"},
		{src:"sounds/Voice7.mp3?1692143296114", id:"Voice7"},
		{src:"sounds/Voice8.mp3?1692143296114", id:"Voice8"},
		{src:"sounds/interaccion.mp3?1692143296114", id:"interaccion"},
		{src:"sounds/intro.mp3?1692143296114", id:"intro"},
		{src:"sounds/BGM.mp3?1692143296114", id:"BGM"}
	],
	preloads: []
};
