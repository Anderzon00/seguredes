...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,829,2376,129],[0,0,1382,827],[1384,0,591,512],[1977,0,530,452],[0,960,2381,72],[0,1034,2377,65]]},
		{name:"index_atlas_P_3", frames: [[1397,340,221,47],[2792,324,80,80],[2069,281,188,68],[1933,335,80,80],[1328,66,173,223],[2259,281,81,80],[1621,324,81,80],[1815,225,116,144],[2792,241,81,81],[1704,324,80,81],[1077,236,128,110],[2015,351,79,79],[1077,348,79,80],[2149,66,194,104],[1503,66,172,223],[1207,291,188,67],[1397,291,222,47],[2161,351,48,108],[620,66,287,323],[315,66,303,322],[2370,66,7,15],[2874,0,14,28],[2345,89,10,26],[2357,89,10,26],[2857,50,15,36],[2874,60,10,35],[2857,88,15,30],[2857,0,15,48],[2069,175,74,95],[2096,351,63,86],[1815,66,139,157],[1956,175,111,158],[1677,66,136,256],[2345,66,23,21],[1207,236,33,31],[1077,66,249,168],[0,66,313,324],[2792,0,63,143],[909,66,166,317],[1158,360,63,72],[2149,172,174,107],[1956,66,191,107],[2379,0,247,436],[2628,0,162,517],[2792,145,80,94],[0,0,2377,64],[2874,30,14,28],[2370,83,7,15],[2342,172,33,145]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1.45,-14.25,1.0252,1.0252,0,0,0,207.1,103.8);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:208.5,regY:118.2,scaleX:1.0287,scaleY:1.0287,x:0.05,y:0.6,alpha:0.125},0).wait(1).to({scaleX:1.0322,scaleY:1.0322,y:0.65,alpha:0.25},0).wait(1).to({scaleX:1.0357,scaleY:1.0357,y:0.7,alpha:0.375},0).wait(1).to({scaleX:1.0392,scaleY:1.0392,y:0.75,alpha:0.5},0).wait(1).to({scaleX:1.0448,scaleY:1.0448,y:0.85,alpha:0.6},0).wait(1).to({scaleX:1.0504,scaleY:1.0504,y:0.9,alpha:0.7},0).wait(1).to({scaleX:1.0559,scaleY:1.0559,y:1,alpha:0.8},0).wait(1).to({scaleX:1.0615,scaleY:1.0615,x:0.1,y:1.05,alpha:0.9},0).wait(1).to({scaleX:1.0671,scaleY:1.0671,y:1.15,alpha:1},0).wait(1).to({scaleX:1.0598,scaleY:1.0598,x:0.05,y:1.05},0).wait(1).to({scaleX:1.0525,scaleY:1.0525,y:0.95},0).wait(1).to({scaleX:1.0452,scaleY:1.0452,y:0.85},0).wait(1).to({scaleX:1.0378,scaleY:1.0378,y:0.7},0).wait(1).to({scaleX:1.0305,scaleY:1.0305,x:0,y:0.6},0).wait(1).to({scaleX:1.0244,scaleY:1.0244,x:0.05,y:0.55,alpha:0.8},0).wait(1).to({scaleX:1.0183,scaleY:1.0183,x:0,y:0.45,alpha:0.6},0).wait(1).to({scaleX:1.0122,scaleY:1.0122,y:0.35,alpha:0.4},0).wait(1).to({scaleX:1.0061,scaleY:1.0061,x:-0.05,y:0.25,alpha:0.2},0).wait(1).to({scaleX:1,scaleY:1,x:0,y:0.2,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-222.4,-125,444.9,252.4);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:17.4,rotation:0.6881,y:-18.1},2).to({rotation:5.853,x:16.95,y:-18.15,startPosition:15},15).to({rotation:8.2652,y:-18.1,startPosition:0},7).to({regY:17.5,rotation:0,x:17,y:-18},25).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({scaleX:0.8481,scaleY:0.8481,x:66.4786,y:-59.3929,alpha:0.2},0).wait(1).to({scaleX:1.4068,scaleY:1.4068,x:66.5071,y:-58.7857,alpha:0.18},0).wait(1).to({scaleX:1.9655,scaleY:1.9655,x:66.5357,y:-58.1786,alpha:0.16},0).wait(1).to({scaleX:2.5242,scaleY:2.5242,x:66.5643,y:-57.5714,alpha:0.14},0).wait(1).to({scaleX:3.0829,scaleY:3.0829,x:66.5929,y:-56.9643,alpha:0.12},0).wait(1).to({scaleX:3.6416,scaleY:3.6416,x:66.6214,y:-56.3571,alpha:0.1},0).wait(1).to({scaleX:4.2003,scaleY:4.2003,x:66.65,y:-55.75,alpha:0.08},0).wait(8).to({scaleX:0.2921,scaleY:0.2921,x:66.45,y:-60,alpha:0.2188},0).to({_off:true},1).wait(34));
	...
	// AlaIzq.png  
	this.instance_5 = new lib.Interpolación16("synched",0);
	this.instance_5.setTransform(47,-6.25,1,1,0,0,0,-25,21);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:-24.9,rotation:-9.1885,x:47.1,y:-6.2},24).to({regX:-25,rotation:0,x:47,y:-6.25},25).wait(1));

	// AlaDerecha.png
	this.instance_6 = new lib.Interpolación18("synched",0);
	this.instance_6.setTransform(-58,-10,1,1,0,0,0,18,17);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:17.9,rotation:7.9445,x:-58.05},24).to({regX:18,rotation:0,x:-58},25).wait(1));

	// estrellas
	this.instance_7 = new lib.estrellas();
	this.instance_7.setTransform(0,-57.45);
...
p.nominalBounds = new cjs.Rectangle(-230.4,-359.9,594,608.2);
...
if (reversed == null) { reversed = false; }
	...
	// hada_2
	this.instance = new lib.hada_2();

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-9},49).to({y:0},50).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-213.7,-187.1,427.5,323.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_5
	this.instance_5 = new lib.vela_candelabro();
	this.instance_5.setTransform(442.65,90.4);

	this.instance_6 = new lib.TarroPintura();
	this.instance_6.setTransform(410,369,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5}]}).wait(7));

	// pepe
	this.instance_7 = new lib.pepe();
	this.instance_7.setTransform(407.25,314.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(7));

	// pinocho
	this.instance_8 = new lib.pinocho();
	this.instance_8.setTransform(694.75,290);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(7));

	// hada
	this.instance_9 = new lib.hada();
	this.instance_9.setTransform(507.75,199.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(7));

	// objetos
	this.instance_10 = new lib.acuario();
	this.instance_10.setTransform(187.05,449.1);

	this.instance_11 = new lib.reloj_1();
	this.instance_11.setTransform(175.55,152,1,1,0,0,0,77.8,-10);

	this.instance_12 = new lib.Mesa_2();
	this.instance_12.setTransform(280,156,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11},{t:this.instance_10}]}).wait(7));
	...
	this.instance_15 = new lib.fondoEscena1();
	this.instance_15.setTransform(0,-8,0.5008,0.5053);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("AgNAAIAAgBIABgCIAEgGIADgBQAFgBACAAIAEAAIACABIADAEIACACIAAADQABAEgDAHIgRADQgEgIgDgFg");
	this.shape.setTransform(354.8,377.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13}]}).wait(7));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1679282185047", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1679282185047", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1679282185049", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1679282185214", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1679282185214", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1679282185214", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1679282185214", id:"Voice3"},
		{src:"sounds/BGM.mp3?1679282185214", id:"BGM"}
	],
	preloads: []
};
