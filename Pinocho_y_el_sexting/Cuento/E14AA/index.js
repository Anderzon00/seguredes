...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,0,2375,1135],[2377,0,474,731]]},
		{name:"index_atlas_P_2", frames: [[0,829,2377,80],[0,911,2377,80],[0,993,2377,80],[0,1075,2377,80],[662,0,457,696],[0,0,660,497],[0,698,2376,129]]},
		{name:"index_atlas_P_3", frames: [[0,513,2377,64],[1529,579,221,47],[2159,579,80,80],[1643,443,188,68],[2241,579,80,80],[1850,246,173,223],[1911,579,81,80],[1994,579,81,80],[594,579,116,144],[1828,579,81,81],[2077,579,80,81],[712,579,128,110],[1386,628,79,79],[1305,628,79,80],[1447,345,194,104],[0,0,2377,80],[2025,246,172,223],[0,82,2377,80],[1115,579,188,67],[0,164,2377,80],[1305,579,222,47],[305,579,287,323],[0,579,303,322],[1752,579,74,95],[633,345,245,156],[2628,0,54,208],[1306,345,139,157],[1098,345,206,135],[2694,519,91,187],[842,579,140,92],[984,579,129,99],[2199,246,136,256],[2628,355,51,44],[2787,519,101,108],[0,246,631,265],[2858,0,23,21],[2337,246,33,31],[1643,345,184,96],[880,345,216,151],[2379,438,313,324],[2628,210,63,143],[2379,0,247,436],[2694,0,162,517],[633,246,1215,97]]}
];
...
(lib.ojos2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(12.5344,6.0827);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Ah6AZQACgDADgCIABgEQABgGAFgEQAEgCAEAAIAIgCIAXgBIAIAAIABAAQAMgBAEAKQACAEAAAHQgmABgZADQgKABgGADIABgEgAAuAQIADgBQgBgLACgHQADgOAKgHQAJgFAKABIAGABIAGgBQAJgCAHAFQAFAEAEAIIADACIAAACIAAADIABAGIABADQgKAEgTADIgnAGIgLABIABgBg");
	this.shape_1.setTransform(12.475,2.9577);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(12.5344,4.7827);
...
p.nominalBounds = new cjs.Rectangle(0,0,25.1,12.2);
...
p.nominalBounds = new cjs.Rectangle(-40.2,-25,103,67.5);
...
p.nominalBounds = new cjs.Rectangle(-60.2,-38.5,122.5,78);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.TextColorinColorado();
	this.instance.setTransform(-575.55,-45.95,0.9474,0.9474);
...
p.nominalBounds = new cjs.Rectangle(-575.5,-45.9,1151.1,91.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.BRazoIzqAUrora();
	this.instance.setTransform(-22.75,-46.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-22.7,-46.7,45.5,93.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.BrazoDerAurora();
	this.instance.setTransform(-13.5,-52,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-13.5,-52,27,104);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_1 = new lib.Carpinterocabeza();
	this.instance_1.setTransform(-12.75,-11,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(575.55,45.95);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.s2, new cjs.Rectangle(0,0,1151.1,91.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(29.25,83.6,1,1,0,0,0,-55,-33.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:30,x:29.3,y:83.75},24).to({rotation:0,x:29.25,y:83.6},25).wait(1));

	// ojos2
	this.instance_1 = new lib.ojos2();
	this.instance_1.setTransform(70.5,33.85,1,1,0,0,0,12.5,6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50));

	// Pinocho.png
	this.instance_2 = new lib.SiluetaPinocho();
	this.instance_2.setTransform(-136,-23,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(50));

	// BrazoIzq_3.png
	this.instance_3 = new lib.Interpolación24("synched",0);
	this.instance_3.setTransform(77.15,89.5,1,1,0,0,0,-30.1,-19.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regY:-19.4,rotation:-14.9994,y:89.6},24).to({regY:-19.5,rotation:0,y:89.5},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-136,-23,318.8,365.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(231.35,223.1,0.0204,0.0204,180);

	this.instance_1 = new lib.Interpolación8("synched",0);
	this.instance_1.setTransform(363.4,334.05,0.6661,0.7358);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},124).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,scaleX:0.6661,scaleY:0.7358,rotation:0,x:363.4,y:334.05},124).wait(1));

	// s2
	this.instance_2 = new lib.s2();
	this.instance_2.setTransform(213.6,463.7,1,1,0,0,0,575.6,46);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:461},17).to({alpha:1},25).wait(83));

	// Capa_6
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#00000B","rgba(50,50,50,0.149)","rgba(50,50,50,0)","rgba(181,181,183,0.369)","rgba(129,129,133,0)"],[0.463,0.808,1,1,1],0,53.7,0,-53.7).s().p("EhcuAIZIAAwxMC5eAAAIAAQxg");
	this.shape.setTransform(195.55,439.225);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1).to({_off:false},0).wait(124));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-398,139.6,1187.1,370);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1.45,-14.3,1.0252,1.0252,0,0,0,207.1,103.6);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:208.5,regY:118.2,scaleX:1.0287,scaleY:1.0287,x:0.05,y:0.75,alpha:0.125},0).wait(1).to({scaleX:1.0322,scaleY:1.0322,y:0.8,alpha:0.25},0).wait(1).to({scaleX:1.0357,scaleY:1.0357,y:0.85,alpha:0.375},0).wait(1).to({scaleX:1.0392,scaleY:1.0392,y:0.95,alpha:0.5},0).wait(1).to({scaleX:1.0448,scaleY:1.0448,y:1,alpha:0.6},0).wait(1).to({scaleX:1.0504,scaleY:1.0504,y:1.05,alpha:0.7},0).wait(1).to({scaleX:1.0559,scaleY:1.0559,y:1.15,alpha:0.8},0).wait(1).to({scaleX:1.0615,scaleY:1.0615,x:0.1,y:1.2,alpha:0.9},0).wait(1).to({scaleX:1.0671,scaleY:1.0671,y:1.35,alpha:1},0).wait(1).to({scaleX:1.0598,scaleY:1.0598,x:0.05,y:1.2},0).wait(1).to({scaleX:1.0525,scaleY:1.0525,y:1.1},0).wait(1).to({scaleX:1.0452,scaleY:1.0452,y:1},0).wait(1).to({scaleX:1.0378,scaleY:1.0378,y:0.85},0).wait(1).to({scaleX:1.0305,scaleY:1.0305,x:0,y:0.75},0).wait(1).to({scaleX:1.0244,scaleY:1.0244,x:0.05,y:0.7,alpha:0.8},0).wait(1).to({scaleX:1.0183,scaleY:1.0183,x:0,y:0.6,alpha:0.6},0).wait(1).to({scaleX:1.0122,scaleY:1.0122,y:0.5,alpha:0.4},0).wait(1).to({scaleX:1.0061,scaleY:1.0061,x:-0.05,y:0.4,alpha:0.2},0).wait(1).to({scaleX:1,scaleY:1,x:0,y:0.35,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-222.4,-124.8,444.9,252.39999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(153.5,60.6,1,1,0,0,0,12.8,5.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50));

	// BrazoDer_1.png
	this.instance_1 = new lib.Interpolación2("synched",0);
	this.instance_1.setTransform(111.4,96,1,1,0,0,0,3.9,-49);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:4,rotation:3.961,x:111.6},24).to({regX:3.9,rotation:0,x:111.4},25).wait(1));

	// Aurora_1.png
	this.instance_2 = new lib.Aurora();
	...
	this.instance_3.setTransform(135.35,96.55,1,1,0,0,0,-13.4,-43.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:-13.3,rotation:-24.4407,x:135.5,y:96.5},24).to({regX:-13.4,rotation:0,x:135.35,y:96.55},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,228.5,348);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},2).to({regY:17.4,rotation:5.8531,x:16.95,y:-18.15,startPosition:15},15).to({rotation:8.2644,y:-18.1,startPosition:0},7).to({regY:17.5,rotation:0,x:17,y:-18},25).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.btnInteraccion.setTransform(812.95,212.5,1,1,0,0,0,-21.1,7.5);
	this.btnInteraccion._off = true;
	new cjs.ButtonHelper(this.btnInteraccion, 0, 1, 2, false, new lib.btnInteractivo(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btnInteraccion).wait(10).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.adelanteEscena},{t:this.atrasEscena}]}).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.muteMC},{t:this.unmuteMC},{t:this.prev,p:{x:97.3}},{t:this.next,p:{x:143.1}},{t:this.pressToStart}]}).to({state:[{t:this.playaudio},{t:this.muteMC},{t:this.unmuteMC},{t:this.pause},{t:this.prev,p:{x:97.2}},{t:this.next,p:{x:143}}]},1).wait(10));

	// Capa_2
	this.instance = new lib._1_1();
	this.instance.setTransform(-1,507,0.5,0.5);
	...
	this.FIN.name = "FIN";
	this.FIN.setTransform(631.3,250.2,1,1,0,0,0,233.2,177.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},2).to({state:[{t:this.instance_1}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3},{t:this.FIN}]},2).wait(1));
	...
	this.instance_6 = new lib._6pngcopia2();
	this.instance_6.setTransform(-1,534,0.5,0.5);

	this.instance_7 = new lib._8_1();
	this.instance_7.setTransform(-1,534,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},3).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},1).wait(2));
	...
	this.pinocho.setTransform(328.9,361.5,1,1,0,0,0,111.8,143);
	...
	this.aurora.setTransform(437.8,350.8,1,1,0,0,0,102.8,140.8);

	this.timeline.addTween(cjs.Tween.get(this.aurora).wait(11));

	// hada
	this.instance_9 = new lib.MapacheCabeza();
	this.instance_9.setTransform(980,348,0.5,0.5);

	this.instance_10 = new lib.MapacheCuerpo();
	this.instance_10.setTransform(988,371,0.5,0.5);

	this.hada = new lib.hada();
	this.hada.name = "hada";
	this.hada.setTransform(769.9,274.3,1.3429,1.3293);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.hada},{t:this.instance_10},{t:this.instance_9}]}).wait(11));

	// fondo
	this.instance_11 = new lib.bukho();
	this.instance_11.setTransform(71.1,215.2,1,1,0,0,0,35,45.2);

	this.instance_12 = new lib.carpintero();
	this.instance_12.setTransform(1019.2,271.5,1,1,0,0,0,25.2,36);

	this.instance_13 = new lib.Fondo();
	this.instance_13.setTransform(1,0,0.5029,0.4983);

	this.instance_14 = new lib.brillopantalla();
	this.instance_14.setTransform(-77,7);
	...
	this.instance_17.setTransform(0,-7,0.5004,0.5022);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11}]}).wait(11));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1692144349101", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1692144349101", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1692144349103", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1692144349275", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1692144349275", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1692144349275", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1692144349275", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1692144349275", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1692144349275", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1692144349275", id:"Voice6"},
		{src:"sounds/Voice7.mp3?1692144349275", id:"Voice7"},
		{src:"sounds/Interaccion.mp3?1692144349275", id:"Interaccion"},
		{src:"sounds/intro.mp3?1692144349275", id:"intro"},
		{src:"sounds/BGM.mp3?1692144349275", id:"BGM"}
	],
	preloads: []
};
