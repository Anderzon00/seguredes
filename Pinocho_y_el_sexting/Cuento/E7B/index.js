...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[2382,0,498,813],[0,0,2380,1147]]},
		{name:"index_atlas_P_2", frames: [[0,1021,2377,64],[1644,219,80,80],[0,865,2377,76],[1726,219,80,80],[0,943,2377,76],[2590,209,81,80],[2673,209,81,80],[2776,131,81,81],[2756,214,80,81],[1889,219,79,79],[1808,219,79,80],[2138,219,73,71],[1970,219,80,78],[0,0,477,779],[479,131,408,732],[2283,207,128,52],[2519,131,69,142],[2441,131,76,145],[479,0,2376,129],[1267,131,375,495],[889,131,376,497],[2590,131,91,76],[2213,261,73,71],[2283,131,156,74],[2052,219,84,69],[2683,131,91,76],[1644,131,319,86],[1965,131,316,86]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-331.55,-46.85,1,1,-29.9992);
...
}).prototype = getMCSymbolPrototype(lib.mariposas, new cjs.Rectangle(-454.1,-81.9,1005.4,195.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// mariposas
	this.instance_4 = new lib.mariposa();
	this.instance_4.setTransform(1129.95,222.25);

	this.instance_5 = new lib.mariposa();
	this.instance_5.setTransform(1046.95,258.3,1,1,71.4951);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4}]}).to({state:[{t:this.instance_5},{t:this.instance_4}]},5).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.contenedor).wait(7));

	// mariposas
	this.instance_6 = new lib.mariposas();
	this.instance_6.setTransform(573.25,289.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(7));

	// flor_1
	this.instance_7 = new lib.flor_1();
	this.instance_7.setTransform(1110.5,282.25,1,1,0,0,0,32,42.5);

	this.instance_8 = new lib.flor_1();
	this.instance_8.setTransform(1066,282.25,1,1,0,0,0,32,42.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.instance_7}]}).wait(7));

	// flor_2
	this.instance_9 = new lib.flor_2();
	this.instance_9.setTransform(30.2,257.65,1,1,0,0,180,33.8,39);

	this.instance_10 = new lib.flor_2();
	this.instance_10.setTransform(135.3,235.3,1,1,0,0,180,33.8,39);

	this.instance_11 = new lib.flor_2();
	this.instance_11.setTransform(85.95,210.65,1,1,0,0,0,33.8,39);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9}]}).wait(7));

	// nubes
	this.instance_12 = new lib.nubes_grupo();
	this.instance_12.setTransform(946.65,94,1,1,0,0,0,534.6,72.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(7));

	// fondo
	this.instance_13 = new lib.Fondo();
	this.instance_13.setTransform(0,-3,0.505,0.5013);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(7));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(587.1,321.5,715.1,578.3);
// library properties:
lib.properties = {
