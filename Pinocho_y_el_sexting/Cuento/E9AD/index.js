...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,1002,2377,80],[0,871,2376,129],[0,0,518,869]]},
		{name:"index_atlas_P_3", frames: [[0,573,2377,64],[1061,721,80,80],[815,741,80,80],[0,0,2377,80],[1061,639,81,80],[1144,639,81,80],[0,82,2377,80],[978,639,81,81],[1227,639,80,81],[0,492,2377,79],[632,795,79,79],[551,795,79,80],[0,164,2377,80],[0,246,2377,80],[0,328,2377,80],[0,410,2377,80],[2379,447,316,414],[2830,423,30,28],[2830,402,51,19],[713,795,69,77],[249,792,210,171],[2697,258,131,197],[572,639,241,154],[249,639,321,151],[2830,145,46,175],[815,639,161,100],[2697,636,141,142],[2687,0,136,256],[2862,423,24,11],[2838,453,26,12],[2865,369,23,21],[2830,369,33,31],[2825,0,63,143],[461,792,88,171],[2697,780,120,164],[2379,0,306,445],[0,639,247,436],[2830,322,56,45],[2819,780,62,32],[2697,457,139,177]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#666666").ss(1,1,1).p("AClgOIjvgpQg1gLgQAHQgOAGgFASQgGATALAQAibABIAFAFAiUAIQAPAIAPADQAZAFD5An");
...
(lib.Interpolación32_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(140,65.4,1,1,0,0,0,22,5.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2 = new lib.Interpolación32_1("synched",0);
...
if (reversed == null) { reversed = false; }
	...
	this.btnInteraccion.setTransform(551.6,368.15,1,1,0,0,0,-21.1,7.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6}]},3).to({state:[]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[]},1).wait(2));
	...
	// pinocho
	this.instance_11 = new lib.BocaPinocho();
	this.instance_11.setTransform(252,292,0.5,0.5);

	this.pinocho = new lib.pinocho();
	this.pinocho.name = "pinocho";
	this.pinocho.setTransform(267.8,362,1,1,0,0,0,111.8,143);

	this.instance_12 = new lib.risa2();
	this.instance_12.setTransform(251,287,0.4637,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.pinocho},{t:this.instance_11}]}).to({state:[{t:this.pinocho},{t:this.instance_12}]},11).wait(2));
	...
	this.instance_13 = new lib.risa1();
	this.instance_13.setTransform(477,286,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.aurora}]}).to({state:[{t:this.aurora},{t:this.instance_13}]},11).wait(2));

	// fondo
	this.instance_14 = new lib.pepe();
	this.instance_14.setTransform(55.45,343.9,1,1,0,0,180);

	this.instance_15 = new lib.reloj_1();
	this.instance_15.setTransform(92.1,124.95,0.8057,0.8057,0,0,0,77.8,-10);

	this.instance_16 = new lib.candelabro();
	this.instance_16.setTransform(676.55,65.15);

	this.instance_17 = new lib.Fondo();
	this.instance_17.setTransform(0,-7,0.5008,0.5053);

	this.instance_18 = new lib.reloj_1();
	this.instance_18.setTransform(92.1,124.95,0.8057,0.8057,0,0,0,77.8,-10);

	this.instance_19 = new lib.candelabro();
	this.instance_19.setTransform(676.55,65.15);

	this.instance_20 = new lib.Fondo();
	this.instance_20.setTransform(0,-7,0.5008,0.5053);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14}]}).wait(13));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1692065526467", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1692065526467", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1692065526468", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1692065526665", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1692065526665", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1692065526665", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1692065526665", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1692065526665", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1692065526665", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1692065526665", id:"Voice6"},
		{src:"sounds/Voice7.mp3?1692065526665", id:"Voice7"},
		{src:"sounds/Voice8.mp3?1692065526665", id:"Voice8"},
		{src:"sounds/interaccion.mp3?1692065526665", id:"interaccion"},
		{src:"sounds/intro.mp3?1692065526665", id:"intro"},
		{src:"sounds/BGM.mp3?1692065526665", id:"BGM"}
	],
	preloads: []
};
