...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,1066,2377,80],[0,935,2376,129],[0,0,645,933],[647,0,646,407]]},
		{name:"index_atlas_P_3", frames: [[0,574,2377,64],[2246,699,221,47],[1948,710,80,80],[1866,640,188,68],[2546,733,80,80],[0,0,2377,80],[2684,519,173,223],[2056,709,81,80],[2139,709,81,80],[1618,640,116,144],[0,82,2377,80],[2546,650,81,81],[1866,710,80,81],[1736,640,128,110],[0,164,2377,80],[2709,744,79,79],[2628,744,79,80],[1422,640,194,104],[0,246,2377,80],[1107,640,172,223],[0,328,2377,80],[2056,640,188,67],[0,410,2377,80],[2246,650,222,47],[0,492,2377,80],[0,640,287,323],[2379,326,303,322],[2246,640,45,6],[2470,650,74,95],[1281,640,139,157],[2858,93,25,4],[2858,0,19,38],[2858,70,15,21],[2379,0,313,324],[2694,0,162,517],[289,640,816,103],[2858,40,14,28]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-6.25,-1,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1.45,-14.3,1.0252,1.0252,0,0,0,207.1,103.5);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:208.5,regY:118.2,scaleX:1.0287,scaleY:1.0287,x:0.05,y:0.85,alpha:0.125},0).wait(1).to({scaleX:1.0322,scaleY:1.0322,y:0.9,alpha:0.25},0).wait(1).to({scaleX:1.0357,scaleY:1.0357,y:0.95,alpha:0.375},0).wait(1).to({scaleX:1.0392,scaleY:1.0392,y:1.05,alpha:0.5},0).wait(1).to({scaleX:1.0448,scaleY:1.0448,y:1.1,alpha:0.6},0).wait(1).to({scaleX:1.0504,scaleY:1.0504,y:1.15,alpha:0.7},0).wait(1).to({scaleX:1.0559,scaleY:1.0559,y:1.25,alpha:0.8},0).wait(1).to({scaleX:1.0615,scaleY:1.0615,x:0.1,y:1.3,alpha:0.9},0).wait(1).to({scaleX:1.0671,scaleY:1.0671,y:1.45,alpha:1},0).wait(1).to({scaleX:1.0598,scaleY:1.0598,x:0.05,y:1.3},0).wait(1).to({scaleX:1.0525,scaleY:1.0525,y:1.2},0).wait(1).to({scaleX:1.0452,scaleY:1.0452,y:1.1},0).wait(1).to({scaleX:1.0378,scaleY:1.0378,y:0.95},0).wait(1).to({scaleX:1.0305,scaleY:1.0305,x:0,y:0.85},0).wait(1).to({scaleX:1.0244,scaleY:1.0244,x:0.05,y:0.8,alpha:0.8},0).wait(1).to({scaleX:1.0183,scaleY:1.0183,x:0,y:0.7,alpha:0.6},0).wait(1).to({scaleX:1.0122,scaleY:1.0122,y:0.6,alpha:0.4},0).wait(1).to({scaleX:1.0061,scaleY:1.0061,x:-0.05,y:0.5,alpha:0.2},0).wait(1).to({scaleX:1,scaleY:1,x:0,y:0.45,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-222.4,-124.7,444.9,252.4);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_1 = new lib.Interpolación30("synched",0);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(24).call(this.frame_24).wait(31));

	// Jaula Frente.png
	this.instance = new lib.JaulaFrente();
	this.instance.setTransform(728,42,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55));

	// MergedLayer_2
	this.instance_1 = new lib.Símbolo1_1();
	this.instance_1.setTransform(821,337.25,0.8629,0.7684,-6.6882,0,0,15.6,9.5);

	this.instance_2 = new lib.Símbolo2_1();
	this.instance_2.setTransform(821.1,337,0.7091,0.7545,-10.8806,0,0,33.7,12.3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true,regX:33.7,regY:12.3,scaleX:0.7091,scaleY:0.7545,rotation:-10.8806,x:821.1,y:337},6).wait(49));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:false},6).to({regX:34,regY:13.2,scaleX:1.3201,rotation:-7.4116,x:821.35,y:337.7},18).wait(31));

	// niños
	this.instance_3 = new lib.lagrimas4();
	this.instance_3.setTransform(974.6,351.35,0.3352,0.3352,0,0,180,-594.3,-152.5);

	this.instance_4 = new lib.lagrimas3();
	this.instance_4.setTransform(957.1,350.85,0.3352,0.3352,0,0,0,-594.3,-152.5);

	this.instance_5 = new lib.lagrimas1();
	this.instance_5.setTransform(806.35,343.7,0.3352,0.3352,0,0,0,-594.3,-152.3);

	this.instance_6 = new lib.lagrimas2();
	this.instance_6.setTransform(1023.15,396.15,0.3352,0.3352);

	this.instance_7 = new lib.Sombrajaula();
	this.instance_7.setTransform(691,533,0.5,0.5);

	this.instance_8 = new lib.Pinochoyaurora();
	this.instance_8.setTransform(734,284,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]}).wait(55));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(691,42,408,542.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_8.setTransform(0,-57.45);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(2).to({_off:false},0).wait(38).to({alpha:0.0313},9).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.hada_2).to({alpha:1},25).to({y:-9},50).to({y:0},50).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// jaula
	this.jaula = new lib.jaula();
	this.jaula.name = "jaula";
	this.jaula.setTransform(895,44,1,1,4.9958,0,0,895,42);

	var maskedShapeInstanceList = [this.jaula];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get(this.jaula).to({regY:42.1,rotation:-4.4545,x:895.05},39).to({regY:42,rotation:4.9958,x:895,y:44.05},40).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(644.5,29.5,496.0999999999999,557.1);
...
if (reversed == null) { reversed = false; }
	...
	this.hada.name = "hada";
	this.hada.setTransform(236.9,275.3,1.3429,1.3293);

	this.timeline.addTween(cjs.Tween.get(this.hada).wait(13));

	// niños
	this.niños = new lib.niños();
	this.niños.name = "niños";
	this.niños.setTransform(366.6,230.2,1,1,0,0,0,528.8,254.2);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.niños}]}).wait(13));
	...
	this.instance_12.setTransform(0,-2,0.5008,0.5053);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.instance_12},{t:this.instance_11}]}).wait(13));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1692070905049", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1692070905049", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1692070905050", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1692070905215", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1692070905215", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1692070905215", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1692070905215", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1692070905215", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1692070905215", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1692070905215", id:"Voice6"},
		{src:"sounds/Voice7.mp3?1692070905215", id:"Voice7"},
		{src:"sounds/Voice8.mp3?1692070905215", id:"Voice8"},
		{src:"sounds/interaccion.mp3?1692070905215", id:"interaccion"},
		{src:"sounds/intro.mp3?1692070905215", id:"intro"},
		{src:"sounds/BGM.mp3?1692070905215", id:"BGM"}
	],
	preloads: []
};
