...
p.nominalBounds = new cjs.Rectangle(609.5,331.5,515.5,302);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_1.png?1663942061018", id:"index_atlas_1"},
		{src:"sounds/QuestionSoundEffect.mp3?1663942061106", id:"QuestionSoundEffect"}
	],
	preloads: []
};
