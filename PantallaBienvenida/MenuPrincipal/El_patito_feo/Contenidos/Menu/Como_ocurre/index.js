...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1690,289,206,226],[1690,517,223,172],[0,0,1688,1004],[1898,393,100,100],[0,1006,382,25],[1898,289,102,102],[1690,0,273,287]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#999999").ss(1,1,1).p("ApnnVITPAAIAAOrIzPAAg");
	this.shape.setTransform(58.55,57.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00FF00").s().p("ApmHWIAAurITNAAIAAOrg");
	this.shape_1.setTransform(58.55,57.1);
...
p.nominalBounds = new cjs.Rectangle(-4,0,125.1,105.1);
...
if (reversed == null) { reversed = false; }
	...
	this.siguienteA.setTransform(747.4,608.35,0.5,0.5,0,0,0,51,51);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_1.png?1663991769808", id:"index_atlas_1"}
	],
	preloads: []
};
