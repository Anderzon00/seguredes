...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[2053,1748,466,90],[2374,2300,315,90],[2053,2024,457,90],[2053,1840,466,90],[2521,1748,315,90],[2053,2116,457,90],[2053,1932,466,90],[2521,1840,315,90],[2053,2208,457,90],[0,3735,2372,153],[0,1682,2051,2051],[0,0,2888,1680],[2512,2114,253,89],[2512,2205,253,89],[2053,1682,802,64],[2521,1932,254,89],[2521,2023,254,89]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// fondo
	this.instance = new lib.tituloCaperucitacuiento();
	this.instance.setTransform(177,18,0.5,0.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ehc8AsYMAAAhYvMC54AAAMAAABYvg");
	this.shape.setTransform(690.9086,340.9,1.0019,1);

	this.instance_1 = new lib.bannernegro1();
	this.instance_1.setTransform(95,621,0.5025,0.5);

	this.instance_2 = new lib.fondo11();
	this.instance_2.setTransform(-43,-37,0.5,0.5);
