...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-299,-161);

	this.instance_1 = new lib.globoverdederecha();
	this.instance_1.setTransform(139,-228,1,1.1232);

	this.instance_2 = new lib.globorojoderecha();
	this.instance_2.setTransform(89,-265,1,1.1427);
	...
	this.instance_4.setTransform(-199,-260,0.9767,1.116);

	this.instance_5 = new lib.tituloBienvenida1();
	this.instance_5.setTransform(-186,-190,1.0142,1.1186);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.zoomseguredes, new cjs.Rectangle(-299,-265,598,452), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({regY:-39,scaleX:0.036,scaleY:0.0327,y:251.05},0).wait(1).to({scaleX:0.0704,scaleY:0.063,y:249.6},0).wait(1).to({scaleX:0.1047,scaleY:0.0934,y:248.15},0).wait(1).to({scaleX:0.1391,scaleY:0.1238,y:246.7},0).wait(1).to({scaleX:0.1734,scaleY:0.1542,y:245.3},0).wait(1).to({scaleX:0.2078,scaleY:0.1845,y:243.85},0).wait(1).to({scaleX:0.2421,scaleY:0.2149,y:242.4},0).wait(1).to({scaleX:0.2765,scaleY:0.2453,y:241},0).wait(1).to({scaleX:0.3108,scaleY:0.2757,y:239.55},0).wait(1).to({scaleX:0.3452,scaleY:0.306,y:238.1},0).wait(1).to({scaleX:0.3795,scaleY:0.3364,y:236.7},0).wait(1).to({scaleX:0.4139,scaleY:0.3668,y:235.25},0).wait(1).to({scaleX:0.4482,scaleY:0.3971,y:233.8},0).wait(1).to({scaleX:0.4826,scaleY:0.4275,y:232.4},0).wait(1).to({scaleX:0.517,scaleY:0.4579,y:230.9},0).wait(1).to({scaleX:0.5513,scaleY:0.4883,y:229.45},0).wait(1).to({scaleX:0.5857,scaleY:0.5186,y:228},0).wait(1).to({scaleX:0.62,scaleY:0.549,y:226.6},0).wait(1).to({scaleX:0.6544,scaleY:0.5794,y:225.15},0).wait(1).to({scaleX:0.6887,scaleY:0.6097,y:223.7},0).wait(1).to({scaleX:0.7231,scaleY:0.6401,y:222.3},0).wait(1).to({scaleX:0.7574,scaleY:0.6705,y:220.85},0).wait(1).to({scaleX:0.7918,scaleY:0.7009,y:219.4},0).wait(1).to({scaleX:0.8261,scaleY:0.7312,y:218},0).wait(1).to({scaleX:0.8605,scaleY:0.7616,y:216.55},0).wait(1).to({scaleX:0.8948,scaleY:0.792,y:215.1},0).wait(1).to({scaleX:0.9292,scaleY:0.8223,y:213.7},0).wait(1).to({scaleX:0.9635,scaleY:0.8527,y:212.25},0).wait(1).to({scaleX:0.9979,scaleY:0.8831,y:210.8},0).to({_off:true},1).wait(73));
