...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(476.05,-513.9,1,1,0,0,0,-56.5,-88.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-482.35},74).to({y:-513.9},79).wait(1));

	// niña-derecha.png
	this.instance_1 = new lib.Interpolación2("synched",0);
	this.instance_1.setTransform(462.85,-365.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:458.6,y:-333.5},74).to({x:462.85,y:-365.25},79).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-5.6518,x:-475.95,y:-150.7},74).to({rotation:-10.9459,x:-499.95,y:-165.75},79).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-668.8,-559.1,1217.1,537.6);
