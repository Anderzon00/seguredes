...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,0,576,1028]]},
		{name:"index_atlas_P_3", frames: [[0,999,2377,63],[2461,1000,80,80],[0,1064,2377,63],[2543,1000,80,80],[0,867,2377,64],[2726,878,81,80],[2726,960,81,80],[0,933,2377,64],[2726,795,81,81],[2379,1000,80,81],[434,723,2377,70],[2706,1042,79,79],[2625,1000,79,80],[0,795,2377,70],[434,649,2377,72],[0,131,432,660],[2378,0,471,647],[0,0,2376,129],[2379,795,345,203],[434,131,314,182],[2706,1000,12,12],[2787,1042,67,21]]}
];
...
(lib.Onlinenotificacion = function() {
	this.initialize(ss["index_atlas_P_3"]);
	this.gotoAndStop(20);
}).prototype = p = new cjs.Sprite();
...
(lib.notificación = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// en linea
	this.instance = new lib.OnlineText();
	this.instance.setTransform(-14,-3,0.8025,0.8025);

	this.instance_1 = new lib.Onlinenotificacion();
	this.instance_1.setTransform(-25,0,0.8025,0.8025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[]},20).wait(14));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-25,-3,64.8,16.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Mensajecaperucita();
	this.instance.setTransform(-86.25,-50.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-86.2,-50.7,172.5,101.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.MensajePatricio();
	this.instance.setTransform(-78.5,-45.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-78.5,-45.5,157,91);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-331,-23.25,0.5,0.5);

	this.instance_1 = new lib.brazoDer();
	this.instance_1.setTransform(115,-42.25,0.5,0.5);

	this.instance_2 = new lib.notificación();
	this.instance_2.setTransform(116.2,-229.05,1,1,0,0,0,20.2,5.2);

	this.instance_3 = new lib.Interpolación10("synched",0);
	this.instance_3.setTransform(62.25,107.75);

	this.instance_4 = new lib.Interpolación9("synched",0);
	this.instance_4.setTransform(-36.5,15.9);

	this.instance_5 = new lib.Interpolación8("synched",0);
	this.instance_5.setTransform(62.25,-71.5);

	this.instance_6 = new lib.Interpolación7("synched",0);
	this.instance_6.setTransform(-37.5,-162.75);

	this.instance_7 = new lib.celular();
	this.instance_7.setTransform(-125,-300.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-331,-300.2,662,600.5);
...
(lib.caperucita2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_49 = function() {
		playSound("messenger_notification");
	}

	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(49).call(this.frame_49).wait(150));

	// Capa_2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Eg/sAr/MAAAhX9MB/ZAAAMAAABX9g");
	mask.setTransform(128.25,-20.325);

	// Capa_11
	this.instance = new lib.brazoIzq();
	this.instance.setTransform(-216,-7,0.5,0.5);

	this.instance_1 = new lib.brazoDer();
	this.instance_1.setTransform(230,-26,0.5,0.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(102,102,102,0.278)").ss(1,1,1).p("Eg29AAAMBt7AAA");
	this.shape.setTransform(206.55,-301.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(255,255,255,0)").s().p("Eg/sAr/MAAAhX9IIvAAMBt7AAAIIvAAMAAABX9g");
	this.shape_1.setTransform(206.55,-20.325);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.shape_1},{t:this.shape}]},198).wait(1));

	// manos
	this.instance_2 = new lib.notificación();
	this.instance_2.setTransform(231.2,-212.8,1,1,0,0,0,20.2,5.2);

	this.instance_3 = new lib.brazoIzq();
	this.instance_3.setTransform(-216,-7,0.5,0.5);

	this.instance_4 = new lib.brazoDer();
	this.instance_4.setTransform(230,-26,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[{t:this.instance_4},{t:this.instance_3}]},198).wait(1));

	// notificación
	this.instance_5 = new lib.Interpolación7("synched",0);
	this.instance_5.setTransform(77.5,-140.25);

	this.instance_6 = new lib.notificación();
	this.instance_6.setTransform(231.2,-212.8,1,1,0,0,0,20.2,5.2);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5}]}).to({state:[{t:this.instance_5}]},30).to({state:[]},1).to({state:[{t:this.instance_6}]},18).to({state:[{t:this.instance_6}]},149).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({alpha:0},30).to({_off:true},1).wait(168));

	// Mensaje-Patricio.png
	this.instance_7 = new lib.Interpolación8("synched",0);
	this.instance_7.setTransform(177.25,-52.75);

	this.instance_8 = new lib.Interpolación7("synched",0);
	this.instance_8.setTransform(77.95,-134.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({alpha:0},30).to({_off:true},1).wait(168));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(49).to({_off:false},0).to({x:77.5,y:-140.25,alpha:1},31).to({startPosition:0},93).to({startPosition:0},25).wait(1));

	// Mensaje-caperucita.png
	this.instance_9 = new lib.Interpolación9("synched",0);
	this.instance_9.setTransform(78.5,32.15);

	this.instance_10 = new lib.Interpolación8("synched",0);
	this.instance_10.setTransform(177.25,-45.15);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({alpha:0},30).to({_off:true},1).wait(168));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(80).to({_off:false},0).to({y:-52.75,alpha:1},25).to({startPosition:0},68).to({startPosition:0},25).wait(1));

	// Mensaje-Patricio.png
	this.instance_11 = new lib.Interpolación10("synched",0);
	this.instance_11.setTransform(177.25,122.75);

	this.instance_12 = new lib.Interpolación9("synched",0);
	this.instance_12.setTransform(78.5,42.45);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({alpha:0},30).to({_off:true},1).wait(168));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(105).to({_off:false},0).to({y:32.15,alpha:1},25).to({startPosition:0},43).to({startPosition:0},25).wait(1));

	// Mensaje-caperucita.png
	this.instance_13 = new lib.Interpolación10("synched",0);
	this.instance_13.setTransform(177.25,134);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(130).to({_off:false},0).to({y:122.75,alpha:1},43).to({startPosition:0},25).wait(1));

	// celular.png
	this.instance_14 = new lib.celular();
	this.instance_14.setTransform(-10,-284,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-216,-301.8,774.4,563);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Eg/sAr/MAAAhX9IIvAAMBt7AAAIIvAAMAAABX9g");
	mask.setTransform(206.55,-20.325);

	// Mensaje-Patricio.png
	this.instance = new lib.Interpolación11("synched",0);
	this.instance.setTransform(115,16.25);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:13.7},8).to({y:3.75},31).to({y:16.25},40).to({startPosition:0},35).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-201.1,-296.5,647.1,557.7);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_9 = function() {
		...
		*/
		...
		_this.caperucita2.gotoAndPlay(1);
		});
	}
	...
	this.btnInteraccion.setTransform(501.9,455.6,1,1,0,0,0,-21.1,7.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnInteraccion,p:{x:501.9,y:455.6}}]},9).to({state:[{t:this.btnInteraccion,p:{x:499.95,y:455.65}},{t:this.nextEscenaFinal}]},1).wait(1));
	...
	this.instance_7.setTransform(592.9,473.2,1.0168,1,0,0,0,592,152.3);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({regX:594,regY:219.8,scaleX:1.0202,x:595.55,y:540.65,alpha:0.5},0).wait(1).to({scaleX:1.0235,x:596.15,alpha:1},0).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.nextEscena,p:{y:609.6}},{t:this.prevEscena}]}).to({state:[{t:this.shape},{t:this.nextEscena,p:{y:610.6}},{t:this.prevEscena}]},9).to({state:[{t:this.shape_1},{t:this.prevEscena}]},1).wait(1));
	...
	this.caperucita.setTransform(236,442,1,1,0,0,0,-216,130);

	this.caperucita2 = new lib.caperucita2();
	this.caperucita2.name = "caperucita2";
	this.caperucita2.setTransform(591.7,319.35,1,1,0,0,0,139.7,7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.caperucita}]}).to({state:[{t:this.caperucita2}]},9).wait(2));

	// fondo
	this.instance_8 = new lib.fondo();
	this.instance_8.setTransform(-2,-7,0.505,0.5096);
...
p.nominalBounds = new cjs.Rectangle(584.2,317.5,619.8999999999999,314.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1688656622760", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1688656622760", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1688656622761", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1688656624686", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1688656624686", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1688656624686", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1688656624686", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1688656624686", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1688656624686", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1688656624686", id:"Voice6"},
		{src:"sounds/Voice7.mp3?1688656624686", id:"Voice7"},
		{src:"sounds/BGM.mp3?1688656624686", id:"BGM"},
		{src:"sounds/messenger_notification.mp3?1688656624686", id:"messenger_notification"}
	],
	preloads: []
};
