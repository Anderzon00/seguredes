...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,1022,2377,76],[2378,0,443,680],[0,891,2376,129],[0,0,603,889],[605,0,500,500]]},
...
if (reversed == null) { reversed = false; }
	...
	// pata
	this.instance_4 = new lib.interacciones();
	this.instance_4.setTransform(682.05,393.8,1,1,0,0,0,-28.2,-152);
	...
	// fondo
	this.instance_5 = new lib.fondoEscena1();
	this.instance_5.setTransform(0,0,0.5008,0.5053);
