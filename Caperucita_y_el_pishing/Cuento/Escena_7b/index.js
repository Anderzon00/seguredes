...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,944,2377,63],[1757,351,80,80],[0,1009,2377,63],[1839,351,80,80],[0,746,2377,64],[2112,275,81,80],[2195,275,81,80],[0,131,2193,64],[2029,275,81,81],[2278,275,80,81],[0,812,2377,64],[2193,357,79,79],[2112,357,79,80],[0,878,2377,64],[2029,358,68,80],[2274,358,85,66],[1757,275,97,74],[1524,275,136,110],[2749,345,79,82],[2269,131,56,49],[2830,345,51,48],[1271,275,251,103],[1131,275,138,208],[1662,275,93,92],[2327,131,48,33],[1662,369,51,30],[2860,0,18,17],[2195,131,72,53],[2378,0,369,744],[2749,0,109,179],[2749,181,103,162],[1955,275,72,94],[0,0,2376,129],[1856,275,97,74],[566,197,563,203],[0,197,564,203],[1131,197,1200,76]]}
];
...
(lib.CaparucitaBrazoIzq = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(17);
}).prototype = p = new cjs.Sprite();
...
(lib.CaparucitaMangaIzq = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(18);
}).prototype = p = new cjs.Sprite();
...
(lib.CaperucitaBrazoDerpngcopia2 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(21);
}).prototype = p = new cjs.Sprite();
...
(lib.Caperucitanarizpngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(26);
}).prototype = p = new cjs.Sprite();
...
(lib.Caperucitaojospngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(27);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CaparucitaMangaIzq();
	this.instance.setTransform(-59.6,-4.5,0.5,0.5,-29.9984);

	this.instance_1 = new lib.CaparucitaBrazoIzq();
	this.instance_1.setTransform(-48.2,-47.5,0.5,0.5,-4.2108);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo2, new cjs.Rectangle(-59.6,-52.5,83.3,83.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(99,206,1.5119,1.6809);

	this.instance_1 = new lib.Mensaje2pngcopia();
	this.instance_1.setTransform(99,573,1.5093,1.7836);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00CC00").s().p("AgZAaQAXgtAcgGQABAJgHAJIgOAOQgGAHgHAMg");
	this.shape.setTransform(330.8813,405.425);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_1},{t:this.instance}]}).wait(40));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(99,206,851.3,729.1);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CaperucitaBrazoDerpngcopia2();
	this.instance.setTransform(0,49,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.brazoizq, new cjs.Rectangle(0,49,125.5,51.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(11).to({_off:false},0).to({_off:true},4).wait(5).to({_off:false},0).wait(86));

	// Caperucita-Boca2.png
	this.instance_1 = new lib.CaperucitaBoca2();
	this.instance_1.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},11).wait(4).to({_off:false},0).to({_off:true},5).wait(86));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,28,24.5);
...
}).prototype = getMCSymbolPrototype(lib.Símbolo1_1, new cjs.Rectangle(0,49,125.5,51.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(48).call(this.frame_49).wait(49).call(this.frame_98).wait(1));

	// Lobo-Ventana-Llamada.png
	this.celular = new lib.celular();
	this.celular.name = "celular";
	this.celular.setTransform(-315.85,26.3,0.001,1,0,0,0,-156.1,518.3);

	this.timeline.addTween(cjs.Tween.get(this.celular).to({regX:0,scaleX:1,x:-317},49).to({y:10.3},23).to({y:26.3},26).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-315.6,-302,1082.4,745.1);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_1 = new lib.CaperucitaMangaDer();
	this.instance_1.setTransform(0,50.25,0.5,0.5);

	this.instance_2 = new lib.Símbolo1_1();
	this.instance_2.setTransform(76.35,55.05,1,1,4.223,0,0,59,42.7);

	this.instance_3 = new lib.Símbolo4();
	this.instance_3.setTransform(122.35,48.8,1,1,19.9977,0,0,34.5,52);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo3_1, new cjs.Rectangle(0,-11.8,172.6,129.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Caperucita-Ojos.png
	this.instance = new lib.Caperucitaojospngcopia();
	this.instance.setTransform(-102,-172,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50));

	// Caperucita-Boca.png
	this.instance_1 = new lib.boca();
	this.instance_1.setTransform(-102.2,-138,1,1,0,0,0,12.8,12);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50));

	// Caperucita-Nariz.png
	this.instance_2 = new lib.Caperucitanarizpngcopia();
	this.instance_2.setTransform(-95,-150,0.5,0.5);
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_49 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-62.135,y:-94.1596}).wait(49).to({graphics:mask_graphics_49,x:-62.135,y:-94.1596}).wait(1));

	// Caperucita-MangaDerecha.png
	this.instance_3 = new lib.Símbolo3_1();
	this.instance_3.setTransform(-153.3,-78.5,1,1,3.2393,0,0,9.1,77.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:9.2,scaleX:0.9999,scaleY:0.9999,rotation:-7.9768,x:-146.7,y:-74.4},24).to({regX:9.1,scaleX:1,scaleY:1,rotation:3.2393,x:-153.3,y:-78.5},25).wait(1));

	// Caperucita-Silueta.png
	this.instance_4 = new lib.CaperucitaSiluetapngcopia();
	this.instance_4.setTransform(-228,-219,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(50));

	// Caperucita-BrazoIzq.png
	this.instance_5 = new lib.Símbolo2();
	this.instance_5.setTransform(-79.9,-8.2,1,1,14.4769,0,0,11.3,71.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({rotation:3.2619,x:-61.1,y:-19.7},24).to({rotation:14.4769,x:-79.9,y:-8.2},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-228,-219,241.6,372);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.nextEscenaFinal = new lib.siguienteAnimado();
	this.nextEscenaFinal.name = "nextEscenaFinal";
	this.nextEscenaFinal.setTransform(255.3,609.4,1,1,0,0,0,20.2,20);
	this.nextEscenaFinal._off = true;
	new cjs.ButtonHelper(this.nextEscenaFinal, 0, 1, 2, false, new lib.siguienteAnimado(), 3);
	...
	this.btnInteraccion.setTransform(669.9,293.6,1,1,0,0,0,-21.1,7.5);
	...
	this.instance_4 = new lib._4pngcopia();
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.nextEscena,p:{y:609.6}},{t:this.prevEscena}]}).to({state:[{t:this.shape},{t:this.nextEscena,p:{y:609}},{t:this.prevEscena}]},8).to({state:[{t:this.shape_1},{t:this.prevEscena}]},1).wait(1));
	...
	this.lobo.name = "lobo";
	this.lobo.setTransform(668.15,232.7,0.5,0.5,0,0,0,-317,26.3);

	this.timeline.addTween(cjs.Tween.get(this.lobo).wait(10));

	// caperucita 
	this.instance_7 = new lib.caperucita();
	this.instance_7.setTransform(499.95,398.55,1,1,0,0,0,-158,-27.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(10));

	// constantes
	this.instance_8 = new lib.mariposas();
	this.instance_8.setTransform(664.05,421.75,1,1,0,0,0,-2.8,-0.5);

	this.instance_9 = new lib.abeja_1();
	this.instance_9.setTransform(143.9,446.35,1,1,0,0,180,-189,-30);
	...
	this.instance_10.setTransform(70.65,544.1,1.0471,1.1748,0,0,0,-0.1,190.8);

	this.instance_11 = new lib.Fondo();
	this.instance_11.setTransform(-263,-281,0.505,0.507);
...
p.nominalBounds = new cjs.Rectangle(333,43.5,969,692.5);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/Fondo.png?1688657727785", id:"Fondo"},
		{src:"images/index_atlas_P_1.png?1688657727651", id:"index_atlas_P_1"},
		{src:"sounds/Voice0.mp3?1688657727785", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1688657727785", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1688657727785", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1688657727785", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1688657727785", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1688657727785", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1688657727785", id:"Voice6"},
		{src:"sounds/BGM.mp3?1688657727785", id:"BGM"}
	],
	preloads: []
};
