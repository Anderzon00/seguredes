...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1690,289,206,226],[1690,517,223,172],[0,0,1688,1004],[0,1006,604,397],[606,1006,434,339],[1042,1006,368,243],[1412,1006,440,137],[1690,778,286,85],[1690,691,288,85],[1412,1145,382,25],[1898,289,102,102],[1965,0,3,27],[1690,0,273,287]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(-596,-284,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Tilde_1();
	this.instance.setTransform(12,-25);

	this.instance_1 = new lib.Indicedecontenidos();
	this.instance_1.setTransform(-35,-25,0.5,0.5);

	this.instance_2 = new lib.Oscuro();
	this.instance_2.setTransform(-35,-25,0.5198,0.5201);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,197,255,0)").ss(1,1,1).p("AAZgCIAAAFIgxAA");
	this.shape.setTransform(34.05,29.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#33CC99").s().p("As1DtIAAnZIZrAAIAAHZg");
	this.shape_1.setTransform(46.3,-3.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.shape_1},{t:this.shape}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-35.9,-26.9,164.5,57.5);
