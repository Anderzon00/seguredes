...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[3983,1066,61,62],[3983,890,77,109],[3983,1001,63,63],[1811,1164,60,60],[0,772,751,551],[1757,1164,52,71],[3671,802,310,383],[1052,0,899,898],[3017,0,800,800],[3065,802,604,397],[1321,900,434,339],[753,1204,368,243],[0,1325,440,137],[1827,1374,286,85],[3819,0,264,284],[2619,802,444,632],[1953,742,664,630],[3819,638,262,146],[442,1325,258,138],[1757,900,194,134],[1123,1241,412,216],[1537,1241,288,178],[1757,1036,158,126],[753,900,566,302],[3819,286,250,188],[3671,1187,374,298],[3819,476,264,160],[753,772,288,85],[2619,742,382,25],[3983,786,102,102],[1953,0,1062,740],[0,0,1050,770],[3065,1201,563,201]]}
];
...
(lib.Indicedecontenidos = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(13);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.niño_1();
	this.instance.setTransform(-166,-157.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-166,-157.5,332,315);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.nube2izq();
	this.instance.setTransform(-224.5,83.5,0.5,0.5);

	this.instance_1 = new lib.nube3der();
	this.instance_1.setTransform(-58.5,69.5,0.5,0.5);

	this.instance_2 = new lib.nube2der();
	this.instance_2.setTransform(9.5,-45.5,0.5,0.5);

	this.instance_3 = new lib.nube1izq();
	this.instance_3.setTransform(-190.5,-28.5,0.5,0.5);

	this.instance_4 = new lib.nube1der();
	this.instance_4.setTransform(27.5,-172.5,0.5,0.5);

	this.instance_5 = new lib.luna_1();
	this.instance_5.setTransform(-24.5,-220.5,0.5,0.5);

	this.instance_6 = new lib.fondoimagen_1();
	this.instance_6.setTransform(-203.8,-189.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-224.5,-220.5,449,441);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.avionder();
	this.instance.setTransform(-15.25,-15.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-15.2,-15.5,30.5,31);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.avionizq();
	this.instance.setTransform(-19.25,-27.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-19.2,-27.2,38.5,54.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-111,-158,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-111,-158,222,316);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Indicedecontenidos();
	this.instance.setTransform(-33,-25,0.5,0.5);

	this.instance_1 = new lib.Oscuro();
	this.instance_1.setTransform(-34,-25,0.5198,0.5201);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00CCCC").s().p("ArhDuIAAnbIXDAAIAAHbg");
	this.shape.setTransform(37.75,0.8);
...
p.nominalBounds = new cjs.Rectangle(-36,-25,151.7,49.6);
...
if (reversed == null) { reversed = false; }
	...
	// timeline functions:
	this.frame_2 = function() {
		playSound("Scifidoorsoundeffect");
	}
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.BtnInteractivoB.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_15.bind(this));
	...
	this.BtnInteractivoB.setTransform(38.4,-6.45,1,1,0,0,0,-21.1,7.5);
	new cjs.ButtonHelper(this.BtnInteractivoB, 0, 1, 2, false, new lib.btnInteractivoB(), 3);

	this.timeline.addTween(cjs.Tween.get(this.BtnInteractivoB).to({_off:true},2).wait(85));

	// niña.png
	this.instance = new lib.Interpolación3("synched",0);
	this.instance.setTransform(129.5,50.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},1).to({guide:{path:[129.5,50.1,125.4,49.4,119.9,48.8,101.1,46.5,75.6,46.2]}},45).to({guide:{path:[75.6,46.2,101.1,46.5,119.9,48.8,125.4,49.4,129.5,50.1]}},40).wait(1));

	// burbujas.png
	this.instance_1 = new lib.burbujas();
	this.instance_1.setTransform(-58,-113,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(87));

	// avion der.png
	this.instance_2 = new lib.Interpolación9("synched",0);
	this.instance_2.setTransform(250.65,-63.15);

	this.instance_3 = new lib.Interpolación12("synched",0);
	this.instance_3.setTransform(250.65,-63.15);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},23).to({state:[{t:this.instance_2}]},22).to({state:[{t:this.instance_3}]},40).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},1).to({rotation:-90,guide:{path:[250.6,-63,242.5,-73.4,232,-82.8,185.2,-125,119.2,-125,74.7,-125,39,-106], orient:'fixed'}},23).to({regX:0.1,regY:-0.1,rotation:-208.3244,guide:{path:[38.9,-106,21.5,-96.7,6.2,-82.9,-40.6,-40.6,-40.6,19.1,-40.6,78.7,6.2,120.9,31.3,143.6,62,154.1], orient:'fixed'}},22).to({_off:true,regX:0,regY:0,rotation:-360,guide:{path:[62.2,154.1,88.6,163.2,119.2,163.2,185.3,163.2,232.1,120.9,278.9,78.7,278.9,19.1,278.9,-27.2,250.7,-63], orient:'fixed'}},40).wait(1));

	// avion izq.png
	this.instance_4 = new lib.Interpolación7("synched",0);
	this.instance_4.setTransform(-5.5,-71.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:0},1).to({rotation:-105.0002,guide:{path:[-5.4,-71.3,-40.6,-32.7,-40.6,19.1,-40.6,78.7,6.1,120.9,24.5,137.4,45.8,147.5], orient:'fixed'}},23).to({rotation:-186.7404,guide:{path:[45.9,147.5,79,163.1,119.2,163.1,185.2,163.1,232,120.9,241.5,112.3,249,103.1]}},22).to({rotation:-360,guide:{path:[249,103.1,278.8,66.6,278.8,19,278.8,-40.6,232,-82.8,185.2,-125,119.2,-125,53,-125,6.2,-82.8,0,-77.2,-5.4,-71.3]}},40).wait(1));

	// Capa_2
	this.instance_5 = new lib.nube3();
	this.instance_5.setTransform(5,128,0.5,0.5);

	this.instance_6 = new lib.nube2();
	this.instance_6.setTransform(-64,88,0.5,0.5);

	this.instance_7 = new lib.nube1();
	this.instance_7.setTransform(-95,21,0.5,0.5);

	this.instance_8 = new lib.nubearriba();
	this.instance_8.setTransform(73,-177,0.5,0.5);

	this.instance_9 = new lib.nube4();
	this.instance_9.setTransform(139,90,0.5,0.5);

	this.instance_10 = new lib.candado_1();
	this.instance_10.setTransform(148,-103,0.5,0.5);

	this.instance_11 = new lib.fondoimagen();
	this.instance_11.setTransform(-113,-194,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]}).wait(87));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-857,-311,1366,768);


(lib.imagena = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.btnInteractionB.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_13.bind(this));
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(107));

	// Capa_2
	this.btnInteractionB = new lib.btnInteractivo();
	this.btnInteractionB.name = "btnInteractionB";
	this.btnInteractionB.setTransform(-167.85,-42.45,1,1,0,0,0,-21.1,7.5);
	new cjs.ButtonHelper(this.btnInteractionB, 0, 1, 2, false, new lib.btnInteractivo(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btnInteractionB).to({_off:true},2).wait(106));

	// niño
	this.instance = new lib.Interpolación24("synched",0);
	this.instance.setTransform(59,13.8,1,1,0,0,0,96.5,26.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},1).to({scaleX:0.8333,scaleY:0.8333,x:8.65,y:2.9},25).to({scaleX:1,scaleY:1,x:59,y:13.8},27).to({scaleX:0.8333,scaleY:0.8333,x:8.65,y:2.9},27).to({scaleX:1,scaleY:1,x:59,y:13.8},27).wait(1));

	// fondo
	this.instance_1 = new lib.Interpolación22("synched",0);
	this.instance_1.setTransform(-7,8.85);
...
p.nominalBounds = new cjs.Rectangle(-231.5,-211.6,449,441);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_1 = function() {
		...
		this.btnAtrasB.addEventListener("click", fl_ClickToGoToAndStopAtFrame_2.bind(this));
		function fl_ClickToGoToAndStopAtFrame_2(){	
			createjs.Sound.play("sound2", { volume: 0.8}).on("complete", function () { 
			this.gotoAndStop(0); 
		                    }, this);
	...
	// interactivos
	this.insultos = new lib.imagena();
	this.insultos.name = "insultos";
	this.insultos.setTransform(918,311);

	this.BtnInteractivoB = new lib.niña_1();
	this.BtnInteractivoB.name = "BtnInteractivoB";
	this.BtnInteractivoB.setTransform(814.15,269.45,0.9224,0.9224);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.insultos}]}).to({state:[{t:this.BtnInteractivoB}]},1).wait(1));
	...
	// texto
	this.instance_1 = new lib.texto_1();
	this.instance_1.setTransform(110,120,0.5,0.5);

	this.instance_2 = new lib.candado();
	this.instance_2.setTransform(122,383,0.5,0.5);

	this.instance_3 = new lib.candado();
	this.instance_3.setTransform(122,267,0.5,0.5);

	this.instance_4 = new lib.candado();
	this.instance_4.setTransform(122,135,0.5,0.5);

	this.instance_5 = new lib.texto();
	...
	this.btnAtrasA.name = "btnAtrasA";
	this.btnAtrasA.setTransform(427.25,607,0.5,0.5,0,0,180,51,51);
	new cjs.ButtonHelper(this.btnAtrasA, 0, 1, 2, false, new lib.btnSiguiente(), 3);
	...
	this.btnAtrasB.setTransform(426.25,606.25,0.5,0.5,0,0,180,51,51);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnSiguienteA},{t:this.btnAtrasA}]}).to({state:[{t:this.btnSiguienteB},{t:this.btnAtrasB}]},1).wait(1));
	...
	// esquinas fondo,indicador de página
	this.movieClip_9 = new lib.Símbolo1();
	this.movieClip_9.name = "movieClip_9";
	this.movieClip_9.setTransform(597.3,284.05);

	this.instance_6 = new lib.posición();
	this.instance_6.setTransform(490,547,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.movieClip_9}]}).wait(2));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_1.png?1721425600326", id:"index_atlas_1"},
		{src:"sounds/sound2.mp3?1721425600452", id:"sound2"},
		{src:"sounds/sound1.mp3?1721425600452", id:"sound1"},
		{src:"sounds/como1.mp3?1721425600452", id:"como1"},
		{src:"sounds/como2.mp3?1721425600452", id:"como2"},
		{src:"sounds/como3.mp3?1721425600452", id:"como3"},
		{src:"sounds/como4.mp3?1721425600452", id:"como4"},
		{src:"sounds/como5.mp3?1721425600452", id:"como5"},
		{src:"sounds/como6.mp3?1721425600452", id:"como6"},
		{src:"sounds/Scifidoorsoundeffect.mp3?1721425600452", id:"Scifidoorsoundeffect"},
		{src:"sounds/y2matecomsonidodemagiaefectohadas.mp3?1721425600452", id:"y2matecomsonidodemagiaefectohadas"}
	],
	preloads: []
};
