...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[1669,309,80,80],[1751,309,80,80],[2763,186,81,80],[2687,268,81,80],[2763,103,81,81],[2770,268,80,81],[2768,351,79,79],[2687,350,79,80],[2404,248,281,158],[2404,0,357,246],[2763,0,107,101],[0,587,2376,129],[0,0,717,585],[1902,0,500,500],[1669,391,69,60],[2846,103,20,42],[2872,0,16,34],[719,309,948,208],[0,718,2376,71],[0,791,2376,71],[2404,408,246,118],[719,0,1181,307]]},
...
(lib.ojo = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A7A8A8").s().p("");
	this.shape.setTransform(0.0875,-1.445);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#A7A8A8").s().p("");
	this.shape_1.setTransform(0.0265,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},42).to({state:[{t:this.shape_1}]},3).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10.8,-5.1,21.700000000000003,10.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(98,-17,0.4156,0.4156);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},2).wait(1));

	// Capa_1
	this.instance_1 = new lib.siguienteAnimado();
	this.instance_1.setTransform(20.2,20,1,1,0,0,0,20.2,20);
...
p.nominalBounds = new cjs.Rectangle(-0.3,-18.2,492.3,109.4);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_3
	this.instance = new lib.mano2();
	this.instance.setTransform(-119.55,29.55,0.314,0.314,-179.2594);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(21).to({y:38.55},0).wait(20));
...
p.nominalBounds = new cjs.Rectangle(-276.5,-129.5,159,209.5);
...
p.nominalBounds = new cjs.Rectangle(-27.2,-64.7,79.5,105.7);
...
if (reversed == null) { reversed = false; }
	...
	this.btnInteraccion.setTransform(582.05,376.95);
	...
	// btns_media
	this.instance_1 = new lib.TextoParaPlay();
	this.instance_1.setTransform(0,418,0.3061,0.3769);
	...
	new cjs.ButtonHelper(this.nextescene, 0, 1, 2);

	this.instance_2 = new lib.Símbolo3();
	this.instance_2.setTransform(203.65,607.1,1,1,0,0,0,20.2,20);
	new cjs.ButtonHelper(this.instance_2, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.prev,p:{x:97.3}},{t:this.next,p:{x:143.1}},{t:this.pressToStart},{t:this.instance_1}]}).to({state:[{t:this.playaudio,p:{x:38.65}},{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.pause,p:{x:31.65}},{t:this.prev,p:{x:97.2}},{t:this.next,p:{x:143}}]},1).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance_2},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}},{t:this.nextescene}]},4).wait(1));
	...
	// texto 1
	this.instance_3 = new lib.texto1mc();
	this.instance_3.setTransform(769.15,494.5,0.9703,1);
	...
	this.instance_4.setTransform(616.5,550.3,1,1,0,0,0,-378,43.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(3).to({_off:false},0).wait(3));

	// lago fondo blanco
	this.instance_5 = new lib.Símbolo9();
	this.instance_5.setTransform(706.5,522.2,1,1,0,0,0,594,151.2);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({regY:121,x:594,y:440.85,alpha:0.5},0).wait(1).to({y:441,alpha:1},0).wait(4));
	...
	// fondo
	this.instance_6 = new lib.Paisajedefondo();
	this.instance_6.setTransform(0,0,0.5008,0.5009);
...
p.nominalBounds = new cjs.Rectangle(581.7,324.5,718.8,353.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1723341438640", id:"index_atlas_P_1"},
		{src:"images/index_atlas_NP_1.jpg?1723341438640", id:"index_atlas_NP_1"},
		{src:"sounds/Voice0.mp3?1723341438876", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1723341438876", id:"Voice1"},
		{src:"sounds/BGM.mp3?1723341438876", id:"BGM"},
		{src:"sounds/Voice2.mp3?1723341438876", id:"Voice2"},
		{src:"sounds/intro.mp3?1723341438877", id:"intro"}
	],
	preloads: []
};
