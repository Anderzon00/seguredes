...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[3602,659,426,226],[2599,2991,447,102],[3048,3019,447,102],[0,3040,447,102],[449,3040,447,102],[898,3040,447,102],[2599,3095,447,102],[3602,887,423,122],[3625,2849,423,122],[3625,2973,423,122],[3791,2459,296,89],[3791,2550,296,89],[3964,1098,87,87],[3964,1187,87,87],[3964,1276,87,87],[3964,1365,87,87],[4020,0,61,63],[4020,130,61,62],[4020,65,61,63],[3964,1454,89,64],[0,1166,2362,1132],[0,0,2376,1164],[2599,2849,590,140],[3191,2849,432,168],[2085,2300,169,169],[4083,0,2,78],[3877,290,200,200],[3497,3097,372,53],[0,3144,371,50],[1347,3137,371,52],[3048,3123,374,52],[3964,1520,87,61],[3877,584,147,70],[3602,0,273,657],[1427,2300,656,835],[3964,1011,130,85],[2085,2471,235,108],[3877,492,153,90],[3458,1909,328,144],[3877,0,141,288],[4020,194,72,52],[2085,2581,140,67],[3791,1909,267,548],[2364,2109,1425,738],[3458,1029,504,878],[2378,1029,1078,1078],[2085,2849,512,512],[2378,0,1222,1027],[0,2300,1425,738]]}
];
...
(lib.stopwatch_3126752 = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(46);
}).prototype = p = new cjs.Sprite();
...
}).prototype = getMCSymbolPrototype(lib.Símbolo85, new cjs.Rectangle(0,0,130,85), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.pato();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo84, new cjs.Rectangle(0,0,656,835), null);
...
}).prototype = getMCSymbolPrototype(lib.Símbolo83, new cjs.Rectangle(0,0,235,108), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PatoPicoAbajo();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo38, new cjs.Rectangle(0,0,87,61), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PatoSilueta();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo37, new cjs.Rectangle(0,0,273,657), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PatoPicoArriba();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo36, new cjs.Rectangle(0,0,147,70), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Profesoraala();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo29, new cjs.Rectangle(0,0,141,288), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ProfesoraPicoAbajo();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo28, new cjs.Rectangle(0,0,72,52), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ProfesoraPicoArriba();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo27, new cjs.Rectangle(0,0,140,67), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ProfesoraSilueta_1();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(39.5829,27.0688);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(39.0728,29.0875);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},33).to({state:[{t:this.shape_1}]},6).wait(6));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,78.2,58.2);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(37.6389,29.0335);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(37.6389,29.0335);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},36).to({state:[{t:this.shape_1}]},2).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,75.3,58.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-84.5,-84.5);
...
p.nominalBounds = new cjs.Rectangle(-84.5,-84.5,169,169);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(54.75,-14.75,0.5,0.5);

	this.instance_1 = new lib.Emoji2();
	this.instance_1.setTransform(-4.25,-14.75,0.5,0.5);

	this.instance_2 = new lib.Emoji3();
	this.instance_2.setTransform(26.75,-16.75,0.5,0.5);

	this.instance_3 = new lib.Emoji3();
	this.instance_3.setTransform(-30.25,-16.75,0.5,0.5);

	this.instance_4 = new lib.Emoji2();
	this.instance_4.setTransform(-58.25,-14.75,0.5,0.5);

	this.instance_5 = new lib.Emoji1();
	this.instance_5.setTransform(-85.25,-14.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-85.2,-16.7,170.5,33.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.imgsopaLetras();
	this.instance.setTransform(-28,-28,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-28,-28,84.5,84.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-22.25,-16,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-22.2,-16,44.5,32);
...
(lib.btnSalir_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance_2 = new lib.Menuactividadesnomalverde();
	this.instance_2.setTransform(-94,-13);

	this.instance_3 = new lib.MenuactividadesHoververde();
	this.instance_3.setTransform(-94,-13);
...
(lib.btnReintentar_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance_3 = new lib.btnreintentar();
	this.instance_3.setTransform(0,0,0.5,0.5);

	this.instance_4 = new lib.btnreintentarhover();
	this.instance_4.setTransform(0,0,0.5,0.5);

	this.instance_5 = new lib.btnreintentarclic();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(68.35,-203.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30));

	// Esqueleto_5
	this.ikNode_2 = new lib.Símbolo27();
	this.ikNode_2.name = "ikNode_2";
	this.ikNode_2.setTransform(115.05,-160.85,1,1,0,0,0,35.1,16.1);

	this.ikNode_6 = new lib.Símbolo29();
	this.ikNode_6.name = "ikNode_6";
	this.ikNode_6.setTransform(123.65,0.05,1,1,0,0,0,29.7,34);

	this.ikNode_4 = new lib.Símbolo28();
	this.ikNode_4.name = "ikNode_4";
	this.ikNode_4.setTransform(96.45,-122.65,1,1,-14.9985,0,0,11.5,15.3);

	this.ikNode_1 = new lib.Símbolo26();
	this.ikNode_1.name = "ikNode_1";
	this.ikNode_1.setTransform(43.8,-153.5,1,1,0,0,0,43.8,102.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:1,scaleY:1,rotation:-14.9985,x:96.45,y:-122.65,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:0,y:0.05,regX:29.7,x:123.65,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:0,x:115.05,regX:35.1,y:-160.85}}]}).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-13.3233,x:96.5,y:-122.6,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:0.4406,y:0.1,regX:29.7,x:123.65,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-0.6374,x:115,regX:35.1,y:-160.85}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-11.6484,x:96.5,y:-122.45,regY:15.4,regX:11.5}},{t:this.ikNode_6,p:{rotation:0.8839,y:0.1,regX:29.8,x:123.75,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-1.2766,x:114.95,regX:35.1,y:-160.85}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-9.974,x:96.5,y:-122.6,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:1.3273,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-1.9159,x:115.1,regX:35.2,y:-160.85}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-8.2994,x:96.45,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:1.7707,y:0.1,regX:29.7,x:123.65,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-2.5555,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-6.6247,x:96.45,y:-122.6,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:2.2134,y:0.1,regX:29.8,x:123.75,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-3.1945,x:114.95,regX:35.1,y:-160.85}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-4.9497,x:96.45,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:2.657,y:0.15,regX:29.7,x:123.55,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-3.834,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-3.2762,x:96.6,y:-122.6,regY:15.3,regX:11.6}},{t:this.ikNode_6,p:{rotation:3.1,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-4.4731,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-1.6011,x:96.6,y:-122.4,regY:15.4,regX:11.6}},{t:this.ikNode_6,p:{rotation:3.5431,y:0.15,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-5.1127,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:0.0691,x:96.45,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:3.9865,y:0.1,regX:29.8,x:123.75,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-5.753,x:114.85,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:1.7437,x:96.45,y:-122.5,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:4.4301,y:0.15,regX:29.7,x:123.55,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-6.3913,x:115,regX:35.2,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:3.4172,x:96.6,y:-122.55,regY:15.3,regX:11.6}},{t:this.ikNode_6,p:{rotation:4.8731,y:0.15,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-7.0312,x:114.85,regX:35.1,y:-160.75}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:5.0927,x:96.45,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:5.3164,y:0.15,regX:29.7,x:123.55,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-7.6704,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:6.7665,x:96.45,y:-122.5,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:5.76,y:0.2,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-8.3096,x:115,regX:35.2,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:8.4408,x:96.5,y:-122.4,regY:15.4,regX:11.5}},{t:this.ikNode_6,p:{rotation:6.203,y:0.15,regX:29.8,x:123.7,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-8.9489,x:114.85,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:6.8846,x:96.4,y:-122.4,regY:15.4,regX:11.5}},{t:this.ikNode_6,p:{rotation:5.789,y:0.2,regX:29.7,x:123.55,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-8.352,x:115,regX:35.2,y:-160.75}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:5.3297,x:96.45,y:-122.5,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:5.3752,y:0.2,regX:29.7,x:123.55,scaleX:0.9999,scaleY:0.9999}},{t:this.ikNode_2,p:{rotation:-7.7551,x:114.85,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:3.7738,x:96.45,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:4.9616,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-7.1591,x:114.85,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:2.2161,x:96.45,y:-122.5,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:4.5485,y:0.15,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-6.5619,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:0.661,x:96.5,y:-122.5,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:4.1346,y:0.15,regX:29.7,x:123.55,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-5.9657,x:114.85,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-0.891,x:96.5,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:3.721,y:0.2,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-5.3682,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-2.4472,x:96.5,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:3.3066,y:0.15,regX:29.7,x:123.65,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-4.7713,x:115.05,regX:35.2,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-4.0025,x:96.4,y:-122.6,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:2.8934,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-4.175,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-5.559,x:96.45,y:-122.4,regY:15.4,regX:11.5}},{t:this.ikNode_6,p:{rotation:2.4794,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-3.5782,x:114.95,regX:35.1,y:-160.85}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-7.1162,x:96.5,y:-122.4,regY:15.4,regX:11.5}},{t:this.ikNode_6,p:{rotation:2.0663,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-2.9818,x:114.95,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-8.6716,x:96.45,y:-122.65,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:1.6526,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-2.3849,x:114.9,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-10.2272,x:96.4,y:-122.6,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:1.239,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-1.7882,x:114.95,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-11.7834,x:96.45,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:0.8253,y:0.1,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-1.1908,x:115,regX:35.1,y:-160.85}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-13.3394,x:96.5,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:0.4118,y:0.05,regX:29.7,x:123.6,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:-0.5945,x:114.95,regX:35.1,y:-160.8}}]},1).to({state:[{t:this.ikNode_1},{t:this.ikNode_4,p:{scaleX:0.9999,scaleY:0.9999,rotation:-14.8964,x:96.45,y:-122.55,regY:15.3,regX:11.5}},{t:this.ikNode_6,p:{rotation:0,y:0.05,regX:29.7,x:123.7,scaleX:1,scaleY:1}},{t:this.ikNode_2,p:{rotation:0,x:115.05,regX:35.1,y:-160.85}}]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(84.6,-242.5,1,1,0,0,0,37.6,29);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(25));

	// Esqueleto_9
	this.ikNode_8 = new lib.Símbolo36();
	this.ikNode_8.name = "ikNode_8";
	this.ikNode_8.setTransform(125.1,-210.95,1,1,3.94,0,0,147,35);

	this.ikNode_11 = new lib.Símbolo38();
	this.ikNode_11.name = "ikNode_11";
	this.ikNode_11.setTransform(96.3,-190.4,0.9998,0.9998,0,0,0,82.5,20.4);

	this.ikNode_9 = new lib.Símbolo37();
...
p.nominalBounds = new cjs.Rectangle(-100,-326,273,657);
...
p.nominalBounds = new cjs.Rectangle(29.5,21.4,84.5,92.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-176.75,-56.25);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-62.25},46).to({y:-56.25},42).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-262,-79,170.5,39.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(22.25,16);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:9},24).to({y:16},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-7,44.5,39);


(lib.pato_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Esqueleto_7
	this.ikNode_1 = new lib.Símbolo83();
	this.ikNode_1.name = "ikNode_1";
	this.ikNode_1.setTransform(-29.95,-292.45,1,1,0,0,0,148.5,7.5);

	this.ikNode_4 = new lib.Símbolo85();
	this.ikNode_4.name = "ikNode_4";
	this.ikNode_4.setTransform(16.6,-243,1,1,11.2199,0,0,117.5,13);

	this.ikNode_2 = new lib.Símbolo84();
	this.ikNode_2.name = "ikNode_2";
...
p.nominalBounds = new cjs.Rectangle(-404,-474,656,835);


(lib.lupas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(36.7,-27.25,1,1,0,0,0,-20,-28);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({guide:{path:[36.7,-27.3,36.8,-29.6,36.8,-32,36.8,-54.3,23.1,-70,9.4,-85.8,-9.9,-85.8,-29.3,-85.8,-43,-70,-45,-67.7,-46.7,-65.3]}},39).to({guide:{path:[-46.7,-65.3,-46.9,-65,-47,-64.8,-56.8,-50.7,-56.8,-31.9,-56.8,-9.8,-43,6,-32.1,18.5,-17.8,21.1,-14.3,21.7,-10.6,21.8]}},40).to({guide:{path:[-10.5,21.8,-10.2,21.8,-9.9,21.8,9.5,21.8,23.1,6,34,-6.4,36.2,-23.2]}},40).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-121.3,-142.3,262.7,276.6);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.SopaFOndo();
	this.instance.setTransform(248,132,0.6566,0.5374);

	this.instance_1 = new lib.pato_1();
	this.instance_1.setTransform(964.45,431.55,0.5485,0.5002,0,3.8186,3.1735,36.9,2.8);

	this.instance_2 = new lib.profesora();
	this.instance_2.setTransform(199.8,442,0.5487,0.5,0,0,0,133.6,18);

	this.instance_3 = new lib.lupas();
	this.instance_3.setTransform(1042.1,268.5,0.4,0.4,0,0,180,56,-6);

	this.instance_4 = new lib.Lupafondo();
	this.instance_4.setTransform(1017,205,0.5,0.5);

	this.instance_5 = new lib.lupas();
	this.instance_5.setTransform(135.95,268.5,0.4,0.4,0,0,0,56.1,-6);

	this.instance_6 = new lib.Lupafondo();
	this.instance_6.setTransform(70,205,0.5,0.5);

	this.instance_7 = new lib.Lupafondo();
	this.instance_7.setTransform(159,0,0.5,0.5);

	this.instance_8 = new lib.fondo();
	this.instance_8.setTransform(0,130,0.5032,0.5042);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.fondo2, new cjs.Rectangle(0,0,1195.6,716.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		window.parent.document.getElementById('mi_iframe').src='./Ayuda/Actividades/Sopa/index.html';
		createjs.Sound.stop();
		 
		
		sound0 = createjs.Sound.play("Instrucciones"); 
	...
	this.frame_1 = function() {
		...
		function createIframe() {
		 ...
		 var iframeHTML = '<iframe id="video" sandbox="allow-same-origin allow-scripts allow-popups allow-forms" style="border:none;" src="./source" >';
		  ...
		  function setElementSize() {   
		    ...
		    element.style.top = 1.2 * Math.max(window.innerHeight) / 16 + 'px';
		    element.style.left = 8.4 * Math.max(window.innerWidth) / 32 + 'px';
			  
		    document.getElementById('video').style.width = 18.5 * (Math.max(window.innerWidth) / 32) + 'px';
		    document.getElementById('video').style.height = 12.6 * Math.max(window.innerHeight) / 16 + 'px';
	...
	this.frame_3 = function() {
		createjs.Sound.stop();
		createjs.Sound.play("retroNegativa");
		document.getElementById('video')?.remove();  
		var _this = this;
		
		_this.btnReintentar2.on('click', function(){
		
		window.open('.', '_self');	
		});
		
		
		_this.btnSalir2.on('click', function(){
	...
	this.instance.setTransform(977.6,364.85,0.8562,0.8562,0,0,0,529,357.2);
	...
	this.instance_1.setTransform(582.25,122,0.9999,0.9999,0,0,0,57.6,57.9);
	...
	this.text1 = new cjs.Text("00:00:00", "24px 'Algerian'", "#0066CC");
	this.text1.name = "text1";
	this.text1.lineHeight = 29;
	this.text1.lineWidth = 99;
	this.text1.parent = this;
	this.text1.setTransform(974.7,477.6);
	this.text1.shadow = new cjs.Shadow("rgba(204,255,204,1)",3,3,4);

	this.instance_4 = new lib.stopwatch_3126752();
	this.instance_4.setTransform(1109.8,373,0.3805,0.3665,0,0,180);
	...
	this.btnReintentar.setTransform(223.85,352.8);
	new cjs.ButtonHelper(this.btnReintentar, 0, 1, 2);

	this.btnSalir = new lib.btnSalir_1();
	this.btnSalir.name = "btnSalir";
	this.btnSalir.setTransform(552.55,365.3);
	...
	this.btnSalir2.setTransform(640.5,397,1,1,0,0,0,59.5,25.5);
	...
	this.btnReintentar2.setTransform(262,359);
...
p.nominalBounds = new cjs.Rectangle(577.5,182.5,624.5,462.4);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_1.png?1721930932119", id:"index_atlas_1"},
		{src:"sounds/audioLoop.mp3?1721930932374", id:"audioLoop"},
		{src:"sounds/Instrucciones.mp3?1721930932374", id:"Instrucciones"},
		{src:"sounds/SoundBoton.mp3?1721930932374", id:"SoundBoton"},
		{src:"sounds/sound.mp3?1721930932374", id:"sound"},
		{src:"sounds/retroalimentacion.mp3?1721930932374", id:"retroalimentacion"},
		{src:"sounds/retroNegativa.mp3?1721930932374", id:"retroNegativa"}
	],
	preloads: []
};
