...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,522,1225,292],[0,816,893,360],[895,816,1004,292],[1227,522,782,220],[1683,107,355,105],[1683,320,355,104],[1683,0,356,105],[1683,214,356,104],[1227,744,63,63],[1292,744,60,60],[1901,744,123,123],[1359,0,322,321],[0,0,1357,520]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.btnSiguiente1.setTransform(408.25,254.1,1,1,0,0,0,89,26.2);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1,p:{y:31.9,x:409.75}},{t:this.btn_sonido1,p:{y:31.9,x:408.4}},{t:this.btnSiguiente1},{t:this.instance,p:{regX:64.9,regY:63.9,skewX:-169.7014,skewY:10.2986,x:104.45,y:324}}]}).to({state:[{t:this.btnStopSonido1,p:{y:-12.1,x:409.75}},{t:this.btn_sonido1,p:{y:-12.1,x:408.4}},{t:this.btnSiguiente2},{t:this.instance,p:{regX:93,regY:121.2,skewX:-158.0458,skewY:21.9542,x:272.35,y:285.9}},{t:this.btnAnterior2}]},1).to({state:[{t:this.btnStopSonido1,p:{y:51.15,x:655.4}},{t:this.btn_sonido1,p:{y:51.15,x:654.05}},{t:this.btnSiguiente3},{t:this.btnAnterior3},{t:this.instance,p:{regX:93,regY:121.2,skewX:-158.0458,skewY:21.9542,x:387,y:304.55}}]},1).to({state:[{t:this.btnStopSonido1,p:{y:70.05,x:618.7}},{t:this.btn_sonido1,p:{y:70.05,x:617.35}},{t:this.instance,p:{regX:64.9,regY:63.9,skewX:-160.2664,skewY:19.7336,x:390.65,y:336}},{t:this.btnAnterior4}]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCerrar).wait(1).to({y:-2.15},0).wait(1).to({x:978.2,y:56.55},0).wait(1).to({x:940.1,y:72.25},0).wait(1));

	// texto
	this.instance_1 = new lib._1_1();
	this.instance_1.setTransform(102,79,0.5,0.5);
	...
	this.instance_5.setTransform(69,25,0.5,0.5395);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({scaleY:0.6276,x:68,y:-20},0).wait(1).to({scaleY:0.5645,x:317,y:43},0).wait(1).to({scaleY:0.4936,x:281,y:61},0).wait(1));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1723395390001", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1723395390066", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1723395390066", id:"ayuda2"},
		{src:"sounds/ayuda3.mp3?1723395390066", id:"ayuda3"},
		{src:"sounds/ayuda4.mp3?1723395390066", id:"ayuda4"},
		{src:"sounds/ayuda5.mp3?1723395390066", id:"ayuda5"}
	],
	preloads: []
};
