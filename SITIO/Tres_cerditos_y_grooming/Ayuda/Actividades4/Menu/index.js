...
(lib.screencapture1270018090indexhtml2024042313_36_29 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(12);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-602.8,273.15,1,1,0,0,0,64.9,63.9);
	...
	this.btnStopSonido2.setTransform(-473.45,127.95,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.btnStopSonido3.setTransform(-366.15,126.6,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido3, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1},{t:this.btnSiguiente1},{t:this.instance,p:{regX:64.9,skewX:0,skewY:0,x:-602.8,y:273.15,regY:63.9}}]}).to({state:[{t:this.btnStopSonido2},{t:this.btnSiguiente2},{t:this.instance,p:{regX:65,skewX:-157.7594,skewY:22.2406,x:-826.4,y:412.3,regY:63.9}},{t:this.btnAnterior2}]},1).to({state:[{t:this.btnStopSonido3},{t:this.instance,p:{regX:129.8,skewX:165.0008,skewY:-14.9992,x:-578.6,y:314.6,regY:127.7}},{t:this.btnAnterior3}]},1).wait(1));

	// cerrar
	this.btnCerrar1 = new lib.cerrar();
	this.btnCerrar1.name = "btnCerrar1";
	this.btnCerrar1.setTransform(-161.75,353.8,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar1, 0, 1, 2);

	this.btnCerrar2 = new lib.cerrar();
	this.btnCerrar2.name = "btnCerrar2";
	this.btnCerrar2.setTransform(-150.9,132.9,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar2, 0, 1, 2);

	this.btnCerrar3 = new lib.cerrar();
	this.btnCerrar3.name = "btnCerrar3";
	this.btnCerrar3.setTransform(-43.35,132,1,1,0,0,0,30.8,30.8);
	...
	this.instance_1.setTransform(-681,389,0.5,0.5);

	this.instance_2 = new lib._2_3();
	this.instance_2.setTransform(-727,175,0.5,0.5);

	this.instance_3 = new lib._3_1();
	this.instance_3.setTransform(-598,164,0.5,0.5);
	...
	this.instance_4.setTransform(-810,337,0.5,0.5237);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({scaleY:0.5527,x:-814,y:121},0).wait(1).to({scaleY:0.4531,x:-704,y:119},0).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.698)").s().p("");
	this.shape.setTransform(-490.967,314.0043);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.698)").s().p("");
	this.shape_1.setTransform(-626.4744,302.8405);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(0,197,255,0)").ss(1,1,1).p("ApthgITbAAIAADBIzbAAg");
	this.shape_2.setTransform(-696.475,475.825);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(0,0,0,0.698)").s().p("");
	this.shape_3.setTransform(-590.1239,373.0605);
...
p.nominalBounds = new cjs.Rectangle(-1408.4,-139,1834.9,1020.7);
...
if (reversed == null) { reversed = false; }
	...
	this.ayuda.setTransform(1326.9,73.9);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.698)").s().p("AhkI+QiDgXhphJQhphJhChyQhChzgLh/QgIhZAVhZQAUhZAuhNQAuhOBFg9QBEg8BSglQB8g4CKAFQCMAFB3BBQB3BABQBzQBRByAUCGQAUCFgrCFQgsCFhfBgQhvBwicAqQhJAThLAAQgzAAg1gJg");
	this.shape.setTransform(262.0279,-189.8854);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.ayuda}]}).wait(1));

	// Capa_1
	this.instance = new lib.screencapture1270018090indexhtml2024042313_36_29();
...
p.nominalBounds = new cjs.Rectangle(601.5,135.8,1151.9,705.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1722463703482", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1722463703602", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1722463703602", id:"ayuda2"},
		{src:"sounds/ayuda3.mp3?1722463703602", id:"ayuda3"},
		{src:"sounds/ayuda4.mp3?1722463703602", id:"ayuda4"},
		{src:"sounds/ayuda5.mp3?1722463703602", id:"ayuda5"}
	],
	preloads: []
};
