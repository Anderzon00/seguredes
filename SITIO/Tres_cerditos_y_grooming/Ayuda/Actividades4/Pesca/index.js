...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,1263,1239,351],[1359,866,63,63],[1424,866,60,60],[1359,741,123,123],[1241,1263,322,321],[0,741,1357,520],[0,0,1440,739]]}
];
...
(lib.screencapture1270018090indexhtml2024042221_19_59 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido1.setTransform(799.35,-155,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.instance.setTransform(399.95,42,0.9999,0.9999,-82.5516,0,0,78.5,72);

	this.btnStopSonido1 = new lib.btnStopSonido();
	this.btnStopSonido1.name = "btnStopSonido1";
	this.btnStopSonido1.setTransform(800.7,-155,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.btnCerrar1.setTransform(1123.25,-150.05,1,1,0,0,0,30.8,30.8);
	...
	this.instance_1.setTransform(496,-95,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// cuadro
	this.instance_2 = new lib.FondoTexto();
	this.instance_2.setTransform(437,-162,0.5339,0.5552);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.698)").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.screencapture1270018090indexhtml2024042221_19_59();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1722463764033", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1722463764082", id:"ayuda1"}
	],
	preloads: []
};
