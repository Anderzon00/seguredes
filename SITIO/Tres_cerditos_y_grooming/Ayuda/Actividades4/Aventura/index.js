...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,1263,997,310],[999,1263,984,225],[1442,0,355,105],[1442,213,355,104],[1359,1064,356,105],[1442,107,356,104],[1799,0,63,63],[1567,319,60,60],[1442,319,123,123],[1359,741,322,321],[0,741,1357,520],[0,0,1440,739]]}
];
...
(lib.screencapturemasterd2ovn6qahf2n97amplifyapp2024042221_07_54 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(11);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido1.setTransform(717.5,-96.65,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido1, 0, 1, 2);

	this.btn_sonido2 = new lib.btn_sonido();
	this.btn_sonido2.name = "btn_sonido2";
	this.btn_sonido2.setTransform(616.1,64.5,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido2, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btn_sonido1}]}).to({state:[{t:this.btn_sonido2}]},1).wait(1));

	// navegacion
	this.instance = new lib.flecha();
	this.instance.setTransform(456.95,163.45,0.9999,0.9999,0,-153.9757,26.0243,78.5,72);

	this.btnSiguiente1 = new lib.siguiente();
	this.btnSiguiente1.name = "btnSiguiente1";
	this.btnSiguiente1.setTransform(717.25,143.55,1,1,0,0,0,89,26.2);
	...
	this.btnStopSonido1.setTransform(718.85,-96.65,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido1, 0, 1, 2);

	this.btnAnterior2 = new lib.anterior();
	this.btnAnterior2.name = "btnAnterior2";
	this.btnAnterior2.setTransform(616,260.35,1,1,0,0,0,88.8,26.2);
	...
	this.btnStopSonido2.setTransform(617.45,64.5,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido2, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1},{t:this.btnSiguiente1},{t:this.instance,p:{regX:78.5,regY:72,scaleX:0.9999,scaleY:0.9999,skewX:-153.9757,skewY:26.0243,x:456.95,y:163.45}}]}).to({state:[{t:this.btnStopSonido2},{t:this.instance,p:{regX:64.9,regY:63.9,scaleX:1,scaleY:1,skewX:0,skewY:180,x:440,y:48.15}},{t:this.btnAnterior2}]},1).wait(1));

	// cerrar
	this.btnCerrar1 = new lib.cerrar();
	this.btnCerrar1.name = "btnCerrar1";
	this.btnCerrar1.setTransform(1041.4,-91.7,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar1, 0, 1, 2);

	this.btnCerrar2 = new lib.cerrar();
	this.btnCerrar2.name = "btnCerrar2";
	this.btnCerrar2.setTransform(940,69.45,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar2, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnCerrar1}]}).to({state:[{t:this.btnCerrar2}]},1).wait(1));

	// texto
	this.instance_1 = new lib._1_6();
	this.instance_1.setTransform(478,-36,0.5,0.5);

	this.instance_2 = new lib._2_4();
	this.instance_2.setTransform(350,119,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},1).wait(1));

	// cuadro
	this.instance_3 = new lib.FondoTexto();
	this.instance_3.setTransform(378,-104,0.5,0.5709);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({scaleY:0.4917,x:277,y:59},0).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AcrEtQAAEHlkC6QlkC6n3AAQn4AAlji6Qlji6AAkHQAAkHFji5QFji6H4AAQH3AAFkC6QFkC5AAEHgA8qulQAAAAAAgB");
	this.shape.setTransform(191.575,172.45);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8rMAAAh3/MCGeAAAIAAhWIB/AEQBmADDKAAIahADIAoAHQApAJBnAaQBcAYA1AJIAEABMAogAAAMAAAB3/gEg/+AIaQljC6gBEHQABEHFjC6QFkC6H3AAQH4AAFki6QFji6AAkHQAAkHlji6Qlki6n4AAQn3AAlkC6gEhY5gD2IAUAAIgUgCIAAACg");
	this.shape_1.setTransform(577.1,103.825);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1).p("AAAABQAAgBAAAA");
	this.shape_2.setTransform(8.1007,79);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(74,74,74,0.698)").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.screencapturemasterd2ovn6qahf2n97amplifyapp2024042221_07_54();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1713838704405", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1713838704451", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1713838704451", id:"ayuda2"}
	],
	preloads: []
};
