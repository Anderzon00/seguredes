...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,0,1440,739],[1442,0,1440,739]]},
		{name:"index_atlas_P_2", frames: [[999,1263,998,234],[0,1263,997,294],[1442,0,355,105],[1442,213,355,104],[1359,1064,356,105],[1442,107,356,104],[1799,0,63,63],[1567,319,60,60],[1442,319,123,123],[1359,741,322,321],[0,741,1357,520],[0,0,1440,739]]}
];
...
(lib.screencapture1270018090indexhtml2024042221_27_13 = function() {
...
(lib.screencapture1270018090indexhtml2024042221_27_26 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido1.setTransform(897.45,170.55,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido1, 0, 1, 2);

	this.btn_sonido2 = new lib.btn_sonido();
	this.btn_sonido2.name = "btn_sonido2";
	this.btn_sonido2.setTransform(784.05,188.45,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.instance.setTransform(534.8,281.45,0.9999,0.9999,0,-93.9754,86.0246,78.5,72);

	this.btnSiguiente1 = new lib.siguiente();
	this.btnSiguiente1.name = "btnSiguiente1";
	this.btnSiguiente1.setTransform(897.2,383.75,1,1,0,0,0,89,26.2);
	...
	this.btnStopSonido1.setTransform(898.8,170.55,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido1, 0, 1, 2);

	this.btnAnterior2 = new lib.anterior();
	this.btnAnterior2.name = "btnAnterior2";
	this.btnAnterior2.setTransform(783.95,416.15,1,1,0,0,0,88.8,26.2);
	...
	this.btnStopSonido2.setTransform(785.4,188.45,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido2, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1},{t:this.btnSiguiente1},{t:this.instance,p:{regX:78.5,regY:72,scaleX:0.9999,scaleY:0.9999,skewX:-93.9754,skewY:86.0246,x:534.8,y:281.45}}]}).to({state:[{t:this.btnStopSonido2},{t:this.instance,p:{regX:57.4,regY:34.9,scaleX:1,scaleY:1,skewX:-90.0009,skewY:89.9991,x:493.55,y:177.05}},{t:this.btnAnterior2}]},1).wait(1));

	// cerrar
	this.btnCerrar1 = new lib.cerrar();
	this.btnCerrar1.name = "btnCerrar1";
	this.btnCerrar1.setTransform(1221.35,175.5,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar1, 0, 1, 2);

	this.btnCerrar2 = new lib.cerrar();
	this.btnCerrar2.name = "btnCerrar2";
	this.btnCerrar2.setTransform(1107.95,193.4,1,1,0,0,0,30.8,30.8);
	...
	this.instance_1.setTransform(658,231,0.5,0.5);

	this.instance_2 = new lib._2_3();
	this.instance_2.setTransform(535,241,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},1).wait(1));

	// cuadro
	this.instance_3 = new lib.FondoTexto();
	this.instance_3.setTransform(558,164,0.5,0.5275);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({scaleY:0.5467,x:445,y:183},0).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AaPLVQgIAFgJAFA6OulQAAAAAAgBAMKOoQgBAAgCAAQipAAiZgW");
	this.shape.setTransform(176.025,172.45);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.698)").s().p("");
	this.shape_1.setTransform(577.1,103.825);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1).p("AzMulQAAAAAAgBATNOoQgCAAgBAAQiqAAiZgW");
	this.shape_2.setTransform(130.975,172.45);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(0,0,0,0.698)").s().p("");
	this.shape_3.setTransform(479.9625,103.825);
	...
	// Capa_2
	this.instance_4 = new lib.screencapture1270018090indexhtml2024042221_27_13();
	this.instance_4.setTransform(-106,-276,0.9486,1.0392);

	this.instance_5 = new lib.screencapture1270018090indexhtml2024042221_27_26();
	this.instance_5.setTransform(-106,-276,0.9486,1.0392);
...
p.nominalBounds = new cjs.Rectangle(-300.2,-284.4,1560.3,776.5);
...
p.nominalBounds = new cjs.Rectangle(682.9,375.5,683.1,392.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1713839990984", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1713839990985", id:"index_atlas_P_2"},
		{src:"sounds/ayuda1.mp3?1713839991054", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1713839991054", id:"ayuda2"}
	],
	preloads: []
};
