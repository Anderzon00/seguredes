...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[4013,0,64,78],[656,649,286,85],[367,649,287,85],[4013,151,63,63],[4013,216,60,60],[492,736,129,112],[623,736,127,99],[4079,29,13,16],[4080,0,16,27],[3154,499,448,429],[3681,0,330,356],[3604,499,425,424],[2676,499,476,408],[3627,0,50,45],[3627,47,31,27],[1250,750,95,93],[0,649,198,194],[367,736,123,123],[752,736,112,94],[2096,622,176,324],[4013,80,65,69],[3681,358,201,134],[1207,0,2047,192],[2487,622,165,165],[200,649,165,165],[3884,358,150,117],[947,388,152,89],[866,750,382,25],[2274,622,211,211],[3256,0,184,182],[1101,388,102,102],[1207,194,1235,303],[947,499,1727,121],[2444,194,1235,303],[0,0,1205,386],[947,622,1147,126],[0,388,945,259],[3442,0,183,175]]}
];
...
(lib.Prohibidopngcopia = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(29);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-16,-19.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-16,-19.5,32,39);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PiernaAdelante();
	this.instance.setTransform(-37.5,-29.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-37.5,-29.2,75,58.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CarpetaVioleta();
	this.instance.setTransform(-31.75,-24.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-31.7,-24.7,63.5,49.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ImgAzul();
	this.instance.setTransform(-23.75,-23.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-23.7,-23.2,47.5,46.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ImgRosado();
	this.instance.setTransform(-30.75,-30.75,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ImgPurpura();
	this.instance.setTransform(-49.5,-48.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-49.5,-48.5,99,97);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Nube_1();
	this.instance.setTransform(-50.25,-33.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-50.2,-33.5,100.5,67);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-33.25,-33.25,0.3614,0.3654);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-48.15,-88.65,0.5472,0.5472);
...
p.nominalBounds = new cjs.Rectangle(-48.1,-88.6,96.30000000000001,177.3);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CorazonDer();
	this.instance.setTransform(-3.25,-4,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-3.2,-4,6.5,8);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CorazonIzq();
	this.instance.setTransform(-4,-6.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-4,-6.7,8,13.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PiernaAtras();
	this.instance.setTransform(-22.75,-21.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-22.7,-21.5,76,44.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-25.5,-25.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-25.5,-25.5,91.5,87.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ManoSeñala();
	this.instance.setTransform(-16.25,-16.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-16.2,-16.5,56,47);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Forma_1();
	this.instance.setTransform(-16.5,-16.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-16.5,-16.5,15.5,13.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Forma();
	this.instance.setTransform(-38.25,-40.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-38.2,-40.7,25.000000000000004,22.500000000000004);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PerfilNiño();
	this.instance.setTransform(-29.25,-29.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-29.2,-29.7,82.5,82.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Prohibidopngcopia();
	this.instance.setTransform(-42,-85.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-42,-85.2,92,91);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PerfilIncognito();
	this.instance.setTransform(-35.75,-36.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-35.7,-36.5,82.5,82.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-31,-25,0.5198,0.5201);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#3399FF").s().p("AssDuIAAnbIZZAAIAAHbg");
	this.shape.setTransform(41.375,0.8);
...
p.nominalBounds = new cjs.Rectangle(-39.9,-25,162.6,49.6);
...
p.nominalBounds = new cjs.Rectangle(-45.5,-17.1,48.9,49.300000000000004);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		_this.btnInteractionD.on('click', function(){
		/*
	...
	this.instance.setTransform(71.4,112.8,1,1,18.5599,0,0,-14.5,-17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:44.9994,x:71.45},24).to({rotation:18.5599,x:71.4},25).wait(1));

	// IconStop.png
	this.instance_1 = new lib.Interpolación12("synched",0);
	this.instance_1.setTransform(13,89);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50));

	// PiernaAdelante.png
	this.instance_2 = new lib.Interpolación24("synched",0);
	this.instance_2.setTransform(60.5,152.45,1,1,0,0,0,28,-25.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:-25.7,rotation:-67.7549,x:60.6,y:152.6},24).to({regY:-25.8,rotation:0,x:60.5,y:152.45},25).wait(1));

	// IconAlerta.png
	this.instance_3 = new lib.Interpolación13("synched",0);
	this.instance_3.setTransform(51.6,149.5,1,1,43.0256,0,0,-15.3,-18.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:-15.4,regY:-18.8,rotation:118.0252,x:59.1,y:153.05},24).to({regX:-15.3,regY:-18.9,rotation:43.0256,x:51.6,y:149.5},25).wait(1));

	// btn
	this.btnInteractionD = new lib.btnInteractivo();
	this.btnInteractionD.name = "btnInteractionD";
	this.btnInteractionD.setTransform(126.9,199.5,1,1,0,0,0,-21.1,7.5);
	new cjs.ButtonHelper(this.btnInteractionD, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.btnInteractionD).wait(50));

	// TapaCarpetaIzq.png
	this.instance_4 = new lib.Fondopngcopia2();
	this.instance_4.setTransform(-26,66,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-26,63.5,177.7,180.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		Al hacer clic en la instancia del símbolo especificada, se ejecuta una función.
		*/
		_this.btnInteractionC.on('click', function(){
		/*
		Mueve la cabeza lectora al número de fotograma especificado en la línea de tiempo y continúa la reproducción desde dicho fotograma.
		Se puede utilizar en la línea de tiempo principal o en líneas de tiempo de clips de película.
		*/
	...
	// btn
	this.btnInteractionC = new lib.btnInteractivo();
	this.btnInteractionC.name = "btnInteractionC";
	this.btnInteractionC.setTransform(602.4,-63.5,1,1,0,0,0,-21.1,7.5);
	new cjs.ButtonHelper(this.btnInteractionC, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.btnInteractionC).wait(55).to({x:589.4,y:-30.5},0).wait(1));

	// Fondo.png
	this.instance = new lib.Interpolación5("synched",0);
	this.instance.setTransform(466.1,-106.55,1,1,0,0,0,4,-39.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},27).to({startPosition:0},28).wait(1));

	// Fondo_2.png
	this.instance_1 = new lib.Fondo_1pngcopia();
	this.instance_1.setTransform(341,-214,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(56));

	// Capa_5
	this.instance_2 = new lib.Interpolación4("synched",0);
	this.instance_2.setTransform(386.9,-91.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:-101.5},27).to({y:-91.5},28).wait(1));

	// Guardar.png
	this.instance_3 = new lib.Interpolación6("synched",0);
	this.instance_3.setTransform(519.35,-140.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:-130.25},27).to({y:-140.25},28).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(341,-214,286.20000000000005,208.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		Al hacer clic en la instancia del símbolo especificada, se ejecuta una función.
		*/
		_this.btnInteractionB.on('click', function(){
		/*
		Mueve la cabeza lectora al número de fotograma especificado en la línea de tiempo y continúa la reproducción desde dicho fotograma.
		Se puede utilizar en la línea de tiempo principal o en líneas de tiempo de clips de película.
		*/
	...
	this.btnInteractionB.setTransform(267.65,10.05,1,1,0,0,0,-21.1,7.5);
	new cjs.ButtonHelper(this.btnInteractionB, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.btnInteractionB).wait(60));

	// Capa_7
	this.instance = new lib.Interpolación18("synched",0);
	this.instance.setTransform(417.25,-140.75);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.6992,scaleY:0.6992,y:-136.75},29).to({scaleX:1,scaleY:1,y:-140.75},30).wait(1));

	// Esposas.png
	this.instance_1 = new lib.Interpolación8("synched",0);
	this.instance_1.setTransform(351.85,-140.75,1,1,0,0,0,-24.4,-29.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:-29.6,scaleX:1.4484,scaleY:1.4484,x:351.8,y:-140.9},14).to({regY:-29.5,scaleX:1,scaleY:1,x:358.55,y:-152.75},15).to({regY:-29.6,scaleX:1.5333,scaleY:1.5333,x:355.85,y:-145.95},15).to({regY:-29.5,scaleX:1,scaleY:1,x:351.85,y:-140.75},15).wait(1));

	// Contestar.png
	this.instance_2 = new lib.Interpolación9("synched",0);
	this.instance_2.setTransform(275.5,-61);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:-64.5},29).to({y:-61},30).wait(1));

	// Capa_2
	this.instance_3 = new lib.Nube();
	this.instance_3.setTransform(255,-84,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(60));

	// Capa_6
	this.instance_4 = new lib.Interpolación15("synched",0);
	this.instance_4.setTransform(382,-78.95,1,1,0,0,0,2,6.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:2.1,regY:6.2,rotation:-14.9992,x:382.1,y:-79.05},29).to({regX:2,regY:6.3,rotation:0,x:382,y:-78.95},30).wait(1));

	// CorazonDer.png
	this.instance_5 = new lib.Interpolación16("synched",0);
	this.instance_5.setTransform(384.1,-83,1,1,0,0,0,-1.7,3.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({rotation:4.2116,x:385.55,y:-84.15},29).to({rotation:0,x:384.1,y:-83},30).wait(1));

	// Nube.png
	this.instance_6 = new lib.Nube();
	this.instance_6.setTransform(395.5,-101,0.5,0.5,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(60));

	// Capa_3 copia copia
	this.instance_7 = new lib.Interpolación10("synched",0);
	this.instance_7.setTransform(428.8,37.9,1,1,180,0,0,-16.2,-16.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:-16.3,scaleX:1.1071,scaleY:1.1766,x:428.95},29).to({regX:-16.2,scaleX:1,scaleY:1,x:428.8},30).wait(1));

	// Capa_3 copia
	this.instance_8 = new lib.Interpolación10("synched",0);
	this.instance_8.setTransform(239,37.9,0.897,0.897,0,180,0,-16.3,-16.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:-16.2,regY:-16.6,scaleX:0.969,scaleY:1.0525,x:239.05,y:37.95},29).to({regX:-16.3,regY:-16.5,scaleX:0.897,scaleY:0.897,x:239,y:37.9},30).wait(1));

	// celular
	this.instance_9 = new lib.Interpolación17("synched",0);
	this.instance_9.setTransform(335.15,38.35,1,1,0,0,0,0,88.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({regX:0.2,regY:88.4,scaleX:1.0565,scaleY:1.1336,x:335.1,y:38.85},29).to({regX:0,regY:88.7,scaleX:1,scaleY:1,x:335.15,y:38.35},30).wait(1));

	// Capa_3
	this.instance_10 = new lib.Interpolación10("synched",0);
	this.instance_10.setTransform(255.6,-172.65,0.897,0.897,0,0,0,0,-15);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({scaleX:1.0481,scaleY:1.0659},29).to({scaleX:0.897,scaleY:0.897},30).wait(1));

	// Capa_4
	this.instance_11 = new lib.Fondo1a();
	this.instance_11.setTransform(228,-174,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(228,-174.3,222.5,213.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		Al hacer clic en la instancia del símbolo especificada, se ejecuta una función.
		*/
		_this.btnInteractionA.on('click', function(){
		/*
		Mueve la cabeza lectora al número de fotograma especificado en la línea de tiempo y continúa la reproducción desde dicho fotograma.
		Se puede utilizar en la línea de tiempo principal o en líneas de tiempo de clips de película.
		*/
	...
	this.instance.setTransform(-6.25,240.25);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-14.25,y:231.25},27).to({x:-6.25,y:240.25},28).wait(1));

	// btnInteractionA
	this.btnInteractionA = new lib.btnInteractivo();
	this.btnInteractionA.name = "btnInteractionA";
	this.btnInteractionA.setTransform(-70.6,224,1,1,0,0,0,-21.1,7.5);
	new cjs.ButtonHelper(this.btnInteractionA, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.btnInteractionA).wait(56));

	// ImgPurpura.png
	this.instance_1 = new lib.Interpolación20("synched",0);
	this.instance_1.setTransform(-39.5,259.5,1,1,0,0,0,-23,45);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:-23.1,rotation:-24.2013,x:-39.55,y:259.55},27).to({regX:-23,rotation:0,x:-39.5,y:259.5},28).wait(1));

	// ImgRosado.png
	this.instance_2 = new lib.Interpolación21("synched",0);
	this.instance_2.setTransform(42.75,220.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:204.75},27).to({y:220.75},28).wait(1));

	// Nube_1.png
	this.instance_3 = new lib.Interpolación19("synched",0);
	this.instance_3.setTransform(-0.75,160.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:152.5},27).to({y:160.5},28).wait(1));

	// CarpetaROja.png
	this.instance_4 = new lib.CarpetaROja();
	this.instance_4.setTransform(-94,195,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(56));

	// CarpetaVioleta.png
	this.instance_5 = new lib.Interpolación23("synched",0);
	this.instance_5.setTransform(49.75,183.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:58.75},27).to({x:49.75},28).wait(1));

	// Fondo.png copia
	this.instance_6 = new lib.Fondopngcopia();
	this.instance_6.setTransform(-143,60,0.6788,0.6025);
...
p.nominalBounds = new cjs.Rectangle(-143,60,233.5,214.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.btnAdelabnteA.addEventListener("click", fl_ClickToGoToAndStopAtFrame_2.bind(this));
	...
	this.frame_1 = function() {
		...
		this.btnAtrasB.addEventListener("click", fl_ClickToGoToAndStopAtFrame_4.bind(this));
		...
		*/
		...
		Al hacer clic en la instancia del símbolo especificada, se ejecuta una función.
		*/
		_this.btnAadelanteB.on('click', function(){
		
			createjs.Sound.play("generales").on("complete", function () {                    
			_this.gotoAndStop(2);
		                    }, this);; 
	...
	this.frame_2 = function() {
		...
		height = 8 * Math.max(window.innerHeight) / 16;
		width = 27.85 * (Math.max(window.innerWidth) / 32);
		topElement = 4.5 * Math.max(window.innerHeight) / 16 + 'px';
	...
	this.btn_sonido3.setTransform(948.3,510.45,1,1,0,0,0,15.8,15.8);
	...
	this.btn_sonido4.setTransform(360.05,310.9,1,1,0,0,0,15.8,15.8);
	...
	this.btnStopSonido6.setTransform(904.45,151);
	new cjs.ButtonHelper(this.btnStopSonido6, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1},{t:this.btn_sonido1},{t:this.btnStopSonido2},{t:this.btn_sonido2},{t:this.btnStopSonido3},{t:this.btn_sonido3}]}).to({state:[{t:this.btnStopSonido5},{t:this.btn_sonido5},{t:this.btnStopSonido4},{t:this.btn_sonido4}]},1).to({state:[{t:this.btnStopSonido6},{t:this.btn_sonido6}]},1).wait(1));

	// imagenes
	this.instance = new lib.MC2();
	this.instance.setTransform(922.9,306.15,1,1,0,0,0,339.2,-61);

	this.instance_1 = new lib.Parrafo1();
	this.instance_1.setTransform(71,124,0.5,0.5);

	this.instance_2 = new lib.Texto1();
	this.instance_2.setTransform(133,205,0.5,0.5);

	this.instance_3 = new lib.Texto2_1();
	this.instance_3.setTransform(397,395,0.5,0.5);

	this.instance_4 = new lib.MC1();
	this.instance_4.setTransform(237.9,418.85,1,1,0,0,0,-30.8,167.2);

	this.instance_5 = new lib.MC3();
	this.instance_5.setTransform(893.35,229,1,1,0,0,0,483.9,-112);

	this.instance_6 = new lib.Texto2_2();
	this.instance_6.setTransform(119,138,0.5,0.5);

	this.instance_7 = new lib.Texto4();
	this.instance_7.setTransform(138,416,0.5,0.5);

	this.instance_8 = new lib.MC4();
	this.instance_8.setTransform(1145.8,294.3,1,1,0,0,0,328.2,-8.2);

	this.instance_9 = new lib.Texto1_1();
	this.instance_9.setTransform(164,122,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]},1).to({state:[{t:this.instance_9}]},1).wait(1));

	// titulo
	this.instance_10 = new lib.posicion();
	this.instance_10.setTransform(490,547,0.5,0.5);

	this.instance_11 = new lib.titulo();
	this.instance_11.setTransform(387,7,0.4197,0.4197);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_11},{t:this.instance_10}]}).wait(3));

	// flechas
	this.btnAdelabnteA = new lib.btnSiguiente();
	this.btnAdelabnteA.name = "btnAdelabnteA";
	this.btnAdelabnteA.setTransform(745.5,605.5,0.5,0.5,0,0,0,51,51);
	new cjs.ButtonHelper(this.btnAdelabnteA, 0, 1, 2, false, new lib.btnSiguiente(), 3);
	...
	this.btnAadelanteB = new lib.btnSiguiente();
	this.btnAadelanteB.name = "btnAadelanteB";
	this.btnAadelanteB.setTransform(745.75,605.55,0.5,0.5,0,0,0,51,51);
	new cjs.ButtonHelper(this.btnAadelanteB, 0, 1, 2, false, new lib.btnSiguiente(), 3);

	this.btnAtrasB = new lib.btnSiguiente();
	this.btnAtrasB.name = "btnAtrasB";
	this.btnAtrasB.setTransform(422.5,605.5,0.5,0.5,0,0,180,51,51);
	new cjs.ButtonHelper(this.btnAtrasB, 0, 1, 2, false, new lib.btnSiguiente(), 3);

	this.btnAadelanteC = new lib.btnSiguiente();
	this.btnAadelanteC.name = "btnAadelanteC";
	this.btnAadelanteC.setTransform(745.75,605.55,0.5,0.5,0,0,0,51,51);
	new cjs.ButtonHelper(this.btnAadelanteC, 0, 1, 2, false, new lib.btnSiguiente(), 3);

	this.btnAtrasC = new lib.btnSiguiente();
	this.btnAtrasC.name = "btnAtrasC";
	this.btnAtrasC.setTransform(422.5,605.5,0.5,0.5,0,0,180,51,51);
	new cjs.ButtonHelper(this.btnAtrasC, 0, 1, 2, false, new lib.btnSiguiente(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnAtras},{t:this.btnAdelabnteA}]}).to({state:[{t:this.btnAtrasB},{t:this.btnAadelanteB}]},1).to({state:[{t:this.btnAtrasC},{t:this.btnAadelanteC}]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnIndice).wait(3));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(525.7,195,662.2,485.70000000000005);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_1.png?1693790471893", id:"index_atlas_1"},
		{src:"sounds/audio1.mp3?1693790472027", id:"audio1"},
		{src:"sounds/audio2.mp3?1693790472027", id:"audio2"},
		{src:"sounds/audio3.mp3?1693790472027", id:"audio3"},
		{src:"sounds/audio4.mp3?1693790472027", id:"audio4"},
		{src:"sounds/audio5.mp3?1693790472027", id:"audio5"},
		{src:"sounds/audio6.mp3?1693790472027", id:"audio6"},
		{src:"sounds/generales.mp3?1693790472027", id:"generales"},
		{src:"sounds/indice.mp3?1693790472027", id:"indice"},
		{src:"sounds/QuestionSoundEffect.mp3?1693790472027", id:"QuestionSoundEffect"}
	],
	preloads: []
};
