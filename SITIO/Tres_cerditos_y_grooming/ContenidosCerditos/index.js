...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:true},1).wait(35));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:8.9716},24).to({rotation:0},25).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance_6.setTransform(-113,290,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1));

	// mano
	this.cuerpo = new lib.mano();
	this.cuerpo.name = "cuerpo";
	this.cuerpo.setTransform(43.2,12.5,1,1,0,0,0,139.2,178);

	this.timeline.addTween(cjs.Tween.get(this.cuerpo).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		iframek.src = './Ayuda/Contenidos/C4/index.html';
	...
	this.btnQueEs.setTransform(188.15,167.75);
	...
	this.instance.setTransform(120,39,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.btnComoOcurre},{t:this.btnComoEvitarlo},{t:this.btnSiMeOcurre},{t:this.btnContenidoExtra},{t:this.btnQueEs}]}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(663.7,360,483.29999999999995,258.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1723345378528", id:"index_atlas_1"},
		{src:"sounds/CLOCKTick_Stopwatch2_ID2138_BSB.mp3?1723345378608", id:"CLOCKTick_Stopwatch2_ID2138_BSB"},
		{src:"sounds/sound.mp3?1723345378608", id:"sound"}
	],
	preloads: []
};
