...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,2555,2377,64],[1450,1883,80,80],[0,2244,2377,76],[1532,1883,80,80],[0,2621,2377,63],[3152,345,81,80],[2290,1775,81,80],[0,2322,2377,76],[3110,453,81,81],[2290,1857,80,81],[0,2165,2377,77],[1695,1883,79,79],[1614,1883,79,80],[0,2478,2377,75],[0,2400,2377,76],[2377,0,635,669],[2199,1893,59,30],[2028,1944,46,24],[1848,1927,72,35],[3152,427,72,18],[1776,1883,70,67],[3014,0,222,185],[3014,187,220,156],[3236,193,156,136],[1848,1883,110,42],[601,1448,539,493],[2385,671,321,446],[0,0,2375,1137],[0,1972,2376,129],[0,1448,599,522],[1183,1139,599,532],[1784,1139,599,522],[1960,1883,66,67],[2028,1883,56,59],[2142,1893,55,48],[2086,1893,54,52],[2378,1663,500,500],[2708,671,591,158],[2290,1663,59,110],[3014,345,136,106],[1142,1673,948,208],[1142,1883,306,31],[0,1139,1181,307],[2092,1663,196,228],[3238,0,184,191],[3014,453,94,142],[3236,331,124,127]]}
];
...
(lib.CespedFrenteEspantapajaros = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(24);
}).prototype = p = new cjs.Sprite();
...
(lib.ImaginacionBosque = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(29);
}).prototype = p = new cjs.Sprite();
...
(lib.ImaginacionPantano = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(31);
}).prototype = p = new cjs.Sprite();
...
(lib.texto7mc = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-994,26,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.texto7mc, new cjs.Rectangle(-994,26,1188.5,38), null);


(lib.texto6mc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.texto6mc, new cjs.Rectangle(-994,26,1188.5,37.5), null);


(lib.texto5mc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.texto5mc, new cjs.Rectangle(-994,26,1188.5,38.5), null);


(lib.texto4mc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.texto4mc, new cjs.Rectangle(-994,26,1188.5,38), null);
...
}).prototype = getMCSymbolPrototype(lib.texto2mc, new cjs.Rectangle(-972,26,1188.5,38), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-774,11,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.texto1mc, new cjs.Rectangle(-774,11,1188.5,32), null);
...
p.nominalBounds = new cjs.Rectangle(-594,-17.7,1188.5,31.5);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(89.38,54.3194);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(89.255,54.3206);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(89.38,54.0375);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[]},2).to({state:[{t:this.shape_1}]},68).to({state:[{t:this.shape_2}]},2).wait(3));

	// Capa_1
	this.instance = new lib.Cabeza1Mayor();
...
p.nominalBounds = new cjs.Rectangle(0,0,154,109.2);
...
(lib.izq = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.MangaMenor();
	this.instance.setTransform(0,40.5,0.75,0.75,-90);

	this.instance_1 = new lib.Brazo();
	this.instance_1.setTransform(20.25,4.05,0.7463,0.7463,18.4312);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.izq, new cjs.Rectangle(0,0,69.8,68), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-6.9,-35.45,0.7463,0.7463,35.2684);
...
p.nominalBounds = new cjs.Rectangle(-35.7,-35.4,71.5,70.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-407.75,-39.5,0.5,0.5);

	this.instance_1 = new lib.Nube();
	this.instance_1.setTransform(112.25,-39.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-407.7,-39.5,815.5,79);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ElisMolino();
	this.instance.setTransform(-134.75,-123.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-134.7,-123.2,269.5,246.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Brazo();
	this.instance.setTransform(-21.3,-33,0.8113,0.8113,13.4458);
...
p.nominalBounds = new cjs.Rectangle(-33.9,-33,67.9,66.1);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Espapajaros();
	this.instance.setTransform(-82,-113.9,0.5108,0.5108);
...
p.nominalBounds = new cjs.Rectangle(-82,-113.9,164,227.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.MangaMayor();
	this.instance.setTransform(-17.45,-22.5,0.7,0.7,5.6984);
...
p.nominalBounds = new cjs.Rectangle(-21.5,-22.5,43.1,45);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Brazo();
	this.instance.setTransform(-17.9,-34.95,0.8113,0.8113,19.1441);
...
p.nominalBounds = new cjs.Rectangle(-35.7,-34.9,71.5,69.9);
...
(lib.der = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.MangaMenor();
	this.instance.setTransform(0,4.4,0.75,0.75,-6.2207);

	this.instance_1 = new lib.Brazo();
	this.instance_1.setTransform(15.55,13.85,0.8113,0.8113,28.4445);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.der, new cjs.Rectangle(-10.3,0,75.8,88.7), null);
...
(lib.cara2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EFEEED").s().p("AgRAMIAAgEIABAAIAAABIAAAAIAAADgAANgLIAEADIABABIgFgEg");
	this.shape.setTransform(52.2375,36.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(67.9833,32.9693);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#EFEEED").s().p("AgRALIAAgDIABAAIAAABIAAABIAAABIgBAAgAANgKIAEADIABABIgFgEg");
	this.shape_2.setTransform(52.2375,36.775);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(67.6875,31.78);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(67.9833,32.4175);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[]},2).to({state:[{t:this.shape_3},{t:this.shape_2}]},72).to({state:[{t:this.shape_4},{t:this.shape}]},2).wait(2));

	// cara
	this.instance = new lib.BocaPequeña1();
	this.instance.setTransform(56,56,0.75,0.75);

	this.instance_1 = new lib.RostroPequeña1();
	this.instance_1.setTransform(0,0,0.8305,0.8305);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(78));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,113,88.1);


(lib.cabezacerdo = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(73.55,47.0467);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AizAlIAAgKQACgMAIgOQAFgHAEgFQAGgEAFgCQASgIAOAFQAGACAEADIAHAEQAFAEAEAHIAAAAIAJAFQAIAHACANIAAABQgDgEgKgDQgTgGgdAFQgWADgOAKQgFACgDAFIgCADIAAgEgABVgMQADgJAJgGQAFgDAKgEQAVgHALACQASADALASQAEAHADAJIgLgEQglgGglAPQgIAEgEAFQgCgOAEgKg");
	this.shape_1.setTransform(73.3375,44.0403);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(73.55,46.1528);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[]},2).to({state:[{t:this.shape_1}]},70).to({state:[{t:this.shape_2}]},2).wait(2));

	// Capa_1
	this.instance = new lib.Boca1Medio1();
	this.instance.setTransform(52,76,0.7,0.7);

	this.instance_1 = new lib.CabezaMedio1();
...
p.nominalBounds = new cjs.Rectangle(0,0,109.2,95.2);


(lib.brazoCerdo = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.MangaMedio();
	this.instance.setTransform(0,24.7,0.8314,0.8314,-32.7247);

	this.instance_1 = new lib.Brazo();
	this.instance_1.setTransform(23.35,19.25,0.8113,0.8113,19.73);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.brazoCerdo, new cjs.Rectangle(0,0,76.8,89.6), null);


(lib.boca5 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.Boca2Madre();
	this.instance.setTransform(0,0,0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},4).wait(1).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).wait(3));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,50.4,24.5);


(lib.boca3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},81).wait(1).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).wait(3));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},24).wait(1).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).wait(58));
...
(lib.boca1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},23).wait(2).to({_off:false},0).to({_off:true},4).wait(2).to({_off:false},0).wait(4).to({_off:true},2).wait(2).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false},0).wait(2).to({_off:true},1).wait(3).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false},0).to({_off:true},2).wait(4).to({_off:false},0).to({_off:true},2).wait(6).to({_off:false},0).wait(18).to({_off:true},2).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(2).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).wait(7));
...
(lib.texto3mc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.texto3mc, new cjs.Rectangle(-775,12,1188.5,31.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(571.7,39.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-549},1499).to({_off:true},1).wait(1498).to({_off:false,x:1475},0).to({x:571.7},1503).wait(1));

	// Capa_1 copia
	this.instance_1 = new lib.Interpolación8("synched",0);
	this.instance_1.setTransform(1475,39.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-541},4501).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-956.7,0,2839.5,79);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.Brazo();
	this.instance_1.setTransform(91.6,29.15,0.8113,0.8113,0,44.9749,-135.0251);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.instance = new lib.cabezacerdo();
	this.instance.setTransform(1.85,-18.75,1,1,7.6939,0,0,71.2,88.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:2.966,x:1.95},25).to({rotation:7.6939,x:1.85},24).wait(1));

	// brazoCerdo
	this.instance_1 = new lib.brazoCerdo();
	this.instance_1.setTransform(-25.45,-9.95,1,1,0,0,0,35.9,10.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:10.7,rotation:-5.4761,x:-25.5,y:-10.1},25).to({regY:10.8,rotation:0,x:-25.45,y:-9.95},24).wait(1));

	// Capa_1
	this.instance_2 = new lib.TorsoMedio2();
	this.instance_2.setTransform(-49.1,-21.2,0.8548,0.8548);

	this.instance_3 = new lib.MangaMedio();
	this.instance_3.setTransform(-2.9,23.15,0.8314,0.8314,-74.6455);

	this.instance_4 = new lib.Pierna();
	this.instance_4.setTransform(-14.1,61.8,0.5253,0.4223,0,0,180);

	this.instance_5 = new lib.Pierna();
	this.instance_5.setTransform(18.9,61.8,0.5253,0.4223,0,0,180);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]}).wait(50));

	// Capa_3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(38.3771,38.6738);

	// Brazo.png
	this.instance_6 = new lib.Interpolación11("synched",0);
	this.instance_6.setTransform(28.85,22.9,1,1,0,0,0,-5.6,4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:-5.5,regY:4.2,rotation:12.0273,x:28.8,y:23.1},25).to({regX:-5.6,regY:4,rotation:0,x:28.85,y:22.9},24).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-69.6,-116.3,127.1,224.6);


(lib.helice = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(134.75,123.25);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:98.5329,x:134.7},24).to({rotation:178.2425,y:123.2},25).to({rotation:268.2424,x:134.85,y:123.25},25).to({rotation:360,x:134.75},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-47.9,-59.3,365.29999999999995,365.3);


(lib.espantapajaros = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(82,227.95,1,1,-7.2426,0,0,0,114);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:9.9565},29).to({rotation:-7.2426},30).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-28,-10.7,230.1,252.79999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(77.3,8.25,1,1,-36.983,0,0,29.6,-29.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:29.5,rotation:-45.9434,x:77.25},24).to({regX:29.6,rotation:-36.983,x:77.3},25).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// Mangader
	this.instance = new lib.der();
	this.instance.setTransform(46.45,94.4,1,1,0,0,0,29.9,10.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:30,regY:10.8,rotation:9.7256,x:46.55,y:94.5},24).to({regX:29.9,regY:10.7,rotation:0,x:46.45,y:94.4},25).wait(1));

	// cara2
	this.instance_1 = new lib.cara2();
	this.instance_1.setTransform(73,77.5,1,1,0,0,0,73,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:3.9916,y:77.6},24).to({rotation:0,y:77.5},25).wait(1));

	// cuerpo
	this.instance_2 = new lib.TorsoPequeña1();
	this.instance_2.setTransform(12,75,0.8203,0.8203);

	this.instance_3 = new lib.Pierna();
	this.instance_3.setTransform(64,153,0.5253,0.4223,0,0,180);

	this.instance_4 = new lib.Pierna();
	this.instance_4.setTransform(108,154,0.5253,0.4223,0,0,180);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]}).wait(50));

	// Mangaizq
	this.instance_5 = new lib.izq();
	this.instance_5.setTransform(92.5,83.5,1,1,0,0,0,10.5,6.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({rotation:-3.9539,x:92.55,y:83.55},24).to({rotation:0,x:92.5,y:83.5},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-6.4,-8.8,162.4,209.3);


(lib.cerdo1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(69.1,216.4,1,1,0,0,0,0,108.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY:1.0277},49).to({regY:108.3,scaleY:1.0139,y:216.5},25).to({regY:108.2,scaleY:1,y:216.4},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-0.4,-14.3,139.70000000000002,230.8);


(lib.cerda3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Boca1Medio1.png
	this.instance = new lib.Boca1Medio1();
	this.instance.setTransform(72,93,0.5261,0.5261);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(33.6207,128.6441);

	// MangaMayor.png
	this.instance_1 = new lib.Interpolación3("synched",0);
	this.instance_1.setTransform(48.65,118.55,1,1,0,0,0,8.1,-11);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:-14.9994,x:48.6,y:118.5},24).to({rotation:0,x:48.65,y:118.55},25).wait(1));

	// Cabeza1Mayor.png
	this.instance_2 = new lib.Símbolo1();
	this.instance_2.setTransform(77,54.6,1,1,0,0,0,77,54.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(50));

	// Brazo.png
	this.instance_3 = new lib.Interpolación1("synched",0);
	this.instance_3.setTransform(53,162.55);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:-14.9994,x:64.2,y:159.9},24).to({rotation:0,x:53,y:162.55},25).wait(1));

	// Torso2Mayor.png
	this.instance_4 = new lib.Torso2Mayor();
	this.instance_4.setTransform(10,99,0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(50));

	// MangaMayor.png
	this.instance_5 = new lib.MangaMayor();
	this.instance_5.setTransform(95.1,145.05,0.7,0.7,-75.0001);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(50));

	// Brazo.png
	this.instance_6 = new lib.Interpolación6("synched",0);
	this.instance_6.setTransform(110.5,114.65,1,1,0,0,0,-22,-24.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:-21.9,regY:-24.4,rotation:4.4879,x:110.55,y:114.85},24).to({regX:-22,regY:-24.5,rotation:0,x:110.5,y:114.65},25).wait(1));

	// piernas
	this.instance_7 = new lib.Pierna();
	this.instance_7.setTransform(69.8,204,0.5223,0.5223,0,0,180);

	this.instance_8 = new lib.Pierna();
	this.instance_8.setTransform(122.8,203,0.5223,0.5223,0,0,180);
...
p.nominalBounds = new cjs.Rectangle(0,0,166.5,261.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_3
	this.instance = new lib.mano2();
	this.instance.setTransform(-124.45,17.25,0.314,0.314,179.432);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(21).to({y:35.25},0).wait(20));
...
p.nominalBounds = new cjs.Rectangle(-283,-139.7,158.6,219.7);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.cerda3();
	this.instance.setTransform(495.05,72.05,0.3282,0.3282,0,0,0,83.5,131.2);

	this.instance_1 = new lib.cerdo2();
	this.instance_1.setTransform(338.05,126,0.3017,0.3017,0,0,0,75.9,98.2);

	this.instance_2 = new lib.cerdo1();
	this.instance_2.setTransform(81.85,112,0.3711,0.3711,0,0,0,69.2,108.2);

	this.instance_3 = new lib.ImaginacionPantano();
	this.instance_3.setTransform(232,53,0.3364,0.3364);

	this.instance_4 = new lib.ImaginacionLago();
	this.instance_4.setTransform(432,0,0.3564,0.3564);

	this.instance_5 = new lib.ImaginacionBosque();
	this.instance_5.setTransform(0,35,0.3817,0.3817);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.nube, new cjs.Rectangle(0,0,645.5,234.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(164.45,128.9,1,1,14.7167,0,0,85.5,8.6);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.instance = new lib.TextoParaPlay();
	this.instance.setTransform(6,-172,0.4142,0.4142);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4));

	// Capa_1
	this.instance_1 = new lib.playintermitente();
	this.instance_1.setTransform(16.05,20.05,0.5,0.5,0,0,0,-189.9,40.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2},{t:this.shape}]},1).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.instance_2}]},2).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-30.5,-172,525.7,213);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(24).call(this.frame_24).wait(100).call(this.frame_124).wait(27));

	// Capa_4
	this.instance = new lib.nube();
	this.instance.setTransform(322.8,234.2,1,1,0,0,0,322.8,234.2);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},24).to({scaleY:1.111,y:234.25},50).to({scaleY:1,y:234.2},50).to({alpha:0},26).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-25.9,645.5,260.3);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_9 = function() {
		...
		_this.btnInteraccion.on('click', function(){	
			...
			_this.playSound("Interactividad", "voice", true, { volume: 0.1  });
			_this.burbujas.gotoAndPlay(1);
	...
	this.instance = new lib.siguienteescena();
	this.instance.setTransform(329,571,0.4346,0.4346);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.prev,p:{x:97.3}},{t:this.next,p:{x:143.1}},{t:this.pressToStart}]}).to({state:[{t:this.playaudio,p:{x:38.65}},{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.pause,p:{x:31.65}},{t:this.prev,p:{x:97.2}},{t:this.next,p:{x:143}}]},1).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance_1},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}},{t:this.nextescene},{t:this.instance}]},9).wait(1));

	// texto 1
	this.instance_2 = new lib.texto1mc();
	this.instance_2.setTransform(769.15,499.5,0.9703,1);

	this.instance_3 = new lib.texto3mc();
	this.instance_3.setTransform(769.15,499.5,0.9703,1);

	this.instance_4 = new lib.texto5mc();
	this.instance_4.setTransform(991.5,482.95,0.9703,1);

	this.instance_5 = new lib.texto7mc();
	this.instance_5.setTransform(987.15,482.7,0.9703,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_5}]},2).wait(3));

	// texto 2
	this.instance_6 = new lib.texto2mc();
	this.instance_6.setTransform(594.5,555.3,1,1,0,0,0,-378,43.8);

	this.instance_7 = new lib.texto4mc();
	this.instance_7.setTransform(594.5,555.3,1,1,0,0,0,-378,43.8);

	this.instance_8 = new lib.texto6mc();
	this.instance_8.setTransform(594.5,555.3,1,1,0,0,0,-378,43.8);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6}]},3).to({state:[]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.btnInteraccion}]},1).wait(2));

	// lago fondo blanco
	this.instance_9 = new lib.Símbolo9();
	this.instance_9.setTransform(593.95,472.2,1,1,0,0,0,592.6,151);
	this.instance_9.alpha = 0.0781;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regX:594,regY:219.8,x:595.35,y:541,alpha:0.41},0).wait(1).to({alpha:1},0).wait(9));
	...
	this.burbujas.setTransform(330.8,227.1,1,1,0,0,0,322.8,117.1);

	this.timeline.addTween(cjs.Tween.get(this.burbujas).wait(11));

	// boca
	this.instance_10 = new lib.Boca2Madre();
	this.instance_10.setTransform(955,341,0.7,0.7);

	this.instance_11 = new lib.boca1();
	this.instance_11.setTransform(980.2,353.2,1,1,0,0,0,25.2,12.2);

	this.instance_12 = new lib.boca2();
	this.instance_12.setTransform(980.2,353.2,1,1,0,0,0,25.2,12.2);

	this.instance_13 = new lib.boca3();
	this.instance_13.setTransform(980.2,353.2,1,1,0,0,0,25.2,12.2);

	this.instance_14 = new lib.boca5();
	this.instance_14.setTransform(980.2,353.2,1,1,0,0,0,25.2,12.2);

	this.boca2 = new lib.boca2();
	this.boca2.name = "boca2";
	this.boca2.setTransform(980.2,353.2,1,1,0,0,0,25.2,12.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10}]}).to({state:[{t:this.instance_11}]},4).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.boca2}]},1).to({state:[{t:this.instance_10}]},1).wait(2));

	// mama
	this.instance_15 = new lib.mama();
	this.instance_15.setTransform(972.5,401,1,1,0,0,0,108.9,159);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(11));

	// cerda3
	this.cerdo3 = new lib.cerda3();
	this.cerdo3.name = "cerdo3";
	this.cerdo3.setTransform(589.2,416.7,1,1,0,0,0,83.2,130.7);

	this.timeline.addTween(cjs.Tween.get(this.cerdo3).wait(11));

	// cerdo2
	this.instance_16 = new lib.cerdo2();
	this.instance_16.setTransform(411.9,438.2,1,1,0,0,0,75.9,100.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(11));

	// cerdo1
	this.cerdo1 = new lib.cerdo1();
	this.cerdo1.name = "cerdo1";
	this.cerdo1.setTransform(240.1,423.2,1,1,0,0,0,69.1,108.2);

	this.timeline.addTween(cjs.Tween.get(this.cerdo1).wait(11));

	// Fondo
	this.instance_17 = new lib.Sombra();
	this.instance_17.setTransform(916,547,0.5,0.5);

	this.instance_18 = new lib.Sombra();
	this.instance_18.setTransform(506,536,0.5,0.5);

	this.instance_19 = new lib.Sombra();
	this.instance_19.setTransform(328,526,0.5,0.5);

	this.instance_20 = new lib.Sombra();
	this.instance_20.setTransform(148,520,0.5,0.5);

	this.instance_21 = new lib.helice();
	this.instance_21.setTransform(1001.95,157.7,1,1,0,0,0,134.8,123.2);

	this.instance_22 = new lib.CespedFrenteEspantapajaros();
	this.instance_22.setTransform(767,459,0.5,0.5);

	this.instance_23 = new lib.espantapajaros();
	this.instance_23.setTransform(794,361.7,1,1,0,0,0,82,113.9);

	this.instance_24 = new lib.Arbol();
	this.instance_24.setTransform(377,14,0.6777,0.6777);

	this.instance_25 = new lib.Arbol();
	this.instance_25.setTransform(201,72,0.5925,0.5925);

	this.instance_26 = new lib.Arbol();
	this.instance_26.setTransform(42,158,0.4949,0.4949);

	this.instance_27 = new lib.Arbol();
	this.instance_27.setTransform(-141,43,0.6775,0.6775);

	this.instance_28 = new lib.nubes();
	this.instance_28.setTransform(539.8,63.5,1,1,0,0,0,407.8,39.5);

	this.instance_29 = new lib.fondo();
	this.instance_29.setTransform(361.5,251.5,1,1,0,0,0,510.5,237.5);

	this.instance_30 = new lib.Fondo();
	this.instance_30.setTransform(-3,-4,0.5008,0.5053);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17}]}).wait(11));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(452.5,270.5,1562.3,443.5);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_1.png?1714088330748", id:"index_atlas_1"},
		{src:"sounds/Voice0.mp3?1714088330917", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1714088330917", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1714088330917", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1714088330917", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1714088330917", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1714088330917", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1714088330917", id:"Voice6"},
		{src:"sounds/BGM.mp3?1714088330917", id:"BGM"},
		{src:"sounds/BGM_1.mp3?1714088330917", id:"BGM_1"},
		{src:"sounds/Interactividad.mp3?1714088330917", id:"Interactividad"},
		{src:"sounds/intro.mp3?1714088330917", id:"intro"}
	],
	preloads: []
};
