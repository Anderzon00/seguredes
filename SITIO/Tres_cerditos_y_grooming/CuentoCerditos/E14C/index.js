...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,0,2378,1139]]},
		{name:"index_atlas_P_2", frames: [[0,984,2377,77],[0,726,2377,84],[0,812,2377,84],[0,552,2377,85],[0,639,2377,85],[0,898,2377,84],[0,0,2376,129],[2379,552,412,370],[2040,131,545,419],[690,131,778,347],[1470,131,568,407],[0,131,688,414]]},
		{name:"index_atlas_P_3", frames: [[942,612,80,80],[942,694,80,80],[919,1177,81,80],[462,1233,81,80],[141,1047,81,81],[942,529,80,81],[359,1265,79,79],[919,1259,79,80],[799,989,178,186],[799,802,180,185],[609,775,69,25],[232,949,81,36],[545,1270,82,54],[0,1271,71,30],[629,1270,82,31],[970,0,33,112],[359,1159,101,104],[232,817,91,130],[732,1177,90,115],[0,1047,139,107],[598,1088,132,180],[0,817,230,228],[252,1269,57,108],[0,1159,250,110],[970,174,34,60],[252,1159,105,108],[824,1177,93,109],[0,383,798,161],[232,989,248,168],[482,989,114,242],[970,236,51,38],[970,114,44,58],[1005,0,5,99],[386,0,358,381],[0,546,334,269],[336,775,271,212],[800,301,214,226],[336,546,353,227],[0,0,384,360],[691,546,249,254],[609,802,188,284],[746,0,222,299]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(0.0076,0);
...
p.nominalBounds = new cjs.Rectangle(-119.3,-100.2,238.7,200.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},4).to({state:[{t:this.instance}]},8).to({state:[{t:this.instance_1}]},4).to({state:[{t:this.instance}]},4).wait(55));

	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(137.2523,71.262);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(137.3375,71.262);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(137.2523,69.0764);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[]},3).to({state:[{t:this.shape_1}]},66).to({state:[{t:this.shape_2}]},3).wait(3));

	// Rostro_5.png
	this.instance_2 = new lib.Rostro_5();
	this.instance_2.setTransform(0,0,0.5852,0.5852);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PasamanosLateral();
	this.instance.setTransform(-56,-65,1.2237,0.7381);

	this.instance_1 = new lib.PasamanosFrontal();
	this.instance_1.setTransform(-263,-58,0.2724,0.7281);
...
p.nominalBounds = new cjs.Rectangle(-263,-65,510.5,124.3);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PuertaLado();
	this.instance.setTransform(-150.55,-124.15,0.5677,0.5677,1.95);
...
p.nominalBounds = new cjs.Rectangle(-158.6,-124.1,317.29999999999995,248.3);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.IzquierdoLado();
	this.instance.setTransform(-112.75,-125.4,0.5677,0.5677,1.95);
...
p.nominalBounds = new cjs.Rectangle(-119.9,-125.4,240.9,217.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.TechoCasa();
	this.instance.setTransform(-191.15,-124.1,0.5677,0.5677,1.95);
...
p.nominalBounds = new cjs.Rectangle(-199.1,-124.1,398.29999999999995,248.2);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.techoLadoIzq();
	this.instance.setTransform(-105.45,-105.8,0.5677,0.5677,1.95);
...
p.nominalBounds = new cjs.Rectangle(-112.4,-105.8,224.8,211.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(106.7,69.85,0.6752,0.6752,0,60.0011,-119.9989);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(8));

	// Manga3
	this.instance_1 = new lib.Manga_10();
	this.instance_1.setTransform(159.8,68.55,0.6622,0.6622,0,80.47,-99.53);
...
p.nominalBounds = new cjs.Rectangle(0,0,159.8,113.8);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-4.0825,1.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape}]},1).wait(50));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-126.9,-100.2,246.3,202.9);


(lib.policia = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// diapositiva2-img1-telefono.png
	this.instance = new lib.diapositiva2img1telefono();
	this.instance.setTransform(214,11,0.0802,0.0802);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50));

	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FF00").s().p("Ajuh3IJdgLIiAD6IpdALg");
	this.shape.setTransform(222.65,21.05);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("Ajuh3IJdgLIiAD6IpdALg");
	this.shape_1.setTransform(222.65,21.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},10).to({state:[{t:this.shape}]},10).to({state:[{t:this.shape_1}]},10).to({state:[{t:this.shape}]},10).wait(10));

	// Boca2_9.png
	this.instance_1 = new lib.Sintítulo1();
	this.instance_1.setTransform(178,-89,0.629,0.6513);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhcA9IAAh5IC5AAIAAB5g");
	this.shape_2.setTransform(174.625,8.575);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.instance_1}]}).wait(50));

	// Rostro_5.png
	this.instance_2 = new lib.PuppetShape_1("synched",1,false);
	this.instance_2.setTransform(231.4,-8.75);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgqA8QgKgIgEgOQgDgOAGgNQAEgIAJgKIAOgRQAFgIAJgQQAKgOAMgBQAJAAgCgEQAXADAJANQAPASgLAmIgHATQgGAMgMAKQgQAPgQAFQgIACgGAAQgNAAgLgIg");
	this.shape_3.setTransform(165.2716,48.4529);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(184.6932,54.0215);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.instance_2}]}).wait(50));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(104.5,-108.5,245.7,202.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:4.8,alpha:0.3281},99).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-22.2,28.5,81.1);
...
(lib.policia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// policia
	this.policia = new lib.policia();
	this.policia.name = "policia";
	this.policia.setTransform(120.3,140.55,0.881,0.7609,0,0,0,241,76.1);
	this.policia.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.policia).wait(99).to({alpha:1},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,216.5,154.1);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(30).call(this.frame_30).wait(52).call(this.frame_82).wait(1));

	// mesa
	this.instance = new lib.humo();
	this.instance.setTransform(18.75,19.8,1,1,0,0,0,14.2,27);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(69).to({_off:false},0).wait(14));

	// cuerpo
	this.instance_1 = new lib.Símbolo12();
	this.instance_1.setTransform(-273.1,108.1,1,1,0,0,0,13.9,38.1);

	this.instance_2 = new lib.Interpolación53("synched",0);
	this.instance_2.setTransform(-259.4,102);

	this.instance_3 = new lib.Símbolo11();
	this.instance_3.setTransform(-326.3,115.1,1,1,0,0,0,41.7,32.1);

	this.instance_4 = new lib.Interpolación55("synched",0);
	this.instance_4.setTransform(-246.5,152.7);

	this.instance_5 = new lib.Interpolación57("synched",0);
	this.instance_5.setTransform(-238.95,159.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(83));

	// bocaDientes
	this.instance_6 = new lib.Interpolación10("synched",0);
	this.instance_6.setTransform(-272.7,23.4,1,1,-13.9726,0,0,-18.4,-11.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({rotation:-7.2478,y:23.35},5).to({rotation:-13.9726,y:23.4},10).to({_off:true},1).wait(15).to({_off:false},0).wait(52));

	// cabeza1
	this.instance_7 = new lib.Símbolo10();
	this.instance_7.setTransform(-261.6,-0.35,1,1,0,0,0,53.4,55.8);
	...
	this.instance_8 = new lib.PuppetShape_1copia("synched",1,false);
	this.instance_8.setTransform(-254.6,-2.45,0.6006,0.5905,7.3772,0,0,89,93);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7}]}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.instance_8},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},16).to({state:[{t:this.instance_7}]},15).wait(52));

	// soplo
	this.instance_9 = new lib.Interpolación13("synched",0);
	this.instance_9.setTransform(-217.65,35.2,0.8287,1.0828,0,0,0,-156.1,-23.7);
	this.instance_9._off = true;

	this.instance_10 = new lib.Interpolación15("synched",0);
	this.instance_10.setTransform(66.25,38.3);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(16).to({_off:false},0).to({regY:-23.6,scaleX:0.992,scaleY:1.2988,y:35.25},4).to({alpha:0},10).to({_off:true,regX:0,regY:0,scaleX:1,scaleY:1,x:66.25,y:38.3,alpha:1},1).wait(52));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(30).to({_off:false},1).to({scaleX:59.0108,scaleY:59.0108,x:63.4,y:58.05,alpha:0.1016},9).to({scaleX:309.0315,scaleY:309.0315,x:20.4,y:42.65,alpha:0.3281},9).to({scaleX:309.0255,scaleY:309.0255,rotation:-44.9994,x:-9.35,y:106.45,alpha:0.0703},12).to({startPosition:0},21).wait(1));

	// TechoCasa.png
	this.instance_11 = new lib.Interpolación3("synched",0);
	this.instance_11.setTransform(62.15,-147.3);

	this.instance_12 = new lib.Interpolación5("synched",0);
	this.instance_12.setTransform(24.25,67.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_11}]}).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},30).to({state:[{t:this.instance_11}]},30).to({state:[{t:this.instance_12}]},21).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({startPosition:0},1).to({startPosition:0},30).to({x:32.3,y:71.6},30).to({_off:true,x:24.25,y:67.1},21).wait(1));

	// techoLadoIzq.png
	this.instance_13 = new lib.Interpolación1("synched",0);
	this.instance_13.setTransform(-95.2,-117.1);

	this.instance_14 = new lib.Interpolación2("synched",0);
	this.instance_14.setTransform(-99.9,106.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13}]}).to({state:[{t:this.instance_13}]},31).to({state:[{t:this.instance_13}]},30).to({state:[{t:this.instance_14}]},21).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({startPosition:0},31).to({x:-91.8,y:89.85},30).to({_off:true,x:-99.9,y:106.45},21).wait(1));

	// Capa_2
	this.instance_15 = new lib.Interpolación19("synched",0);
	this.instance_15.setTransform(-172.95,186.8,1,1,0,0,0,-242.2,62);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({startPosition:0},1).to({startPosition:0},29).to({startPosition:0},1).to({regX:-242,regY:63.2,scaleY:0.0386,skewX:50.5975,x:-172.9,y:182.05},51).wait(1));

	// IzquierdoLado.png
	this.instance_16 = new lib.Interpolación6("synched",0);
	this.instance_16.setTransform(-195,206.5,1,1,0,0,0,-121,125.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({startPosition:0},1).to({startPosition:0},30).to({regY:125.5,scaleY:1.6801,skewX:71.9269,skewY:18.4532,x:-245.75,y:161.3},51).wait(1));

	// PuertaLado.png
	this.instance_17 = new lib.Interpolación8("synched",0);
	this.instance_17.setTransform(283.05,190.5,1,1,0,0,0,158.7,124.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({startPosition:0},31).to({regX:158.6,scaleY:1.2606,skewX:-60.7065,skewY:-23.1951,x:301.25,y:125},51).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-368,-271.4,739.8,596.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(2,506,0.5,0.5066);
	...
	// chat
	this.instance_7 = new lib.Sillon();
	this.instance_7.setTransform(531,369,0.5,0.5);

	this.instance_8 = new lib.Tronco();
	this.instance_8.setTransform(398,336,0.5,0.5);
	...
	this.lobo.name = "lobo";
	this.lobo.setTransform(136.4,322.35,1.2112,1.2112,0,0,0,-378.4,91.9);

	this.timeline.addTween(cjs.Tween.get(this.lobo).wait(10));

	// tronco
	this.instance_9 = new lib.Recurso80();
	this.instance_9.setTransform(908,269,0.2896,0.2896);
	...
	this.felipe.setTransform(1022.75,257.5,0.3599,0.3599,0,0,0,114,174.2);

	this.timeline.addTween(cjs.Tween.get(this.felipe).wait(10));

	// policia2
	this.policia2 = new lib.policia2();
	this.policia2.name = "policia2";
	this.policia2.setTransform(1004.7,142.05,0.8522,0.8522,0,0,180,108.2,77);

	this.timeline.addTween(cjs.Tween.get(this.policia2).wait(10));

	// flor
	this.flor = new lib.flor();
	this.flor.name = "flor";
	this.flor.setTransform(1008.65,257.05,0.3599,0.3599,0,0,0,135.8,127.1);

	this.timeline.addTween(cjs.Tween.get(this.flor).wait(10));

	// casa
	this.instance_10 = new lib.casa();
	this.instance_10.setTransform(685.8,169.25,1,1,0,0,0,245.3,239);
...
p.nominalBounds = new cjs.Rectangle(500,206.8,802.2,507.2);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1711315713016", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1711315713016", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1711315713018", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1711315713205", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1711315713205", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1711315713205", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1711315713205", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1711315713205", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1711315713205", id:"Voice5"},
		{src:"sounds/interaccion.mp3?1711315713205", id:"interaccion"},
		{src:"sounds/intro.mp3?1711315713205", id:"intro"},
		{src:"sounds/BGM.mp3?1711315713205", id:"BGM"}
	],
	preloads: []
};
