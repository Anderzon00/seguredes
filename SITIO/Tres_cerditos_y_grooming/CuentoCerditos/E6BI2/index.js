...
if (reversed == null) { reversed = false; }
	...
	// reloj
	this.instance_10 = new lib.reloj_1();
	...
	this.instance_11.setTransform(488.3,259,1,1,0,0,0,14.2,27);

	this.instance_12 = new lib.Mesa();
	this.instance_12.setTransform(107,182,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).wait(32));

	// ventana
	this.instance_13 = new lib.SuperiorVentana();
	this.instance_13.setTransform(-7,48,0.5,0.5);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1711307565589", id:"index_atlas_P_1"},
		{src:"sounds/Voice0.mp3?1711307565760", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1711307565760", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1711307565760", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1711307565760", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1711307565760", id:"Voice4"},
		{src:"sounds/BGM.mp3?1711307565760", id:"BGM"},
		{src:"sounds/Voice11.mp3?1711307565760", id:"Voice11"},
		{src:"sounds/Voice10.mp3?1711307565760", id:"Voice10"},
		{src:"sounds/interaccion.mp3?1711307565760", id:"interaccion"},
		{src:"sounds/intro.mp3?1711307565760", id:"intro"},
		{src:"sounds/Voicem.mp3?1711307565760", id:"Voicem"},
		{src:"sounds/Voice9.mp3?1711307565760", id:"Voice9"}
	],
	preloads: []
};
