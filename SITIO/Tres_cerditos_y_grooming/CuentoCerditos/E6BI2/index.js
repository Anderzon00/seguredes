...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,2557,2377,76],[3887,1285,80,80],[0,2399,2377,77],[3805,1310,80,80],[0,2635,2377,76],[4000,965,81,80],[3935,1203,81,80],[0,2478,2377,77],[4000,882,81,81],[3805,1227,80,81],[1411,2313,2377,84],[3887,1367,79,79],[3969,1285,79,80],[3805,1392,69,25],[4000,1047,81,36],[1846,1356,71,30],[1762,1356,82,31],[3935,1097,101,104],[4000,765,90,115],[1426,1407,502,109],[1762,1136,502,108],[1762,1246,502,108],[3789,2217,100,78],[4018,1269,12,11],[3805,231,231,177],[3921,410,135,122],[4028,534,57,108],[0,0,2376,1134],[1411,2182,2376,129],[2266,1324,29,27],[3887,1227,41,40],[3921,534,105,108],[4001,644,93,109],[1426,1528,1289,652],[3805,410,114,242],[2322,1324,42,175],[2266,1136,82,186],[4038,1085,44,58],[2378,0,1425,797],[3805,1097,128,128],[3887,1269,33,12],[4038,1145,22,46],[2297,1324,22,22],[3805,0,227,229],[2717,1528,320,566],[2378,799,1425,727],[0,1136,1424,713],[3789,2011,294,204],[1426,1136,334,269],[1930,1356,194,109],[3805,987,193,108],[3805,765,193,109],[2126,1356,194,109],[3805,654,194,109],[3805,876,193,109],[4018,1203,43,64],[3789,1781,269,228],[0,1851,721,507],[3789,1528,289,251],[723,1851,686,519]]}
];
...
(lib.CuadroPendamiento = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(25);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Pendulo_1();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(101.35,65.9421);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(100.9375,65.915);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(101.35,63.7275);
	...
	// Capa_1
	this.instance = new lib.Rostro_14();
	this.instance.setTransform(203.2,0,0.6911,0.6911,0,0,180);
...
p.nominalBounds = new cjs.Rectangle(0,0,203.2,141);
...
(lib.Interpolación6_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance_1 = new lib.Prohibido();
	this.instance_1.setTransform(-32,-32,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-25,-19.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-25,-19.5,50,39);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_1 = new lib.CuadroPendamiento();
	this.instance_1.setTransform(-67.5,-61);
...
p.nominalBounds = new cjs.Rectangle(-67.5,-61,135,122);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.SignoPregunta();
	this.instance.setTransform(-21.5,-32);
...
p.nominalBounds = new cjs.Rectangle(-21.5,-32,43,64);
...
if (reversed == null) { reversed = false; }
	...
	// Manga2
	this.instance = new lib.Manga_9();
	this.instance.setTransform(2.25,4,0.6885,0.6885,-14.9962);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(51));

	// Brazo2
	this.instance_1 = new lib.Brazo_6();
	this.instance_1.setTransform(41.75,27.05,0.7323,0.7323,8.2377);
...
p.nominalBounds = new cjs.Rectangle(2.3,-12.5,112.7,125.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(185.6,127,0.6753,0.6753,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},3).wait(17).to({_off:false},0).to({_off:true},26).wait(15).to({_off:false},0).wait(66));

	// Boca2_10.png
	this.instance_1 = new lib.Boca2_10();
	this.instance_1.setTransform(185.95,126,0.6753,0.6753,0,0,180);
	...
	this.instance_2.setTransform(163.6,82.5,1,1,0,0,0,101.6,70.5);
...
p.nominalBounds = new cjs.Rectangle(62,12,203.2,141);
...
(lib.interrogante = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(135));

	// SignoPregunta.png
	this.instance = new lib.Interpolación1("synched",0);
	this.instance.setTransform(72.5,58);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({y:55,alpha:1},8).to({y:58},10).to({y:45},19).to({y:58},21).to({startPosition:0},31).to({y:45},24).to({y:58},20).wait(1));

	// CuadroPendamiento.png
	this.instance_1 = new lib.Interpolación2_1("synched",0);
	this.instance_1.setTransform(67.5,61);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({y:59.7,alpha:1},8).to({y:58.1},10).to({y:48.2},19).to({y:61},21).to({startPosition:0},31).to({y:48.2},24).to({y:61},20).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-12.8,135,134.8);
...
if (reversed == null) { reversed = false; }
	...
	// interrogante
	this.interrogante = new lib.interrogante();
	this.interrogante.name = "interrogante";
	this.interrogante.setTransform(570,-82);

	this.timeline.addTween(cjs.Tween.get(this.interrogante).wait(100));
	...
	// Torso_10.png
	this.instance_1 = new lib.Silueta_4();
	this.instance_1.setTransform(561.8,122,0.6795,0.6795,0,0,180);

	this.instance_2 = new lib.PataBrazo();
	this.instance_2.setTransform(462.65,229,0.3915,0.3915,0,0,180);

	this.instance_3 = new lib.PataBrazo();
	this.instance_3.setTransform(477,231,0.3915,0.3915);
	...
	this.instance_4.setTransform(497.6,141.5,0.9311,0.9311,0,0,180,84.4,13.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({skewX:-7.2079,skewY:172.7921,x:497.65},24).to({skewX:0,skewY:180,x:497.6},25).to({skewX:-5.4751,skewY:174.5249,x:497.65},25).to({skewX:0,skewY:180,x:497.6},25).wait(1));

	// brazo4
	this.instance_5 = new lib.brazo4();
	this.instance_5.setTransform(437.05,144.85,0.9311,0.9311,0,0,0,84.4,13.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({rotation:7.9753,x:437,y:144.9},24).to({rotation:0,x:437.05,y:144.85},25).to({rotation:5.9659},25).to({rotation:0},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(348,-7,237.79999999999995,332.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(71,53);
	this.instance.alpha = 0;

	this.instance_1 = new lib.Interpolación6_1("synched",0);
	this.instance_1.setTransform(71,53);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance}]},34).to({state:[{t:this.instance}]},28).to({state:[{t:this.instance}]},28).to({state:[{t:this.instance}]},24).to({state:[{t:this.instance_1}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},34).to({startPosition:0},28).to({startPosition:0},28).to({startPosition:0},24).to({_off:true},28).wait(1));

	// Camara.png
	this.instance_2 = new lib.Interpolación3("synched",0);
	this.instance_2.setTransform(68,53.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-14.9992},34).to({rotation:0},35).to({rotation:-14.9992},38).to({rotation:0},35).wait(1));

	// CuadroDialogo.png
	this.instance_3 = new lib.CuadroDialogo();
	this.instance_3.setTransform(15,15,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(15,15,115.5,88.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(113.15,155.05,1,1,0,0,0,112.7,146.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:4.4878},24).to({regX:112.8,rotation:2.5897,x:113.3,y:155.15},11).to({regX:112.7,rotation:0,x:113.15,y:155.05},15).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// CirculoReloj.png
	this.instance_5 = new lib.CirculoReloj();
	this.instance_5.setTransform(77,100,0.5,0.5);
	...
	// pendulo
	this.instance_9 = new lib.pendulo();
	this.instance_9.setTransform(80.6,144.05,1,1,24.9387,0,0,20.6,0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(67.85,163.95,1,1,0,0,0,19.3,10);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:19.4,rotation:-14.9992,x:61.65,y:166},24).to({regX:19.3,rotation:0,x:61.55},26).to({regX:19.4,rotation:-14.9992,x:61.65},24).to({regX:19.3,rotation:0,x:61.55},25).wait(1));

	// torso
	this.instance_2 = new lib.Torso_17();
	this.instance_2.setTransform(70.9,129.95,0.726,0.7013,14.996);

	this.instance_3 = new lib.Pie_1();
	this.instance_3.setTransform(197.45,307.9,1.0476,1.0476,82.8082);

	this.instance_4 = new lib.Pie_1();
	this.instance_4.setTransform(248.15,299.4,1.0476,1.0476,83.5242);
	...
	this.instance_5.setTransform(148,155.6,1.0631,1.0631,-8.7265,0,0,37.5,2.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:37.4,regY:2.5,scaleX:1,scaleY:1,rotation:0,x:147.9,y:155.5},24).to({rotation:-8.7276},26).to({rotation:0},24).to({rotation:-8.7276},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,273.6,361.3);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_7 = function() {
		...
		_this.chat.gotoAndPlay(1);
			_this.flor.interrogante.gotoAndPlay(1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnInteraccion}]},7).to({state:[{t:this.btnInteraccion}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.escenaNo}]},1).to({state:[{t:this.escenaSi}]},1).wait(1));
	...
	this.instance_8 = new lib.RetroSi();
	...
	this.chat.name = "chat";
	this.chat.setTransform(698.9,243.75,2.1,2.1,0,0,0,57,109);

	this.timeline.addTween(cjs.Tween.get(this.chat).wait(32));

	// mesa
	this.instance_10 = new lib.humo();
	this.instance_10.setTransform(488.3,259,1,1,0,0,0,14.2,27);

	this.instance_11 = new lib.Mesa();
	this.instance_11.setTransform(107,182,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_11},{t:this.instance_10}]}).wait(32));

	// ventana
	this.instance_12 = new lib.SuperiorVentana();
	this.instance_12.setTransform(-7,48,0.5,0.5);
	...
	this.felipe.setTransform(549,316.2,1,1,0,0,0,113.9,174.2);

	this.timeline.addTween(cjs.Tween.get(this.felipe).wait(32));

	// reloj
	this.instance_13 = new lib.reloj_1();
	this.instance_13.setTransform(772.95,122.6,0.8026,0.8026,0,0,0,80.1,141.5);
	...
	this.flor.name = "flor";
	this.flor.setTransform(595.55,297,1,1,0,0,0,135.5,127);

	this.timeline.addTween(cjs.Tween.get(this.flor).wait(32));

	// fondo
	this.instance_14 = new lib.VentanaAtrás();
	this.instance_14.setTransform(3,39,0.5,0.5);

	this.instance_15 = new lib.reloj();
	this.instance_15.setTransform(771.25,72.9,1,1,0,0,0,7.8,14.2);

	this.instance_16 = new lib.FondoCasa();
	this.instance_16.setTransform(0,-3,0.505,0.5013);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_16},{t:this.instance_15},{t:this.instance_14}]}).wait(32));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1713923101642", id:"index_atlas_P_1"},
		{src:"sounds/Voice0.mp3?1713923101809", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1713923101809", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1713923101809", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1713923101809", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1713923101809", id:"Voice4"},
		{src:"sounds/BGM.mp3?1713923101809", id:"BGM"},
		{src:"sounds/Voice11.mp3?1713923101809", id:"Voice11"},
		{src:"sounds/Voice10.mp3?1713923101809", id:"Voice10"},
		{src:"sounds/interaccion.mp3?1713923101809", id:"interaccion"},
		{src:"sounds/intro.mp3?1713923101809", id:"intro"},
		{src:"sounds/Voicem.mp3?1713923101809", id:"Voicem"},
		{src:"sounds/Voice9.mp3?1713923101809", id:"Voice9"}
	],
	preloads: []
};
