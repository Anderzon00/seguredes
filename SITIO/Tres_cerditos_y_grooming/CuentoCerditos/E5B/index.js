...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,1600,2377,76],[2847,1103,394,37],[3884,1107,80,80],[0,1442,2377,77],[3966,1107,80,80],[3719,957,367,74],[0,1678,2377,76],[3478,1064,81,80],[3719,1107,81,80],[3719,1033,367,72],[0,1521,2377,77],[3478,981,81,81],[3802,1107,80,81],[0,1356,2377,84],[3965,1189,79,79],[3884,1189,79,80],[0,1269,2377,85],[2990,883,311,218],[3598,421,59,30],[3598,453,52,26],[2847,1030,64,69],[3598,355,55,64],[4021,897,64,32],[3361,799,199,180],[3667,0,353,352],[3667,354,352,353],[3303,959,12,11],[3312,0,353,353],[0,0,2374,1136],[0,1138,2376,129],[3562,799,29,27],[3312,355,41,40],[3303,981,173,163],[2913,1030,62,68],[2378,941,467,307],[2376,524,612,415],[3953,709,82,186],[2376,0,600,522],[2847,941,124,87],[3303,883,56,74],[3361,355,235,442],[2990,0,320,566],[3598,709,353,246],[2990,568,369,313],[4021,931,66,14],[3953,897,66,37],[3562,957,155,204]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Sonrisa2.png
	this.instance = new lib.Sonrisa1();
	this.instance.setTransform(0,3,0.3,0.3);

	this.instance_1 = new lib.Sonrisa2();
	this.instance_1.setTransform(0,0,0.3,0.3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(15).to({_off:false},0).wait(5));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},15).wait(5));
...
if (reversed == null) { reversed = false; }
	...
	// Capa_18
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(128.6233,83.4332);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1).to({_off:false},0).wait(124));

	// Interpolación 26
	this.instance = new lib.Mensaje1Rafael();
	this.instance.setTransform(-13,-37,0.6882,0.6882);
...
p.nominalBounds = new cjs.Rectangle(-13,-37,321.4,211.3);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(103).to({_off:false},0).to({_off:true},3).wait(2).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(2).to({_off:false},0).to({_off:true},3).wait(2).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(2).to({_off:false},0).to({_off:true},3).wait(2).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(2).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false},0).wait(2));

	// Boca1_2.png
	this.instance_1 = new lib.Boca1_2();
	this.instance_1.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},103).wait(3).to({_off:false},0).to({_off:true},2).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},2).wait(3).to({_off:false},0).to({_off:true},2).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},2).wait(3).to({_off:false},0).to({_off:true},2).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false},0).to({_off:true},2).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,29.5,15);
...
if (reversed == null) { reversed = false; }
	...
	// boca
	this.bocaFlor = new lib.boca();
	this.bocaFlor.name = "bocaFlor";
	this.bocaFlor.setTransform(219.8,104.5,1,1,0,0,0,14.8,7.5);

	this.timeline.addTween(cjs.Tween.get(this.bocaFlor).wait(30));

	// Símbolo 5
	this.instance_3 = new lib.Símbolo5();
	this.instance_3.setTransform(218.2,61.5,1,1,0,0,0,88.2,61.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(30));

	// SiluetaMenor.png
	this.instance_4 = new lib.SiluetaMenor();
	this.instance_4.setTransform(124,114,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(30));

	// Pies.png
	this.instance_5 = new lib.Pies();
	this.instance_5.setTransform(277.05,231,0.1789,0.1789,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(30));

	// Pies.png
	this.instance_6 = new lib.Pies();
	this.instance_6.setTransform(173,233,0.1812,0.1812);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(30));

	// Manga.png
	this.instance_7 = new lib.Manga();
	this.instance_7.setTransform(296.75,123,0.3742,0.3742,0,0,180);

	this.instance_8 = new lib.Manga();
	this.instance_8.setTransform(144,123,0.3742,0.3742);
...
p.nominalBounds = new cjs.Rectangle(124,0,185.2,313.1);
...
if (reversed == null) { reversed = false; }
	...
	// Símbolo 1
	this.flor2 = new lib.Símbolo1();
	this.flor2.name = "flor2";
	this.flor2.setTransform(92.2,313.1,1,1,0,0,0,220.2,313.1);

	this.timeline.addTween(cjs.Tween.get(this.flor2).to({scaleY:1.0543,y:313.15},36).to({scaleY:1,y:313.1},38).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-4,-16.9,185.9,330.09999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(88.25,153);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,alpha:1},30).wait(161));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},30).to({startPosition:0},160).wait(1));

	// CirculosCoreografias.png
	this.instance_2 = new lib.Interpolación12("synched",0);
	this.instance_2.setTransform(257.65,65.45);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.instance_3 = new lib.Interpolación13("synched",0);
	this.instance_3.setTransform(257.65,65.45);
	this.instance_3._off = true;

	this.instance_4 = new lib.Interpolación14("synched",0);
	this.instance_4.setTransform(257.65,65.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},63).to({state:[{t:this.instance_3}]},15).to({state:[{t:this.instance_4}]},112).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(63).to({_off:false},0).to({_off:true,alpha:1},15).wait(113));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(63).to({_off:false},15).to({_off:true},112).wait(1));

	// CirculoFotosPaisajes.png
	this.instance_5 = new lib.Interpolación15("synched",0);
	this.instance_5.setTransform(416.4,153.25);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.instance_6 = new lib.Interpolación16("synched",0);
	this.instance_6.setTransform(416.4,153.25);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(105).to({_off:false},0).to({_off:true,alpha:1},18).wait(68));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(105).to({_off:false},18).to({startPosition:0},67).wait(1));

	// 1BandaFavorita.png
	this.instance_7 = new lib._1BandaFavorita();
	this.instance_7.setTransform(0,493,1.2621,1.2635);

	this.instance_8 = new lib._2TomarFotografias();
	this.instance_8.setTransform(0,493,1.259,1.259);

	this.instance_9 = new lib._3FotosPaisajes();
	this.instance_9.setTransform(-2,497,1.1384,1.1384);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_8}]},62).to({state:[{t:this.instance_9}]},45).wait(82));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2,-22.8,506.4,609);
...
(lib.brazos = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(54.6,15.9,1,1,0,0,0,-8.5,-15.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:-14.9992,y:15.85},34).to({rotation:0,y:15.9},35).wait(1));

	// Símbolo 2
	this.instance_1 = new lib.Símbolo2();
	this.instance_1.setTransform(29.2,18.95,1,1,0,0,0,28.1,12);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:29.9992,x:29.15},34).to({rotation:0,x:29.2},35).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-6.4,-5.5,94.10000000000001,57.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(109.9,37.5,1,1,0,0,0,9.9,5.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(5).to({_off:false},0).wait(92));

	// Sonrisa2.png
	this.instance_1 = new lib.Sonrisa2();
	this.instance_1.setTransform(100,32,0.3,0.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},5).wait(92));

	// CabezaMalo.png
	this.instance_2 = new lib.CabezaMalo();
	this.instance_2.setTransform(81,-10,0.3,0.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(97));
	...
	// brazos
	this.instance_4 = new lib.brazos();
	this.instance_4.setTransform(109.1,55.6,1,1,0,0,0,43.9,25.9);
	...
	this.circulos.setTransform(108.7,-19.35,0.4931,0.4931,0,0,0,246.5,159.7);

	this.timeline.addTween(cjs.Tween.get(this.circulos).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cerdo3},{t:this.shape}]}).wait(97));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-43.2,-66,321.4,338);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_6 = function() {
		...
		_this.flor.flor2.bocaFlor.gotoAndStop(0);
	...
	this.frame_7 = function() {
		...
		_this.flor.flor2.bocaFlor.gotoAndPlay(1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.adelanteEscena},{t:this.atrasEscena}]}).wait(10));
	...
	this.btnInteraccion.setTransform(710.25,398.45);
	this.btnInteraccion._off = true;
	new cjs.ButtonHelper(this.btnInteraccion, 0, 1, 2, false, new lib.btnInteractivo(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btnInteraccion).wait(8).to({_off:false},0).wait(1).to({y:399.45},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.burbuja}]}).wait(10));

	// Símbolo 4
	this.flor = new lib.flor();
	this.flor.name = "flor";
	this.flor.setTransform(533.2,395.6,1,1,0,0,0,92.2,156.6);

	this.timeline.addTween(cjs.Tween.get(this.flor).wait(10));

	// reloj
	this.instance_9 = new lib.reloj();
	this.instance_9.setTransform(92,161.5,1,1,0,0,0,80,141.5);
	...
	this.cerdo2.setTransform(622.8,382.15,1.0374,1.0374,0,0,0,-42.9,259.1);
