...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,988,2377,84],[0,901,2377,85],[0,1074,2377,77],[0,0,2376,129],[2040,131,412,370],[1237,540,798,161],[690,480,545,419],[690,131,778,347],[2454,0,358,381],[2037,540,334,269],[1470,131,568,407],[2379,865,353,227],[0,131,688,414],[2379,503,384,360],[224,547,249,254],[0,547,222,299]]},
		{name:"index_atlas_P_3", frames: [[134,395,80,80],[0,396,80,80],[560,358,81,80],[838,376,81,80],[477,358,81,81],[921,376,80,81],[297,396,79,79],[216,396,79,80],[463,170,178,186],[713,0,180,185],[561,440,69,25],[702,416,81,36],[134,214,82,54],[382,286,71,30],[477,441,82,31],[988,244,33,112],[643,299,101,104],[895,244,91,130],[746,299,90,115],[134,286,139,107],[0,214,132,180],[643,405,57,108],[643,187,250,110],[838,299,34,60],[275,286,105,108],[382,358,93,109],[463,0,248,168],[895,0,114,242],[382,318,51,38],[218,214,44,58],[1011,0,5,99],[0,0,271,212],[273,0,188,284]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.btnInteraccion.setTransform(431.4,324.05,1,1,0,0,0,-21.1,7.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnInteraccion,p:{x:431.4,y:324.05}}]},5).to({state:[{t:this.btnInteraccion,p:{x:432.4,y:323.05}},{t:this.nextEscenaFinal}]},1).wait(1));
	...
	// chat
	this.instance_4 = new lib.Sillon();
	this.instance_4.setTransform(531,369,0.5,0.5);

	this.instance_5 = new lib.Tronco();
	this.instance_5.setTransform(398,336,0.5,0.5);
	...
	// tronco
	this.instance_6 = new lib.Recurso80();
	this.instance_6.setTransform(908,269,0.2896,0.2896);
	...
	// casa
	this.instance_7 = new lib.casa();
	this.instance_7.setTransform(685.8,169.25,1,1,0,0,0,245.3,239);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1715817099055", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1715817099056", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1715817099057", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1715817099193", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1715817099193", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1715817099193", id:"Voice2"},
		{src:"sounds/interaccion.mp3?1715817099193", id:"interaccion"},
		{src:"sounds/intro.mp3?1715817099193", id:"intro"},
		{src:"sounds/BGM.mp3?1715817099193", id:"BGM"}
	],
	preloads: []
};
