...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_3", frames: [[0,79,2377,76],[1154,588,80,80],[2179,604,80,80],[0,157,2377,76],[2790,194,81,80],[2790,276,81,80],[2790,111,81,81],[2286,313,80,81],[1484,650,79,79],[834,626,79,80],[0,235,2377,76],[0,0,2377,77],[2063,313,221,289],[2286,397,221,289],[2509,397,221,284],[1549,313,221,335],[1772,566,221,284],[1267,584,215,265],[1995,566,59,30],[1565,650,92,47],[1212,670,52,26],[2790,358,90,35],[2805,674,73,38],[1267,313,280,269],[2732,674,71,57],[321,615,116,126],[510,313,441,311],[953,588,199,180],[439,626,136,106],[157,615,162,148],[1995,604,182,183],[1723,650,43,41],[2790,0,93,109],[577,626,113,119],[1659,650,62,68],[692,626,140,79],[1154,670,56,74],[1484,584,44,58],[2732,397,146,275],[1236,588,29,54],[953,313,312,273],[2577,683,66,14],[2509,683,66,37],[1772,313,289,251],[2379,0,409,395],[0,615,155,204],[0,313,508,300]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-54.8,-55.1,0.6022,0.6022);
...
p.nominalBounds = new cjs.Rectangle(-54.8,-55.1,109.6,110.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_5.setTransform(65.6,62.9,1,1,0,0,0,39.8,45.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:39.9,rotation:14.9992,x:65.7,y:62.95},34).to({regX:39.8,rotation:0,x:65.6,y:62.9},35).to({startPosition:0},22).wait(1));

	// Símbolo 2
	this.instance_6 = new lib.Símbolo2_1();
	this.instance_6.setTransform(121.5,45.95,1,1,0,0,0,55.2,9.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({rotation:-14.9992,x:121.45},34).to({rotation:0,x:121.5},35).wait(23));

	// Capa_2
	this.instance_7 = new lib.ViñetaFlor();
	this.instance_7.setTransform(4,-19,0.4287,0.4613);
...
p.nominalBounds = new cjs.Rectangle(-29.5,-59,251.3,178.4);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.cerdo2).to({alpha:0.4844},14).to({alpha:1},15).wait(96));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-141.6,-33.8,360.6,190.2);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(80).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3));
...
if (reversed == null) { reversed = false; }
	...
	this.frame_4 = function() {
		...
		_this.flor.cabezaflor.gotoAndPlay(0);
	...
	this.btnInteraccion.setTransform(647.1,298.65,1,1,0,0,0,-21.1,7.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnInteraccion,p:{x:647.1,y:298.65}}]},10).to({state:[{t:this.btnInteraccion,p:{x:645.9,y:298.8}},{t:this.nextEscenaFinal}]},1).wait(1));
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgSAaQgJgFgEgKQgEgLAEgIQADgKAJgGQAJgGAKABIAAgCQAPADAHAGQAFAEAEAJQADAGAAADQABAFgGAJQgFAIgJAGQgEACABACQgUAAgKgGg");
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1715811677157", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1715811677157", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1715811677159", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1715811677318", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1715811677318", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1715811677318", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1715811677318", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1715811677318", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1715811677318", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1715811677318", id:"Voice6"},
		{src:"sounds/Voice7.mp3?1715811677318", id:"Voice7"},
		{src:"sounds/interaccion.mp3?1715811677318", id:"interaccion"},
		{src:"sounds/intro.mp3?1715811677318", id:"intro"},
		{src:"sounds/BGM.mp3?1715811677318", id:"BGM"}
	],
	preloads: []
};
