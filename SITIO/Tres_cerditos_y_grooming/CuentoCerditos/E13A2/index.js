...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,0,2378,1140]]},
		{name:"index_atlas_P_2", frames: [[0,639,2377,84],[2341,1005,80,80],[0,552,2377,85],[2423,1005,80,80],[2093,974,81,80],[2176,974,81,80],[0,725,2377,77],[717,967,81,81],[2259,974,80,81],[2586,1005,79,79],[2505,1005,79,80],[182,967,178,186],[0,967,180,185],[1149,480,69,25],[774,480,81,36],[690,480,82,54],[987,480,71,30],[903,480,82,31],[2849,726,33,112],[614,967,101,104],[2792,0,91,130],[2792,132,90,115],[2715,916,139,107],[2715,734,132,180],[1630,1018,57,108],[0,0,2376,129],[362,967,250,110],[2378,0,412,370],[1060,480,34,60],[2765,616,105,108],[2792,249,93,109],[0,804,798,161],[2093,804,248,168],[2765,372,114,242],[1096,480,51,38],[857,480,44,58],[2881,360,5,99],[1470,131,545,419],[690,131,778,347],[2017,131,358,381],[2379,734,334,269],[1630,804,271,212],[800,804,353,227],[0,131,688,414],[2379,372,384,360],[1379,804,249,254],[1903,804,188,284],[1155,804,222,299]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// chat
	this.instance_4 = new lib.Tronco();
	this.instance_4.setTransform(398,336,0.5,0.5);
	...
	// tronco
	this.instance_5 = new lib.Recurso80();
	this.instance_5.setTransform(982,271,0.1883,0.1883);
	...
	// casa
	this.instance_6 = new lib.casa();
	this.instance_6.setTransform(685.8,169.25,1,1,0,0,0,245.3,239);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(7));

	// fondo
	this.instance_7 = new lib.Fondo();
	this.instance_7.setTransform(0,-3,0.505,0.5013);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1708224930502", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1708224930504", id:"index_atlas_P_2"},
		{src:"sounds/Voice0.mp3?1708224930651", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1708224930651", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1708224930651", id:"Voice2"},
		{src:"sounds/interaccion.mp3?1708224930651", id:"interaccion"},
		{src:"sounds/intro.mp3?1708224930651", id:"intro"},
		{src:"sounds/BGM.mp3?1708224930651", id:"BGM"}
	],
	preloads: []
};
