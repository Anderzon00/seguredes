...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,938,2377,84],[0,851,2377,85],[0,720,2376,129],[1830,0,713,474],[0,0,945,718],[947,0,881,566]]},
		{name:"index_atlas_P_3", frames: [[646,1384,80,80],[728,1384,80,80],[939,1355,81,80],[481,1379,81,80],[939,1272,81,81],[564,1379,80,81],[392,1405,79,79],[810,1384,79,80],[370,1133,178,186],[188,1133,180,185],[832,229,64,27],[659,229,82,54],[951,577,33,112],[188,925,116,157],[275,1321,115,124],[134,1320,139,107],[0,1294,132,180],[0,925,186,228],[951,467,57,108],[0,1155,183,137],[550,1133,135,244],[687,1272,250,110],[743,229,34,60],[392,1321,87,82],[0,467,318,456],[0,304,996,161],[717,1102,248,168],[779,229,51,38],[1014,0,5,99],[0,0,657,302],[320,850,395,281],[320,467,358,381],[717,697,294,204],[680,467,269,228],[659,0,353,227],[717,903,261,197]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,47.5,0.5,0.5,-90);

	this.instance_1 = new lib.BrazoIzq_1();
	this.instance_1.setTransform(12,17,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo8, new cjs.Rectangle(0,4,69.5,75), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ParedFrontal();
	this.instance.setTransform(-178.25,-118.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-178.2,-118.5,356.5,237);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.ParedLateral();
	this.instance.setTransform(-79.5,-114,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-79.5,-114,159,228);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PasamanosFrontal();
	this.instance.setTransform(-249,-40.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-249,-40.2,498,80.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-62,-42,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-62,-42,124,84);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Recurso13x();
	this.instance.setTransform(197.5,-140.5,1,1,0,0,180);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.TechoFrontal();
	this.instance.setTransform(-220.25,-141.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-220.2,-141.5,440.5,283);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.FondoVentana();
	this.instance.setTransform(-45.75,-34.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-45.7,-34.2,91.5,68.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-65.25,-49.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-65.2,-49.2,130.5,98.5);
...
(lib.Interpolación4_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance_1 = new lib.FondoHumoTazaCafe();
	this.instance_1.setTransform(-14.25,-27,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(73.9731,47.1355);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(73.8625,45.1875);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(73.9731,45.425);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[]},3).to({state:[{t:this.shape_1}]},39).to({state:[{t:this.shape_2}]},3).wait(3));

	// Capa_1
	this.instance = new lib.Rostro_7();
	this.instance.setTransform(0,0,0.5,0.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#008699").s().p("AgVAUQgGgHgBgJQgBgIAEgJQADgJAKgFQAIgEAJABQAJACAHAGQAIAJAAANQABAMgIAKQgKAJgMAAQgNgBgIgKg");
	this.shape_3.setTransform(61.1942,48.3813);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.instance}]}).wait(48));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,147,102);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Interpolación4_1("synched",0);
...
p.nominalBounds = new cjs.Rectangle(-0.9,0.4,78.60000000000001,78.6);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(30).call(this.frame_30).wait(28).call(this.frame_58).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(51).to({_off:false},0).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(59));

	// bocaDientes
	this.instance_6 = new lib.Interpolación10("synched",0);
	this.instance_6.setTransform(-272.7,23.4,1,1,-13.9726,0,0,-18.4,-11.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({rotation:-7.2478,y:23.35},5).to({rotation:-13.9726,y:23.4},10).to({_off:true},1).wait(15).to({_off:false},0).wait(28));
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#CC9D94").s().p("");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7}]}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.instance_8},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},16).to({state:[{t:this.instance_7}]},15).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(16).to({_off:false},0).to({regY:-23.6,scaleX:0.992,scaleY:1.2988,y:35.25},4).to({alpha:0},10).to({_off:true,regX:0,regY:0,scaleX:1,scaleY:1,x:66.25,y:38.3,alpha:1},1).wait(28));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(30).to({_off:false},1).to({scaleX:59.0108,scaleY:59.0108,x:63.4,y:58.05,alpha:0.1016},8).to({scaleX:309.0315,scaleY:309.0315,x:20.4,y:42.65,alpha:0.3281},7).to({scaleX:309.0255,scaleY:309.0255,rotation:-44.9994,x:-9.35,y:106.45,alpha:0.0703},5).to({startPosition:0},7).wait(1));

	// TechoFrontal.png
	this.instance_11 = new lib.Interpolación17("synched",0);
	this.instance_11.setTransform(37.25,-192.5);

	this.instance_12 = new lib.Interpolación18("synched",0);
	this.instance_12.setTransform(37.25,-192.5);
	this.instance_12._off = true;

	this.instance_13 = new lib.Interpolación21("synched",0);
	this.instance_13.setTransform(37.25,99.1,1,0.405);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_11}]}).to({state:[{t:this.instance_12}]},30).to({state:[{t:this.instance_13}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},30).wait(29));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:false},30).to({_off:true,scaleY:0.405,y:99.1},28).wait(1));

	// Recurso 1@3x.png
	this.instance_14 = new lib.Interpolación25("synched",0);
	this.instance_14.setTransform(212.5,-196.5);

	this.instance_15 = new lib.Interpolación26("synched",0);
	this.instance_15.setTransform(212.5,-196.5);
	this.instance_15._off = true;

	this.instance_16 = new lib.Interpolación27("synched",0);
	this.instance_16.setTransform(195.05,105.9,1,0.6273,-6.202,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_14}]}).to({state:[{t:this.instance_15}]},30).to({state:[{t:this.instance_16}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true},30).wait(29));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({_off:false},30).to({_off:true,regX:0.1,regY:0.1,scaleY:0.6273,rotation:-6.202,x:195.05,y:105.9},28).wait(1));

	// VentanaFrontal.png
	this.instance_17 = new lib.Interpolación7("synched",0);
	this.instance_17.setTransform(103.25,23.25);

	this.instance_18 = new lib.Interpolación9("synched",0);
	this.instance_18.setTransform(103.25,23.25);
	this.instance_18._off = true;

	this.instance_19 = new lib.Interpolación11("synched",0);
	this.instance_19.setTransform(103.25,102.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17}]}).to({state:[{t:this.instance_18}]},30).to({state:[{t:this.instance_19}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({_off:true},30).wait(29));
	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({_off:false},30).to({_off:true,y:102.9},28).wait(1));

	// FondoVentana.png
	this.instance_20 = new lib.Interpolación12("synched",0);
	this.instance_20.setTransform(103.75,22.25);

	this.instance_21 = new lib.Interpolación14("synched",0);
	this.instance_21.setTransform(103.75,22.25);
	this.instance_21._off = true;

	this.instance_22 = new lib.Interpolación16("synched",0);
	this.instance_22.setTransform(103.75,83);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_20}]}).to({state:[{t:this.instance_21}]},30).to({state:[{t:this.instance_22}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_20).to({_off:true},30).wait(29));
	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({_off:false},30).to({_off:true,y:83},28).wait(1));

	// PasamanosLateral.png
	this.instance_23 = new lib.Interpolación28("synched",0);
	this.instance_23.setTransform(272,130);

	this.instance_24 = new lib.Interpolación29("synched",0);
	this.instance_24.setTransform(272,130);
	this.instance_24._off = true;

	this.instance_25 = new lib.Interpolación30("synched",0);
	this.instance_25.setTransform(272,130);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_23}]}).to({state:[{t:this.instance_24}]},30).to({state:[{t:this.instance_25}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_23).to({_off:true},30).wait(29));
	this.timeline.addTween(cjs.Tween.get(this.instance_24).to({_off:false},30).to({_off:true},28).wait(1));

	// PasamanosFrontal.png
	this.instance_26 = new lib.Interpolación31("synched",0);
	this.instance_26.setTransform(66,132.25);

	this.instance_27 = new lib.Interpolación32("synched",0);
	this.instance_27.setTransform(66,132.25);
	this.instance_27._off = true;

	this.instance_28 = new lib.Interpolación33("synched",0);
	this.instance_28.setTransform(66,132.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_26}]}).to({state:[{t:this.instance_27}]},30).to({state:[{t:this.instance_28}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_26).to({_off:true},30).wait(29));
	this.timeline.addTween(cjs.Tween.get(this.instance_27).to({_off:false},30).to({_off:true},28).wait(1));

	// ParedLateral.png
	this.instance_29 = new lib.Interpolación35("synched",0);
	this.instance_29.setTransform(246.5,157,1,1,0,0,0,0,114);

	this.instance_30 = new lib.Interpolación36("synched",0);
	this.instance_30.setTransform(246.5,157,1,1,0,0,0,0,114);
	this.instance_30._off = true;

	this.instance_31 = new lib.Interpolación38("synched",0);
	this.instance_31.setTransform(246.6,157.05,1,0.3881,0,74.0948,0,0.1,113.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_29}]}).to({state:[{t:this.instance_30}]},30).to({state:[{t:this.instance_31}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_29).to({_off:true},30).wait(29));
	this.timeline.addTween(cjs.Tween.get(this.instance_30).to({_off:false},30).to({_off:true,regX:0.1,regY:113.8,scaleY:0.3881,skewX:74.0948,x:246.6,y:157.05},28).wait(1));

	// ParedFrontal.png
	this.instance_32 = new lib.Interpolación39("synched",0);
	this.instance_32.setTransform(-151.95,157,1,1,0,0,0,-178.2,118.5);

	this.instance_33 = new lib.Interpolación40("synched",0);
	this.instance_33.setTransform(-151.95,157,1,1,0,0,0,-178.2,118.5);
	this.instance_33._off = true;

	this.instance_34 = new lib.Interpolación41("synched",0);
	this.instance_34.setTransform(-152.25,157.05,1,0.0807,0,-49.0616,0,-178.3,119.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_32}]}).to({state:[{t:this.instance_33}]},30).to({state:[{t:this.instance_34}]},28).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_32).to({_off:true},30).wait(29));
	this.timeline.addTween(cjs.Tween.get(this.instance_33).to({_off:false},30).to({_off:true,regX:-178.3,regY:119.1,scaleY:0.0807,skewX:-49.0616,x:-152.25,y:157.05},28).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-368,-337,796.6,662);
...
if (reversed == null) { reversed = false; }
	...
	// Boca2_9.png
	this.instance = new lib.Boca1_11();
	this.instance.setTransform(229,4,0.5,0.5);
	...
	// Silueta_2.png
	this.instance_2 = new lib.Silueta_4();
	this.instance_2.setTransform(180,17,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(10));

	// Manga_9.png
	this.instance_3 = new lib.Manga_11();
	this.instance_3.setTransform(189,27,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(10));

	// brazo
	this.instance_4 = new lib.brazo();
	this.instance_4.setTransform(307.8,65.6,1,1,0,0,0,46.8,46.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(10));

	// BrazoDer.png
	this.instance_5 = new lib.BrazoDer();
	this.instance_5.setTransform(221,21,0.5,0.5,0,0,180);
...
p.nominalBounds = new cjs.Rectangle(163,-78,167.5,209);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(47.75,176.6,0.6103,0.5271,0,0,0,241.1,76);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:241,regY:76.1,scaleX:0.6102,x:47.6,y:151.6},49).to({regX:241.1,regY:76,scaleX:0.6103,x:47.75,y:176.6},50).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,70.4,102.4,135.2);
...
if (reversed == null) { reversed = false; }
	...
	this.btnInteraccion.setTransform(635.4,409,1,1,0,0,0,-21.1,7.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnInteraccion,p:{x:635.4}}]},4).to({state:[{t:this.btnInteraccion,p:{x:636.4}},{t:this.nextEscenaFinal}]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).wait(4));

	// textos2
	this.instance_1 = new lib._2B();
	this.instance_1.setTransform(2,532,0.5,0.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.nextEscena},{t:this.prevEscena}]}).to({state:[{t:this.shape_1},{t:this.prevEscena}]},5).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.pressToStart},{t:this.muteMC,p:{x:312.5}},{t:this.unmuteMC,p:{x:312.5}},{t:this.prev,p:{x:102.3}},{t:this.next,p:{x:149.1}}]}).to({state:[{t:this.playaudio},{t:this.muteMC,p:{x:312.35}},{t:this.unmuteMC,p:{x:312.35}},{t:this.pause},{t:this.prev,p:{x:102.15}},{t:this.next,p:{x:148.95}}]},1).to({state:[{t:this.playaudio},{t:this.muteMC,p:{x:312.35}},{t:this.unmuteMC,p:{x:312.35}},{t:this.pause},{t:this.prev,p:{x:102.15}},{t:this.next,p:{x:148.95}}]},4).wait(1));

	// fondo blanco
	this.instance_2 = new lib.mc_fondotexto();
	this.instance_2.setTransform(708.15,521.7,1,1,0,0,0,594,151.2);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regY:219.8,scaleX:1.0034,x:596,y:535.75,alpha:0.4299},0).wait(1).to({regY:151.2,x:596.05,y:467.2,alpha:1},0).wait(1).to({regY:219.8,x:596,y:535.8},0).wait(3));

	// mascara (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(170.3329,178.8347);

	// flor
	this.instance_3 = new lib.flor();
	this.instance_3.setTransform(64.1,240,0.5565,0.5565,0,0,0,51.1,87.7);
	...
	// sombrilla
	this.instance_4 = new lib.Sillas();
	this.instance_4.setTransform(801,281,0.4081,0.4081);
	...
	this.lobo.name = "lobo";
	this.lobo.setTransform(222.5,413.2,1.2112,1.2112,0,0,0,-378.4,91.9);

	this.timeline.addTween(cjs.Tween.get(this.lobo).wait(6));

	// flores
	this.instance_5 = new lib.GIRASOLES();
	this.instance_5.setTransform(204.3,368.5,0.8411,0.7594,0,0,0,176.3,66.5);

	this.instance_6 = new lib.PlantasTomate();
	this.instance_6.setTransform(24,407,0.5,0.5);

	this.instance_7 = new lib.Flores();
	this.instance_7.setTransform(692,385,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]}).wait(6));

	// fondo
	this.instance_8 = new lib.FondoEscena();
	this.instance_8.setTransform(0,-3,0.505,0.5013);
...
p.nominalBounds = new cjs.Rectangle(500,218.3,802.2,495.7);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1715817230969", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1715817230969", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1715817230970", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1715817231154", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1715817231154", id:"Voice1"},
		{src:"sounds/interaccion.mp3?1715817231154", id:"interaccion"},
		{src:"sounds/intro.mp3?1715817231154", id:"intro"},
		{src:"sounds/BGM.mp3?1715817231154", id:"BGM"}
	],
	preloads: []
};
