...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,720,2376,129],[1830,0,713,474],[0,851,657,302],[0,0,945,718],[947,0,881,566]]},
		{name:"index_atlas_P_3", frames: [[0,79,2377,76],[1666,513,80,80],[0,235,2377,70],[1748,513,80,80],[0,157,2377,76],[1962,506,81,80],[2045,506,81,80],[0,0,2377,77],[875,470,81,81],[2128,506,80,81],[1395,537,79,79],[1830,513,79,80],[2291,427,55,19],[2225,427,64,27],[1529,537,55,19],[2836,418,33,112],[410,470,116,157],[669,470,115,124],[528,470,139,107],[276,470,132,180],[2225,307,128,118],[2699,0,186,228],[2475,458,183,137],[2699,418,135,244],[2660,458,34,60],[786,470,87,82],[0,470,274,110],[2379,0,318,456],[0,307,996,161],[2225,458,248,168],[1476,537,51,38],[2879,230,5,99],[998,307,395,281],[2699,230,178,186],[1666,307,294,204],[1395,307,269,228],[1962,307,261,197]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},25).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).wait(3).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},18).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(25).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(6).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(18).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(4));

	// Símbolo 12
	this.instance_2 = new lib.Símbolo12();
	this.instance_2.setTransform(-273.1,108.1,1,1,0,0,0,13.9,38.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(152));

	// Cuerpo_2.png
	this.instance_3 = new lib.Cuerpo_2();
	this.instance_3.setTransform(-299,48,0.6,0.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(152));

	// Cuerpo_1.png
	this.instance_4 = new lib.Símbolo11();
	this.instance_4.setTransform(-326.3,115.1,1,1,0,0,0,41.7,32.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(152));

	// Símbolo 10
	this.instance_5 = new lib.Símbolo10();
	this.instance_5.setTransform(-261.6,-0.2,1,1,0,0,0,53.4,55.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(152));

	// Pierna_1.png
	this.instance_6 = new lib.Pierna_1();
	this.instance_6.setTransform(-248,123,0.6,0.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(152));

	// Patas_2.png
	this.instance_7 = new lib.Pierna_1();
	this.instance_7.setTransform(-273,123,0.6,0.6);

	this.instance_8 = new lib.Patas_2();
	this.instance_8.setTransform(-279.1,181.25,0.5999,0.5999,3.818);

	this.instance_9 = new lib.Patas_2();
	this.instance_9.setTransform(-218.95,113.35,0.5999,0.5999,44.999);

	this.instance_10 = new lib.Patas_2();
	this.instance_10.setTransform(-247.5,177.7,0.5999,0.5999,12.2751);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7}]}).wait(152));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-368,-56,170.7,262.5);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(49).call(this.frame_49).wait(51));
	...
	// flor
	this.instance_1 = new lib.flor1();
	this.instance_1.setTransform(387.95,475.15,0.6103,0.5271,0,0,0,241.1,76);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:410.15},49).to({y:472.15},50).wait(1));

	// MergedLayer_2
	this.instance_2 = new lib.FondoVentana();
	this.instance_2.setTransform(351,326,0.5,0.5);

	this.instance_3 = new lib.TechoFrontal();
	this.instance_3.setTransform(110,4,0.5,0.5);

	this.instance_4 = new lib.Recurso13x();
	this.instance_4.setTransform(703,1,1,1,0,0,180);

	this.instance_5 = new lib.PasamanosLateral();
	this.instance_5.setTransform(503,426,0.5,0.5);

	this.instance_6 = new lib.PasamanosFrontal();
	this.instance_6.setTransform(110,430,0.5,0.5);

	this.instance_7 = new lib.ParedLateral();
	this.instance_7.setTransform(460,267,0.5,0.5);

	this.instance_8 = new lib.ParedFrontal();
	this.instance_8.setTransform(141,258,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]}).wait(100));
...
if (reversed == null) { reversed = false; }
	...
	this.btnInteraccion.setTransform(602.4,427.05,1,1,0,0,0,-21.1,7.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnInteraccion,p:{y:427.05}}]},6).to({state:[{t:this.btnInteraccion,p:{y:426.05}},{t:this.nextEscenaFinal}]},1).wait(1));
	...
	this.chat.name = "chat";
	this.chat.setTransform(460.55,391,2.1,2.1,0,0,0,57,109);

	this.timeline.addTween(cjs.Tween.get(this.chat).wait(8));

	// lobo
	this.lobo = new lib.lobo();
	this.lobo.name = "lobo";
	this.lobo.setTransform(417.7,386.6,1,1,0,0,0,-274.3,45.6);

	this.timeline.addTween(cjs.Tween.get(this.lobo).wait(8));

	// flores
	this.instance_5 = new lib.GIRASOLES();
	this.instance_5.setTransform(239.2,357.5,1,1,0,0,0,176.2,66.5);

	this.instance_6 = new lib.PlantasTomate();
	this.instance_6.setTransform(78,408,0.5,0.5);

	this.instance_7 = new lib.Flores();
	this.instance_7.setTransform(692,385,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]}).wait(8));

	// Capa_1
	this.instance_8 = new lib.Sillas();
	this.instance_8.setTransform(801,281,0.4081,0.4081);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(8));

	// casa
	this.casa = new lib.casa();
	this.casa.name = "casa";
	this.casa.setTransform(671,239.5,1,1,0,0,0,316,245.5);

	this.timeline.addTween(cjs.Tween.get(this.casa).wait(8));

	// fondo
	this.instance_9 = new lib.FondoEscena();
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1711303006106", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1711303006106", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1711303006107", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1711303006246", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1711303006246", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1711303006246", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1711303006246", id:"Voice3"},
		{src:"sounds/interaccion.mp3?1711303006246", id:"interaccion"},
		{src:"sounds/intro.mp3?1711303006246", id:"intro"},
		{src:"sounds/BGM.mp3?1711303006246", id:"BGM"}
	],
	preloads: []
};
