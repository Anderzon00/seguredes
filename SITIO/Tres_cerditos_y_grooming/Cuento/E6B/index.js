25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-131.7,-53.2,263.5,106.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-13.5,-24.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-13.5,-24.7,27,49.5);
...
p.nominalBounds = new cjs.Rectangle(-230,-27,501,48);


(lib.video2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(213));

	// play.png
	this.instance = new lib.play();
	this.instance.setTransform(247,136,0.8537,0.7);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({_off:true},9).wait(10).to({_off:false,scaleX:0.8536},0).to({_off:true},10).wait(10).to({_off:false,scaleX:0.8537},0).to({_off:true},10).wait(10).to({_off:false,scaleX:0.8536},0).to({_off:true},10).wait(10).to({_off:false,scaleX:0.8537},0).to({_off:true},10).wait(10).to({_off:false,scaleX:0.8536},0).to({_off:true},10).wait(10).to({_off:false},0).to({_off:true},10).wait(10).to({_off:false},0).to({_off:true},10).wait(10).to({_off:false},0).to({_off:true},10).wait(10).to({_off:false},0).to({_off:true},10).wait(23));

	// SombraSobreVideo.png
	this.instance_1 = new lib.Interpolación12("synched",0);
	this.instance_1.setTransform(140.5,118.35);
	this.instance_1.alpha = 0;

	this.instance_2 = new lib.Interpolación14("synched",0);
	this.instance_2.setTransform(140.5,118.35);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},14).wait(199));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true,alpha:1},14).wait(199));

	// MergedLayer_4
	this.instance_3 = new lib.Interpolación16("synched",0);
	this.instance_3.setTransform(150,85);
	this.instance_3.alpha = 0;

	this.instance_4 = new lib.Interpolación17("synched",0);
	this.instance_4.setTransform(150,85);

	this.instance_5 = new lib.image0002();

	this.instance_6 = new lib.image0003();

	this.instance_7 = new lib.image0004();

	this.instance_8 = new lib.image0005();

	this.instance_9 = new lib.image0006();

	this.instance_10 = new lib.image0007();

	this.instance_11 = new lib.image0008();

	this.instance_12 = new lib.image0009();

	this.instance_13 = new lib.image0010();

	this.instance_14 = new lib.image0011();

	this.instance_15 = new lib.image0012();

	this.instance_16 = new lib.image0013();

	this.instance_17 = new lib.image0014();

	this.instance_18 = new lib.image0015();

	this.instance_19 = new lib.image0016();

	this.instance_20 = new lib.image0017();

	this.instance_21 = new lib.image0018();

	this.instance_22 = new lib.image0019();

	this.instance_23 = new lib.image0020();

	this.instance_24 = new lib.image0021();

	this.instance_25 = new lib.image0022();

	this.instance_26 = new lib.image0023();

	this.instance_27 = new lib.image0024();

	this.instance_28 = new lib.image0025();

	this.instance_29 = new lib.image0026();

	this.instance_30 = new lib.image0027();

	this.instance_31 = new lib.image0028();

	this.instance_32 = new lib.image0029();

	this.instance_33 = new lib.image0030();

	this.instance_34 = new lib.image0031();

	this.instance_35 = new lib.image0032();

	this.instance_36 = new lib.image0033();

	this.instance_37 = new lib.image0034();

	this.instance_38 = new lib.image0035();

	this.instance_39 = new lib.image0036();

	this.instance_40 = new lib.image0037();

	this.instance_41 = new lib.image0038();

	this.instance_42 = new lib.image0039();

	this.instance_43 = new lib.image0040();

	this.instance_44 = new lib.image0041();

	this.instance_45 = new lib.image0042();

	this.instance_46 = new lib.image0043();

	this.instance_47 = new lib.image0044();

	this.instance_48 = new lib.image0045();

	this.instance_49 = new lib.image0046();

	this.instance_50 = new lib.image0047();

	this.instance_51 = new lib.image0048();

	this.instance_52 = new lib.image0049();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3}]}).to({state:[{t:this.instance_4}]},14).to({state:[{t:this.instance_5}]},3).to({state:[{t:this.instance_6}]},4).to({state:[{t:this.instance_7}]},4).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_9}]},4).to({state:[{t:this.instance_10}]},4).to({state:[{t:this.instance_11}]},4).to({state:[{t:this.instance_12}]},4).to({state:[{t:this.instance_13}]},4).to({state:[{t:this.instance_14}]},4).to({state:[{t:this.instance_15}]},4).to({state:[{t:this.instance_16}]},4).to({state:[{t:this.instance_17}]},4).to({state:[{t:this.instance_18}]},4).to({state:[{t:this.instance_19}]},4).to({state:[{t:this.instance_20}]},4).to({state:[{t:this.instance_21}]},4).to({state:[{t:this.instance_22}]},4).to({state:[{t:this.instance_23}]},4).to({state:[{t:this.instance_24}]},4).to({state:[{t:this.instance_25}]},4).to({state:[{t:this.instance_26}]},4).to({state:[{t:this.instance_27}]},4).to({state:[{t:this.instance_28}]},4).to({state:[{t:this.instance_29}]},4).to({state:[{t:this.instance_30}]},4).to({state:[{t:this.instance_31}]},4).to({state:[{t:this.instance_32}]},4).to({state:[{t:this.instance_33}]},4).to({state:[{t:this.instance_34}]},4).to({state:[{t:this.instance_35}]},4).to({state:[{t:this.instance_36}]},4).to({state:[{t:this.instance_37}]},4).to({state:[{t:this.instance_38}]},4).to({state:[{t:this.instance_39}]},4).to({state:[{t:this.instance_40}]},4).to({state:[{t:this.instance_41}]},4).to({state:[{t:this.instance_42}]},4).to({state:[{t:this.instance_43}]},4).to({state:[{t:this.instance_44}]},4).to({state:[{t:this.instance_45}]},4).to({state:[{t:this.instance_46}]},4).to({state:[{t:this.instance_47}]},4).to({state:[{t:this.instance_48}]},4).to({state:[{t:this.instance_49}]},4).to({state:[{t:this.instance_50}]},4).to({state:[{t:this.instance_51}]},4).to({state:[{t:this.instance_52}]},4).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true,alpha:1},14).wait(199));

	// CuadroVIdeo.png
	this.instance_53 = new lib.Interpolación18("synched",0);
	this.instance_53.setTransform(141.3,95);
	this.instance_53.alpha = 0;

	this.instance_54 = new lib.Interpolación19("synched",0);
	this.instance_54.setTransform(141.3,95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_53}]}).to({state:[{t:this.instance_54}]},14).wait(199));
	this.timeline.addTween(cjs.Tween.get(this.instance_53).to({_off:true,alpha:1},14).wait(199));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-35,-62,352.6,314);
...
if (reversed == null) { reversed = false; }
	...
	// video2
	this.video = new lib.video2();
	this.video.name = "video";
	this.video.setTransform(708.05,3.05,0.6267,0.6984,0,0,0,300.1,170);

	this.timeline.addTween(cjs.Tween.get(this.video).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.video, new cjs.Rectangle(498,-158.9,221,219.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.BMP_94eb6838_3c0e_4453_ba68_ae178665b78b();
	this.instance_1.setTransform(-5.15,-4.1);
...
p.nominalBounds = new cjs.Rectangle(-5.1,-4.1,80,78);
...
if (reversed == null) { reversed = false; }
	...
	// MergedLayer_1 copia copia copia
	this.instance = new lib.Interpolación3("synched",0);
	this.instance.setTransform(75.55,-0.65);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-884.2,y:1.3},1498).wait(1));

	// MergedLayer_1 copia copia
	this.instance_1 = new lib.Interpolación3("synched",0);
	this.instance_1.setTransform(777,1.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:75.55,y:-0.65},1498).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1114.2,-27.6,2162.2,49.900000000000006);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-18.25,-17.75,0.5,0.5);

	this.instance_1 = new lib.PuppetShape_1("synched",1,false);
	this.instance_1.setTransform(-2.95,-3.4,0.5329,0.5329,0,0,0,36.5,35.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},14).wait(15));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-25.1,-24.5,43.400000000000006,42.3);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:14.9992,y:77.4},49).to({rotation:0,y:77.35},50).wait(1));
...
(lib.celular_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(89.7,66.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({guide:{path:[89.7,66.1,89.8,63.4,88.1,60.7,87.5,59.6,84.2,55.5,82.2,53,81.6,52.5,81.1,51.9,80.6,51.5]}},18).to({guide:{path:[80.7,51.5,79.7,50.6,78.6,50,77.3,49.4,73.9,48.7,65.4,47.5,59.5,47.5,58.3,47.6,57.5,47.7]}},20).to({guide:{path:[57.5,47.8,56.9,47.9,56.6,48.1,55.5,48.6,54.4,49.9,53,51.7,51.8,54.4,50.2,58.2,49.9,62.2]}},20).to({guide:{path:[49.9,62.2,49.8,63.3,49.8,64.5,49.8,68.4,51,71.8,52.5,75.5,55.1,77.8,55.8,78.4,56.5,78.9]}},20).to({guide:{path:[56.5,78.9,57.6,79.6,58.9,80.3,59.8,80.7,62.9,82,66.7,83.7,69.2,84,70.3,84.1,72.4,84.1,73.5,84.1,74.6,84.1]}},22).to({guide:{path:[74.6,84.1,75.5,84.1,76.4,84.1,77.7,84.1,78.3,83.9,78.9,83.7,80.2,82.5,82.7,79.9,84.9,76.6]}},18).to({guide:{path:[84.9,76.5,86.8,73.8,88.4,70.5,89.4,68.2,89.6,66.9,89.7,66.5,89.7,66]}},20).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,0,124.5,168);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(501.8,556.3,1,1,3.7454,0,0,-112,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:0.1,rotation:-5.9734,x:501.75,y:556.4},39).to({regY:0,rotation:3.7454,x:501.8,y:556.3},40).wait(1));

	// celular
	this.instance_1 = new lib.celular_1();
	this.instance_1.setTransform(728.2,469,1,1,0,0,0,62.2,84);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:62.3,rotation:-6.4429,x:714.3,y:431.95},39).to({regX:62.2,rotation:0,x:728.2,y:469},40).wait(1));

	// ojos
	this.instance_2 = new lib.ojos();
	this.instance_2.setTransform(559.6,450.1,1,1,0,0,0,30,10.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(80));

	// SiluetaAurora.png
	this.instance_3 = new lib.SiluetaAurora();
	this.instance_3.setTransform(407,331,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(80));

	// BrazoIzq_1.png
	this.instance_4 = new lib.Interpolación15("synched",0);
	this.instance_4.setTransform(561.5,553.75,1,1,0,0,0,-72,29);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY:29.1,rotation:-6.5399,x:559.5,y:539.85},39).to({regY:29,rotation:0,x:561.5,y:553.75},40).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(407,331,383.5,448.5);


(lib.nubes_grupo = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(181.5,82.3708);

	// nubes
	this.instance = new lib.nubes();
	this.instance.setTransform(118.8,21.3,0.7688,0.7688);

	this.instance_1 = new lib.nubes();
	this.instance_1.setTransform(227.45,100.5,0.7688,0.7688);
...
p.nominalBounds = new cjs.Rectangle(0.1,0.1,783.9,117.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-426.75,29.65,0.9999,0.9999,-0.0009,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(400));

	// mariposa_b
	this.instance_1 = new lib.mariposa_1();
	this.instance_1.setTransform(-377.55,-69.85,1,1,-29.9992);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0.1,regY:-0.1,rotation:-147.2436,guide:{path:[-377.5,-69.8,-393.6,-75.5,-411.9,-75.5,-457.8,-75.5,-490.2,-39.8,-518,-9.4,-522,32]}},98).to({regX:0,regY:0,rotation:-225,guide:{path:[-522,32.1,-522.6,39.1,-522.6,46.3,-522.6,96.6,-490.2,132.3,-467.2,157.5,-437.6,164.9]}},100).to({scaleX:0.9999,scaleY:0.9999,rotation:-321.4287,guide:{path:[-437.6,164.8,-425.3,167.9,-411.8,167.9,-366,167.9,-333.5,132.3,-308.2,104.4,-302.7,67.7]}},100).to({scaleX:1,scaleY:1,rotation:-389.9992,guide:{path:[-302.7,67.7,-301.1,57.3,-301.1,46.2,-301.1,-4.1,-333.6,-39.8,-353.1,-61.2,-377.5,-69.8]}},101).wait(1));

	// mariposa_c
	this.instance_2 = new lib.mariposa_2();
	this.instance_2.setTransform(486.05,58.7);
...
p.nominalBounds = new cjs.Rectangle(-559.1,-112.7,1110.4,317.6);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_5 = function() {
		...
		_this.cuadro.video.gotoAndStop(0);
	}
	...
	this.btnInteraccion.setTransform(619.4,383.15,1,1,0,0,0,-21.1,7.5);
	...
	this.nextEscenaFinal.setTransform(233.1,587.6);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.nextEscena},{t:this.prevEscena}]}).to({state:[{t:this.shape_1},{t:this.prevEscena},{t:this.nextEscenaFinal}]},7).wait(1));
	...
	// video
	this.cuadro = new lib.video();
	this.cuadro.name = "cuadro";
	this.cuadro.setTransform(677,99,1,1,0,0,0,600,-90);

	this.timeline.addTween(cjs.Tween.get(this.cuadro).wait(8));

	// aurora
	this.aurora = new lib.aurora();
	this.aurora.name = "aurora";
	this.aurora.setTransform(48.9,239,1,1,0,0,0,270.5,448.5);

	this.timeline.addTween(cjs.Tween.get(this.aurora).wait(8));

	// mariposas
	this.instance_5 = new lib.mariposas();
	this.instance_5.setTransform(536.2,365.1);

	this.instance_6 = new lib.mariposa();
	this.instance_6.setTransform(1129.95,222.25);

	this.instance_7 = new lib.mariposa();
	this.instance_7.setTransform(1046.95,258.3,1,1,71.4951);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]}).wait(8));

	// nubes
	this.instance_8 = new lib.nubes_grupo();
	this.instance_8.setTransform(946.65,94,1,1,0,0,0,534.6,72.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(8));

	// fondo
	this.instance_9 = new lib.flor_2();
	this.instance_9.setTransform(1000.15,506.65,1,1,0,0,180,33.8,39);

	this.instance_10 = new lib.flor_2();
	this.instance_10.setTransform(966.05,498.15,1,1,0,0,180,33.8,39);

	this.instance_11 = new lib.flor_2();
	this.instance_11.setTransform(959.9,506.65,1,1,0,0,0,33.8,39);

	this.instance_12 = new lib.Fondo_1();
	this.instance_12.setTransform(0,-3,0.505,0.5013);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9}]}).wait(8));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(587.1,321.5,858.1,310.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1692142606613", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1692142606615", id:"index_atlas_P_2"},
		{src:"images/index_atlas_NP_1.jpg?1692142606617", id:"index_atlas_NP_1"},
		{src:"sounds/Voice0.mp3?1692142606792", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1692142606792", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1692142606792", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1692142606792", id:"Voice3"},
		{src:"sounds/interaccion.mp3?1692142606792", id:"interaccion"},
		{src:"sounds/intro.mp3?1692142606792", id:"intro"},
		{src:"sounds/BGM.mp3?1692142606792", id:"BGM"}
	],
	preloads: []
};
