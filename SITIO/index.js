...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[2905,1369,40,59],[2840,927,208,208],[2745,1437,323,98],[422,1338,424,122],[422,1462,323,98],[1084,1078,137,137],[2840,1369,63,63],[2319,1437,424,122],[422,1078,463,128],[422,1208,463,128],[887,1275,325,101],[848,1378,321,101],[887,1078,195,195],[948,1481,98,95],[2840,1270,121,97],[1048,1481,98,94],[2963,1270,100,100],[849,1481,97,97],[747,1481,100,100],[0,0,1222,1076],[2319,702,519,733],[2745,1537,86,86],[2840,702,207,223],[1224,0,1086,1033],[0,1078,420,713],[2312,0,738,700],[2840,1137,212,131],[1224,1035,1093,548]]}
];
...
(lib.BtnDescargar_Hover = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
(lib.BtnDescargar_IconCarpeta = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(5);
}).prototype = p = new cjs.Sprite();
...
(lib.BtnDescargar_IconFlecha = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
...
(lib.BtnDescargarHover_1 = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.BtnIngresar_Hover = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(9);
}).prototype = p = new cjs.Sprite();
...
p.nominalBounds = new cjs.Rectangle(0,0,2082,1562);


(lib.FormaVentana = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(19);
}).prototype = p = new cjs.Sprite();
...
(lib.TituloPantallaIngreso = function() {
	this.initialize(ss["index_atlas_1"]);
	this.gotoAndStop(27);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.TituloPantallaIngreso();
...
p.nominalBounds = new cjs.Rectangle(-262.5,-135,1093,548);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(811,812,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.fondodDer, new cjs.Rectangle(811,812,1041,781), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(55,22,0.5,0.5);

	this.instance_1 = new lib.cuadernomanualusuario();
	this.instance_1.setTransform(-1,-42,0.5,0.5);

	this.instance_2 = new lib.BtnManual();
	this.instance_2.setTransform(-169,-12,0.6249,0.6249);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,197,255,0)").ss(1,1,1).p("AAAsOIAAYd");
	this.shape.setTransform(-171.5,-55.875);

	this.instance_3 = new lib.BtnManual_Hover();
	this.instance_3.setTransform(-178,-14,0.6647,0.6649);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_2,p:{x:-169}},{t:this.instance_1},{t:this.instance,p:{y:22}}]}).to({state:[{t:this.instance_3},{t:this.instance_1},{t:this.instance,p:{y:11}}]},1).to({state:[{t:this.instance_2,p:{x:-165}},{t:this.instance_1},{t:this.instance,p:{y:22}}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-178,-135.2,276,200.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.BtnIngresar_Hover();
	this.instance_1.setTransform(-3,-13,0.521,0.5748);
...
p.nominalBounds = new cjs.Rectangle(-3,-13,241.3,73.6);


(lib.btnDescarga = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.BtnDescargar_IconFlecha();
	this.instance.setTransform(68,4,0.6778,0.6778);

	this.instance_1 = new lib.BtnDescargar_IconCarpeta();
	this.instance_1.setTransform(23,-58,0.6314,0.7336);

	this.instance_2 = new lib.BtnDescargar_1();
	this.instance_2.setTransform(-157,-30,0.673,0.673);

	this.instance_3 = new lib.BtnDescargar_Hover();
	this.instance_3.setTransform(-163,-35,0.7318,0.7318);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance,p:{y:4}}]}).to({state:[{t:this.instance_3},{t:this.instance_1},{t:this.instance,p:{y:-3}}]},1).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance,p:{y:4}}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-163,-58,273.7,104.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-51.75,-55.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-51.7,-55.7,103.5,111.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-63,-63,1.6101,1.6101);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:1.8586,scaleY:1.8586,x:-89,y:-89},0).wait(1).to({scaleX:1.6101,scaleY:1.6101,x:-63,y:-63},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-89,-89,386.6,386.6);


(lib.btnDescarga2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.BtnDescargar_2();
	this.instance.setTransform(-192,94,1.684,1.684);

	this.instance_1 = new lib.BtnDescargarHover_1();
	this.instance_1.setTransform(-252,81,1.9245,1.9245);
...
p.nominalBounds = new cjs.Rectangle(-252,81,816,234.8);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		createjs.Sound.play("sound2", { volume: 0.8}).on("complete", function () {                    
				window.open('Manual de usuario SeguRedes.pdf', '_blank');		 
		                    }, this);
		});
		
		var _this = this;
		
		_this.btnDescargar.on('click', function(){
		createjs.Sound.play("sound2", { volume: 0.8}).on("complete", function () {                    
				_this.parent.letrero.visible=true;
		_this.parent.letrero.gotoAndPlay(1);	 
		                    }, this);
		});
	}
	...
	// Capa_1
	this.btnDescargar = new lib.btnDescarga();
	this.btnDescargar.name = "btnDescargar";
	this.btnDescargar.setTransform(11.8,-86.05);
	new cjs.ButtonHelper(this.btnDescargar, 0, 1, 2);

	this.manual = new lib.btnManual();
	this.manual.name = "manual";
	this.manual.setTransform(24.5,7.9);
	new cjs.ButtonHelper(this.manual, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.manual},{t:this.btnDescargar}]}).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-153.5,-144,276,216.9);
...
if (reversed == null) { reversed = false; }
	...
	this.btnIngresar.setTransform(-2.15,135.15,0.949,0.9479,0,0,0,116.9,23.4);
	new cjs.ButtonHelper(this.btnIngresar, 0, 1, 2);

	this.instance = new lib.titulo();
	this.instance.setTransform(-142,-97.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.btnIngresar}]}).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-273.2,-165.1,546.5,335.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(51.75,55.75);

	this.instance_1 = new lib.Interpolación7("synched",0);
	this.instance_1.setTransform(51.75,50.35);
	this.instance_1._off = true;

	this.instance_2 = new lib.Interpolación8("synched",0);
	this.instance_2.setTransform(51.75,55.75);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,y:50.35},49).wait(51));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},49).to({_off:true,y:55.75},50).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-5.4,103.5,116.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_8
	this.instance = new lib.icon();
	this.instance.setTransform(16.8,-262.2,1,1,0,0,0,51.8,55.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// btnDescarga2
	this.btnDescarga2 = new lib.btnDescarga2();
	this.btnDescarga2.name = "btnDescarga2";
	this.btnDescarga2.setTransform(2.8,116.55,0.2723,0.2723,0,0,0,127.7,127.7);
	new cjs.ButtonHelper(this.btnDescarga2, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.btnDescarga2).wait(1));

	// btnCerrar
	this.btnCerrar = new lib.cerrar();
	this.btnCerrar.name = "btnCerrar";
	this.btnCerrar.setTransform(303.8,-193.2,0.2971,0.2971,0,0,0,150.1,150);
	new cjs.ButtonHelper(this.btnCerrar, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.btnCerrar).wait(1));

	// Forma_Ventana_png
	this.instance_1 = new lib.FormaVentana();
	this.instance_1.setTransform(-287,-351,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-287,-351,634.6,538);


(lib.letrero = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.51)").s().p("EhrOA86MAAAh5zMDWdAAAMAAAB5zg");
...
p.nominalBounds = new cjs.Rectangle(-348.5,-723.6,1372.6,1312.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1886.5,320.95);

	this.letrero = new lib.letrero();
	this.letrero.name = "letrero";
	this.letrero.setTransform(716.4,417.2,1,1,0,0,0,368,230.2);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,197,255,0)").ss(1,1,1).p("EA5gAewIAAFPIhFAAEg5fgj+IKdAA");
	this.shape.setTransform(649.475,450.725);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance}]},39).to({state:[{t:this.shape},{t:this.letrero}]},1).wait(59));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:1073.45,y:342.1},39).to({_off:true},1).wait(59));

	// MergedLayer_2
	this.instance_1 = new lib.manual();
	this.instance_1.setTransform(2069.9,706,0.783,0.783,0,0,0,0.1,0.1);

	this.movieClip_8 = new lib.Interpolación4();
	this.movieClip_8.name = "movieClip_8";
	this.movieClip_8.setTransform(1073.45,342.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_1}]},39).to({state:[{t:this.movieClip_8}]},1).wait(59));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:0.7422,scaleY:0.742,x:1255.85,y:705.95},39).to({_off:true,regX:0,regY:0,scaleX:1,scaleY:1,x:1073.45,y:342.1},1).wait(59));

	// manual
	this.instance_2 = new lib.pescador2();
	this.instance_2.setTransform(-186,475.5,0.5,0.5,0,0,0,210,183.5);
	this.instance_2._off = true;

	this.instance_3 = new lib.manual();
	this.instance_3.setTransform(1255.85,705.95,0.7422,0.742,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},13).to({state:[{t:this.instance_2}]},26).to({state:[{t:this.instance_3}]},1).wait(59));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({_off:false},0).to({x:496.3,y:485.95},26).to({_off:true,regX:0.1,regY:0.1,scaleX:0.7422,scaleY:0.742,x:1255.85,y:705.95},1).wait(59));

	// libro
	this.instance_4 = new lib.libro();
	this.instance_4.setTransform(972.6,804.5,0.1335,0.1335,0,0,0,184.6,0.8);
	this.instance_4.alpha = 0;
	this.instance_4.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	this.instance_4._off = true;

	this.instance_5 = new lib.libro_cte();
	this.instance_5.setTransform(618.55,260.3,1,1,0,0,0,198.7,182.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},40).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(40).to({_off:false},0).wait(1).to({regX:185.9,regY:2.4,scaleX:0.1414,scaleY:0.1414,x:972.75,y:797.8,alpha:0.1428},0).wait(1).to({scaleX:0.1492,scaleY:0.1492,x:972.7,y:790.65,alpha:0.2856},0).wait(1).to({scaleX:0.1571,scaleY:0.1571,x:972.65,y:783.65,alpha:0.4285},0).wait(1).to({scaleX:0.1649,scaleY:0.1649,x:972.6,y:776.65,alpha:0.5713},0).wait(1).to({scaleX:0.1728,scaleY:0.1728,x:972.55,y:769.6,alpha:0.7141},0).wait(1).to({scaleX:0.1806,scaleY:0.1806,x:972.5,y:762.6,alpha:0.8569},0).wait(1).to({scaleX:0.1884,scaleY:0.1884,y:755.55,alpha:0.9998},0).wait(1).to({scaleX:0.1963,scaleY:0.1963,x:972.45,y:748.55},0).wait(1).to({scaleX:0.2041,scaleY:0.2041,x:972.4,y:741.55},0).wait(1).to({scaleX:0.212,scaleY:0.212,x:972.35,y:734.5},0).wait(1).to({scaleX:0.2198,scaleY:0.2198,x:972.3,y:727.55},0).wait(1).to({scaleX:0.2277,scaleY:0.2277,x:972.25,y:720.5},0).wait(1).to({scaleX:0.2355,scaleY:0.2355,y:713.45},0).wait(1).to({scaleX:0.2439,scaleY:0.2457,x:963.7,y:693.25},0).wait(1).to({scaleX:0.2523,scaleY:0.256,x:957.9,y:682.35},0).wait(1).to({scaleX:0.2607,scaleY:0.2662,x:943.85,y:669.25},0).wait(1).to({scaleX:0.2691,scaleY:0.2765,x:927.6,y:658.6},0).wait(1).to({scaleX:0.2775,scaleY:0.2868,x:911.05,y:648.35},0).wait(1).to({scaleX:0.2859,scaleY:0.297,x:894.45,y:638.15},0).wait(1).to({scaleX:0.2943,scaleY:0.3073,x:877.85,y:628.05},0).wait(1).to({scaleX:0.3027,scaleY:0.3175,x:861.2,y:617.9},0).wait(1).to({scaleX:0.3111,scaleY:0.3278,x:844.55,y:608},0).wait(1).to({scaleX:0.3195,scaleY:0.338,x:826.85,y:599.95},0).wait(1).to({scaleX:0.3279,scaleY:0.3483,x:811.85,y:587.65},0).wait(1).to({scaleX:0.3363,scaleY:0.3585,x:802,y:570.95},0).wait(1).to({scaleX:0.3447,scaleY:0.3688,x:798.8,y:560.65,alpha:0.9999},0).wait(1).to({scaleX:0.3531,scaleY:0.379,x:796.05,y:550.2},0).wait(1).to({scaleX:0.3615,scaleY:0.3893,x:793.45,y:539.7},0).wait(1).to({scaleX:0.3699,scaleY:0.3995,x:791.05,y:529.15},0).wait(1).to({scaleX:0.3783,scaleY:0.4098,x:788.85,y:518.55},0).wait(1).to({scaleX:0.3867,scaleY:0.42,x:787,y:507.9},0).wait(1).to({scaleX:0.395,scaleY:0.4303,x:785.55,y:497.2},0).wait(1).to({scaleX:0.4034,scaleY:0.4405,x:784.7,y:486.4},0).wait(1).to({scaleX:0.4118,scaleY:0.4508,x:782.3,y:475.9},0).wait(1).to({scaleX:0.4202,scaleY:0.461,x:779,y:465.55},0).wait(1).to({scaleX:0.4286,scaleY:0.4713,x:775.25,y:455.45},0).wait(1).to({scaleX:0.437,scaleY:0.4815,x:770.95,y:445.5},0).wait(1).to({scaleX:0.4454,scaleY:0.4918,x:766.3,y:435.75},0).wait(1).to({scaleX:0.4746,scaleY:0.5173,x:761.35,y:426.2},0).wait(1).to({scaleX:0.5038,scaleY:0.5428,x:755.9,y:416.85},0).wait(1).to({scaleX:0.5329,scaleY:0.5683,x:750.05,y:407.8},0).wait(1).to({scaleX:0.5621,scaleY:0.5938,x:743.75,y:399.05},0).wait(1).to({scaleX:0.5912,scaleY:0.6193,x:736.9,y:390.75},0).wait(1).to({scaleX:0.6204,scaleY:0.6448,x:729.4,y:383.05},0).wait(1).to({scaleX:0.6496,scaleY:0.6703,x:721,y:376.2},0).wait(1).to({scaleX:0.6787,scaleY:0.6958,x:711.7,y:370.8},0).wait(1).to({scaleX:0.7079,scaleY:0.7213,x:702.55,y:365.25,alpha:1},0).wait(1).to({scaleX:0.737,scaleY:0.7492,x:694.7,y:355.7},0).wait(1).to({scaleX:0.7662,scaleY:0.777,x:687.55,y:345.65},0).wait(1).to({scaleX:0.7954,scaleY:0.8049,x:680.5,y:335.55},0).wait(1).to({scaleX:0.8245,scaleY:0.8327,x:673.6,y:325.3},0).wait(1).to({scaleX:0.8537,scaleY:0.8606,x:666.75,y:315.05},0).wait(1).to({scaleX:0.8828,scaleY:0.8884,x:659.9,y:304.75},0).wait(1).to({scaleX:0.912,scaleY:0.9163,x:653.15,y:294.45},0).wait(1).to({scaleX:0.9412,scaleY:0.9441,x:646.4,y:284.05},0).wait(1).to({scaleX:0.9703,scaleY:0.972,x:639.65,y:273.75},0).wait(1).to({scaleX:0.9995,scaleY:0.9998,x:632.7,y:263.55},0).to({_off:true},1).wait(1));

	// hombre
	this.instance_6 = new lib.pescador2();
	this.instance_6.setTransform(496.35,486.1,0.5,0.5,0,0,0,210,183.5);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(40).to({_off:false},0).wait(59));

	// celular
	this.instance_7 = new lib.MANOMOVIMIENTO();
	this.instance_7.setTransform(-484.75,503);
	this.instance_7._off = true;
	new cjs.ButtonHelper(this.instance_7, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(13).to({_off:false},0).to({x:190.5},26).wait(60));

	// der_fondo
	this.instance_8 = new lib.fondodDer();
	this.instance_8.setTransform(-854.1,-104.1,1,1,0,0,0,1021.5,697);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regX:1331.5,regY:1202.5,x:-544.25,y:402.95},0).wait(1).to({x:-544.4,y:404.45},0).wait(1).to({x:-544.55,y:405.95},0).wait(1).to({x:-544.75,y:407.45},0).wait(1).to({x:-514.75,y:407.25},0).wait(1).to({x:-484.75,y:407.05},0).wait(1).to({x:-454.75,y:406.85},0).wait(1).to({x:-424.75,y:406.65},0).wait(1).to({x:-394.75,y:406.45},0).wait(1).to({x:-364.75,y:406.25},0).wait(1).to({x:-334.75,y:406.05},0).wait(1).to({x:-304.8,y:405.85},0).wait(1).to({x:-274.8,y:405.65},0).wait(1).to({x:-244.8,y:405.45},0).wait(1).to({x:-214.8,y:405.25},0).wait(1).to({x:-184.8,y:405.05},0).wait(1).to({x:-154.8,y:404.85},0).wait(1).to({x:-124.8,y:404.65},0).wait(1).to({x:-94.8,y:404.45},0).wait(1).to({x:-64.85,y:404.25},0).wait(1).to({x:-34.85,y:404.05},0).wait(1).to({x:-4.85,y:403.85},0).wait(1).to({x:25.15,y:403.65},0).wait(1).to({x:55.15,y:403.45},0).wait(1).to({x:85.15,y:403.25},0).wait(1).to({x:115.15,y:403.05},0).wait(1).to({x:145.15,y:402.85},0).wait(1).to({x:175.1,y:402.65},0).wait(1).to({x:205.1,y:402.45},0).wait(1).to({x:235.1,y:402.25},0).wait(1).to({x:265.1,y:402.05},0).wait(1).to({x:295.1,y:401.85},0).wait(1).to({x:325.1,y:401.65},0).wait(1).to({x:355.1,y:401.45},0).wait(1).to({x:385.1,y:401.25},0).wait(1).to({x:415.1,y:401.05},0).wait(1).to({x:445.05,y:400.85},0).wait(1).to({x:475.05,y:400.65},0).wait(1).to({regX:1021.5,regY:697,x:166.75,y:-104.05},0).wait(1).to({regX:1331.5,regY:1202.5,x:476.75,y:401.45},0).wait(59));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-382.2,-152.6,2547.8999999999996,1001.8000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fondoizq.png?1723940877718", id:"fondoizq"},
		{src:"images/index_atlas_1.png?1723940877594", id:"index_atlas_1"},
		{src:"sounds/CLOCKTick_Stopwatch2_ID2138_BSB.mp3?1723940877718", id:"CLOCKTick_Stopwatch2_ID2138_BSB"},
		{src:"sounds/fondo.mp3?1723940877718", id:"fondo"},
		{src:"sounds/sound.mp3?1723940877718", id:"sound"},
		{src:"sounds/notificationsound70621onlineaudioconvertercom.mp3?1723940877718", id:"notificationsound70621onlineaudioconvertercom"},
		{src:"sounds/sound2.mp3?1723940877718", id:"sound2"}
	],
	preloads: []
};
