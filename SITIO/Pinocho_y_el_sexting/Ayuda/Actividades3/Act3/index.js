...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,1263,1082,363],[1359,866,63,63],[1359,931,60,60],[1359,741,123,123],[1084,1263,322,321],[0,741,1357,520],[0,0,1440,739]]}
];
...
(lib.screencapturemasterd2ovn6qahf2n97amplifyapp2024042219_53_49 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido1.setTransform(867.4,139.95,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.instance.setTransform(512,271.5,0.9999,0.9999,0,-90.0009,89.9991,78.5,72);

	this.btnStopSonido1 = new lib.btnStopSonido();
	this.btnStopSonido1.name = "btnStopSonido1";
	this.btnStopSonido1.setTransform(868.75,139.95,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido1, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1},{t:this.instance}]}).wait(1));

	// cerrar
	this.btnCerrar1 = new lib.cerrar();
	this.btnCerrar1.name = "btnCerrar1";
	this.btnCerrar1.setTransform(1191.3,144.9,1,1,0,0,0,30.8,30.8);
	...
	this.instance_1.setTransform(596,193,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// cuadro
	this.instance_2 = new lib.FondoTexto();
	this.instance_2.setTransform(528,134,0.5,0.5355);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(102,0,255,0.408)").ss(1,1,1).p("EAiggD5MA1+AAAQCAAAAACLIAADcQAACLiAAAMg1+AAAQiAAAAAiLIAAjcQAAiLCAAAgA65j5MA19AAAQCAAAAACLIAADcQAACLiAAAMg19AAAQiAAAAAiLIAAjcQAAiLCAAAgEhYdgD5MA1+AAAQCAAAAACLIAADcQAACLiAAAMg1+AAAQiAAAAAiLIAAjcQAAiLCAAAg");
	this.shape.setTransform(589.025,187.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.698)").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.ayuda, new cjs.Rectangle(-105.9,-284.4,1366,776.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.screencapturemasterd2ovn6qahf2n97amplifyapp2024042219_53_49();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1713833960388", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1713833960426", id:"ayuda1"}
	],
	preloads: []
};
