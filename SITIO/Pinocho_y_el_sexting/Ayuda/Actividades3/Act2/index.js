...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,1263,1078,296],[1359,866,63,63],[1359,931,60,60],[1359,741,123,123],[1080,1263,322,321],[0,741,1357,520],[0,0,1440,739]]}
];
...
(lib.screencapture1270018090indexhtml2024042217_18_351 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido1.setTransform(832.15,-11.3,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.instance.setTransform(501,69.65,0.9999,0.9999,0,-90.0026,89.9974,78.5,72);

	this.btnStopSonido1 = new lib.btnStopSonido();
	this.btnStopSonido1.name = "btnStopSonido1";
	this.btnStopSonido1.setTransform(833.5,-11.3,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.btnCerrar1.setTransform(1120.8,-2.45,1,1,0,0,0,30.8,30.8);
	...
	this.instance_1.setTransform(563,35,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// cuadro
	this.instance_2 = new lib.FondoTexto();
	this.instance_2.setTransform(529,-17,0.4468,0.488);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.698)").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	// Capa_3
	this.instance = new lib.screencapture1270018090indexhtml2024042217_18_351();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1715626630209", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1715626630250", id:"ayuda1"}
	],
	preloads: []
};
