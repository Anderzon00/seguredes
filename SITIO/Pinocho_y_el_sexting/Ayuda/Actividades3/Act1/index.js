...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,1263,1095,292],[1097,1263,887,296],[1442,0,355,105],[1442,213,355,104],[1359,1064,356,105],[1442,107,356,104],[1799,0,63,63],[1567,319,60,60],[1442,319,123,123],[1359,741,322,321],[0,741,1357,520],[0,0,1440,739]]}
];
...
(lib.screencapture1270018090indexhtml2024042217_11_05 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(11);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido1.setTransform(595.5,130,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.instance.setTransform(235.35,247.45,0.9999,0.9999,0,-60.003,119.997,78.5,72);

	this.instance_1 = new lib.flecha();
	this.instance_1.setTransform(942.35,235.35,0.9999,0.9999,60.003,0,0,78.5,72);

	this.btnSiguiente1 = new lib.siguiente();
	this.btnSiguiente1.name = "btnSiguiente1";
	this.btnSiguiente1.setTransform(595.25,356.35,1,1,0,0,0,89,26.2);
	...
	this.btnStopSonido1.setTransform(596.85,130,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido1, 0, 1, 2);

	this.btnAnterior2 = new lib.anterior();
	this.btnAnterior2.name = "btnAnterior2";
	this.btnAnterior2.setTransform(633.3,147.2,1,1,0,0,0,88.8,26.2);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1},{t:this.btnSiguiente1},{t:this.instance_1},{t:this.instance,p:{regX:78.5,regY:72,scaleX:0.9999,scaleY:0.9999,skewX:-60.003,skewY:119.997,x:235.35,y:247.45}}]}).to({state:[{t:this.btnStopSonido2},{t:this.instance,p:{regX:65,regY:63.9,scaleX:1,scaleY:1,skewX:-165.0008,skewY:14.9992,x:604.1,y:210.6}},{t:this.btnAnterior2}]},1).wait(1));

	// cerrar
	this.btnCerrar1 = new lib.cerrar();
	this.btnCerrar1.name = "btnCerrar1";
	this.btnCerrar1.setTransform(919.4,134.95,1,1,0,0,0,30.8,30.8);
	...
	this.instance_2.setTransform(322,174,0.5,0.5);

	this.instance_3 = new lib._2_2();
	this.instance_3.setTransform(418,-27,0.5,0.5);
	...
	this.instance_4.setTransform(256,122,0.5,0.5683);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({scaleY:0.4917,x:294,y:-68},0).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(50,50,50,0.698)").s().p("");
	this.shape.setTransform(577.1,103.825);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(255,0,0,0.408)").ss(1,1,1).p("AuDk/IcHAAQBYAAA/A+QA+A/AABYIAADUQAABZg+A/Qg/A+hYAAI8HAAQhYAAg/g+Qg+g/AAhZIAAjUQAAhYA+g/QA/g+BYAAg");
	this.shape_1.setTransform(579.275,36.65);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,153,204,0.698)").s().p("AuDFAQhYAAg/g/Qg+g+AAhZIAAjTQAAhZA+g+QA/g/BYAAIcHAAQBYAAA/A/QA+A+AABZIAADTQAABZg+A+Qg/A/hYAAg");
	this.shape_2.setTransform(579.275,36.65);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(255,0,0,0.408)").ss(1,1,1).p("AuDk/IcHAAQBYAAA/A+QA+A/AABYIAADUQAABZg+A/Qg/A+hYAAI8HAAQhYAAg/g+Qg+g/AAhZIAAjUQAAhYA+g/QA/g+BYAAg");
	this.shape_3.setTransform(579.275,36.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(0,153,204,0.698)").s().p("AuDFAQhYAAg/g/Qg+g+AAhZIAAjTQAAhZA+g+QA/g/BYAAIcHAAQBYAAA/A/QA+A+AABZIAADTQAABZg+A+Qg/A/hYAAg");
	this.shape_4.setTransform(579.275,36.65);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("rgba(255,0,0,0.408)").ss(1,1,1).p("AuDk/IcHAAQBYAAA/A+QA+A/AABYIAADUQAABZg+A/Qg/A+hYAAI8HAAQhYAAg/g+Qg+g/AAhZIAAjUQAAhYA+g/QA/g+BYAAg");
	this.shape_5.setTransform(579.275,36.65);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,153,204,0.698)").s().p("AuDFAQhYAAg/g/Qg+g+AAhZIAAjTQAAhZA+g+QA/g/BYAAIcHAAQBYAAA/A/QA+A+AABZIAADTQAABZg+A+Qg/A/hYAAg");
	this.shape_6.setTransform(579.275,36.65);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("rgba(74,74,74,0.698)").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.screencapture1270018090indexhtml2024042217_11_05();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1722462171834", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1722462171908", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1722462171908", id:"ayuda2"}
	],
	preloads: []
};
