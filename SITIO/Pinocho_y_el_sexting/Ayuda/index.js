...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[1442,522,1267,286],[0,741,1267,363],[1269,810,1183,286],[1442,0,1357,520],[0,0,1440,739]]},
...
(lib.screencapture1270018090indexhtml2024042117_13_59 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8AMAAAh3/MDVbAAAMAAAB3/gAqDw7QkOENABF9QgBF9EOEMQENEOF8AAQF9AAEOkOQENkMAAl9QAAl9kNkNQkOkOl9AAQl8AAkNEOg");
...
if (reversed == null) { reversed = false; }
	...
	this.ayuda.setTransform(107.9,277.05);

	this.timeline.addTween(cjs.Tween.get(this.ayuda).wait(1));

	// Capa_1
	this.instance = new lib.screencapture1270018090indexhtml2024042117_13_59();
...
p.nominalBounds = new cjs.Rectangle(683,383.2,683,384.8);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1722463090709", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1722463090709", id:"index_atlas_P_2"},
		{src:"sounds/ayuda1.mp3?1722463090773", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1722463090773", id:"ayuda2"},
		{src:"sounds/ayuda3.mp3?1722463090773", id:"ayuda3"},
		{src:"sounds/ayuda4.mp3?1722463090773", id:"ayuda4"},
		{src:"sounds/ayuda5.mp3?1722463090773", id:"ayuda5"}
	],
	preloads: []
};
