...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,1064,2377,64],[2106,349,80,80],[0,818,2377,80],[2296,349,80,80],[0,900,2377,80],[2213,266,81,80],[2213,348,81,80],[0,982,2377,80],[2130,266,81,81],[2296,266,80,81],[2776,349,79,79],[2695,349,79,80],[2695,258,114,89],[2833,0,37,39],[2833,82,35,34],[2833,118,35,34],[2833,41,37,39],[2130,0,241,264],[2695,0,136,256],[2379,722,283,297],[1670,0,458,309],[0,687,2376,129],[1293,0,375,495],[915,0,376,497],[1670,311,434,326],[2378,0,315,720],[0,0,529,685],[531,0,382,670],[2872,0,14,28]]}
];
...
(lib.Bombillosdelmedio2 = function() {
	this.initialize(ss["index_atlas_P_2"]);
	this.gotoAndStop(16);
}).prototype = p = new cjs.Sprite();
...
(lib.ojosTiritero = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(14.1339,8.7681);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhuBRIAMAAIAWgBIABAAIgDACQgHAFgGAAIgFABQgIAAgGgHgAiDgtIAHgIIAEgFQAHgLALgDQALgEAKAHQAFADAEAHIAJARIgWAAIgwACIACgFgAA9g1IACgJIADgLQACgGAGgEQAHgEAGAAQAFABAFADQALgBAGADQAKAEAFAJIAFANIg2ABIgTABg");
	this.shape_1.setTransform(14.0375,8.768);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(14.1324,8.7685);
...
p.nominalBounds = new cjs.Rectangle(0,0,28.3,17.6);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_3 copia
	this.instance = new lib.Bombillosdelmedio2();
	this.instance.setTransform(658,-101,0.5,0.5);

	this.instance_1 = new lib.Bombillosdelmedio2();
	this.instance_1.setTransform(573,-101,0.5,0.5);

	this.instance_2 = new lib.Bombillosdelmedio2();
	this.instance_2.setTransform(482,-101,0.5,0.5);

	this.instance_3 = new lib.BombilloLateral2();
	this.instance_3.setTransform(402,-99,0.5,0.5);

	this.instance_4 = new lib.Bombillosdelmedio2();
	this.instance_4.setTransform(440,-101,0.5,0.5);

	this.instance_5 = new lib.Bombillosdelmedio2();
	this.instance_5.setTransform(440,-101,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2,p:{x:482}},{t:this.instance_1,p:{x:573}},{t:this.instance,p:{x:658}}]}).to({state:[{t:this.instance_4,p:{x:440}},{t:this.instance_2,p:{x:529}},{t:this.instance_1,p:{x:615}},{t:this.instance,p:{x:704}}]},15).to({state:[{t:this.instance_5},{t:this.instance_4,p:{x:529}},{t:this.instance_2,p:{x:704}},{t:this.instance_3},{t:this.instance_1,p:{x:573}},{t:this.instance,p:{x:658}}]},15).to({state:[{t:this.instance_1,p:{x:482}},{t:this.instance,p:{x:615}}]},15).wait(15));

	// luces
	this.instance_6 = new lib.bombillodelmedio1();
	this.instance_6.setTransform(704,-101,0.5,0.5);

	this.instance_7 = new lib.bombillodelmedio1();
	this.instance_7.setTransform(658,-101,0.5,0.5);

	this.instance_8 = new lib.bombillodelmedio1();
	this.instance_8.setTransform(615,-101,0.5,0.5);

	this.instance_9 = new lib.bombillodelmedio1();
	this.instance_9.setTransform(573,-101,0.5,0.5);

	this.instance_10 = new lib.bombillodelmedio1();
	this.instance_10.setTransform(529,-101,0.5,0.5);

	this.instance_11 = new lib.bombillodelmedio1();
	this.instance_11.setTransform(482,-101,0.5,0.5);

	this.instance_12 = new lib.Bombillolateral1();
	this.instance_12.setTransform(402,-99,0.5,0.5);

	this.instance_13 = new lib.bombillodelmedio1();
	this.instance_13.setTransform(440,-101,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6}]}).wait(60));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(402,-101,320.5,19.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-28.5,-22.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-28.5,-22.2,57,44.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AjYApQAAgPADgPQAFgUAKgJIAGgFQAFgHADgCQAIgFAHAGIAJALIAHADQAEACAGAHQAFAIACALQAEAPABAPgACGAhIAEgaQAFgXAJgMQAFgHAFgDQAIgEAGACQAIACAGALIAFAJIAHAHQAGAHAFAQIAEAWg");
	this.shape.setTransform(50.2625,86.5136);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AiMBDIgNgCIg7gDIgDgOQgFghAHgdQAFgWAJgIIAGgGQAFgHAEgCQAHgFAIAHIAIAKIAIAEQAEABAFAIQAFAIADAMQAJAkgIAoIgCAGIgDgBgADHBBQgVgEgqACQgIgkAKguQAEgXAJgNQAFgGAGgEQAIgDAGACQAIACAFAKIAFAKIAHAHQAHAHAFARQAKAogKApIgOgDg");
	this.shape_1.setTransform(50.3213,89.1761);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(50.321,90.9186);
...
p.nominalBounds = new cjs.Rectangle(0,0,141.5,148.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AByAAQAFgPAJgEQADgCALgBIAUgBQALgBAHAEQAOAIAGAWIAEATIgLAAIhAAAQgLAAgGAEIgFAEQACgTAFgSgAjDgKIAKgPQAFgHAEgCQAJgEAKAGQAPAIAJARQAEAIADAMIhNAAQADgNAFgKg");
	this.shape.setTransform(55.6125,80.4319);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("ADFBEIhRAAIgCgHQgOguAPguQAFgQAJgEQADgBAKgBIAUgCQALAAAIAEQANAHAGAYQALArgKApIgBAEIgDAAgAiEAuQgRgDgbAAIgaAAQgFgaAEgdQACgRAGgMIAKgPQAGgIAEgCQAIgDAKAFQAQAIAIASQAHAOACAUQADAagEAZIgHgBg");
	this.shape_1.setTransform(55.5721,83.5569);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ACVBSQgCgCgGgLQgKACgJgJQgEgEgEgOQgOgtAPgvQAFgQAJgEQADgBAKgBIAUgCQALAAAIAEQANAHAGAYQALArgKApQgEAOgFAJQgIALgLADIgKABQgJAAgFgDgAinBDQgNgBgGgEQgHgGgFgOQgKghAFgmQACgRAGgMIAKgPQAGgIAEgCQAIgDAKAFQAQAIAIASQAHAOACAUQAEAggJAfQgDAMgFAHQgFAFgEABIgHABg");
	this.shape_2.setTransform(55.5731,85.2819);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},3).to({state:[{t:this.shape_2}]},3).to({state:[]},3).wait(38));
...
p.nominalBounds = new cjs.Rectangle(0,0,120.5,132);
...
if (reversed == null) { reversed = false; }
	...
	// Mensaje - copia.png
	this.instance = new lib.FotoPinocho_1();
	this.instance.setTransform(108,31,0.4155,0.4155);

	this.instance_1 = new lib.FotoAurora_1();
	this.instance_1.setTransform(1,31,0.4155,0.4155);

	this.instance_2 = new lib.Mensajecopia();
	this.instance_2.setTransform(4,32,0.5945,0.8236);
...
p.nominalBounds = new cjs.Rectangle(1,31,263.2,269.5);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(151));

	// burbuja
	this.instance = new lib.burbuja();
	this.instance.setTransform(76,222.95,0.003,0.003,0,0,0,0,297.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:300,scaleX:1,scaleY:1,x:146.5,y:179.5},24).wait(106).to({alpha:0},20).wait(1));

	// cabeza
	this.instance_1 = new lib.cabeza();
	this.instance_1.setTransform(86.2,135,1,1,0,0,0,60.2,132);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:60.3,regY:131.9,rotation:4.4431,x:86.3,y:134.95},24).to({regX:60.2,regY:132,rotation:0,x:86.2,y:135},26).to({regX:60.3,regY:131.9,rotation:4.4431,x:86.3,y:134.95},25).to({regX:60.2,regY:132,rotation:0,x:86.2,y:135},55).wait(21));

	// Silueta.png
	this.instance_2 = new lib.Silueta();
	this.instance_2.setTransform(0,117,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(0,-89.5,410.7,566.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(132.2,132,1,1,0,0,0,63.2,132);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:63.3,regY:132.1,rotation:-11.2311,x:132.35,y:132.1},24).to({regX:63.2,regY:132,rotation:0,x:132.2,y:132},25).to({regX:63.3,regY:132.1,rotation:-11.2311,x:132.35,y:132.1},25).to({regX:63.2,regY:132,rotation:0,x:132.2,y:132},25).wait(26));

	// AntebrazoIzq.png
	this.instance_1 = new lib.Interpolación2("synched",0);
	this.instance_1.setTransform(213.35,237.8,0.9999,0.9999,4.4805,0,0,27.2,-20.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:-20.8,scaleX:0.9998,scaleY:0.9998,rotation:-40.519,x:213.4,y:237.95},24).to({regY:-20.9,scaleX:0.9999,scaleY:0.9999,rotation:4.4805,x:213.35,y:237.8},25).to({regY:-20.8,scaleX:0.9998,scaleY:0.9998,rotation:-40.519,x:213.4,y:237.95},25).to({regY:-20.9,scaleX:0.9999,scaleY:0.9999,rotation:4.4805,x:213.35,y:237.8},25).to({rotation:4.4805},25).wait(1));

	// Silueta_1.png
	this.instance_2 = new lib.Silueta_1();
	this.instance_2.setTransform(0,132,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(0,-12.6,264.5,487.1);
...
if (reversed == null) { reversed = false; }
	...
	// ojosTiritero
	this.instance = new lib.ojosTiritero();
	this.instance.setTransform(-14.3,32.15,1,1,0,0,0,14.1,8.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Capa_1
	this.instance_1 = new lib.Carat();
	this.instance_1.setTransform(-84.65,-86.9,0.4085,0.5,6.1967);
...
p.nominalBounds = new cjs.Rectangle(-101.3,-86.9,202.7,173.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(128.7,138.7,1.1184,1,0,0,0,0.1,61);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.9964,rotation:-5.7309,x:128.8,y:138.8},23).to({scaleX:1.1184,rotation:0,x:128.7,y:138.7},26).to({regX:0.2,regY:61.2,scaleX:0.9911,rotation:-5.9814,x:128.75,y:138.75},25).to({regX:0.1,regY:61,scaleX:1.1184,rotation:0,x:128.7,y:138.7},25).to({startPosition:0},25).wait(1));

	// Siluetat.png
	this.instance_1 = new lib.Siluetat();
	this.instance_1.setTransform(74,134,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(15.3,-9.2,249.7,478.2);
...
if (reversed == null) { reversed = false; }
	...
	this.titiritero.setTransform(582.5,333.5,1,1,0,0,0,132.5,234.5);

	this.timeline.addTween(cjs.Tween.get(this.titiritero).wait(8));

	// policia1
	this.policia1 = new lib.policia1();
	this.policia1.name = "policia1";
	this.policia1.setTransform(740.2,329.2,1,1,0,0,0,132.2,237.2);

	this.timeline.addTween(cjs.Tween.get(this.policia1).wait(8));

	// policia2
	this.policia2 = new lib.policia2();
	this.policia2.name = "policia2";
	this.policia2.setTransform(120.8,327.5,1,1,0,0,0,78.8,238.5);

	this.timeline.addTween(cjs.Tween.get(this.policia2).wait(8));

	// luces
	this.instance_6 = new lib.luces();
	this.instance_6.setTransform(480.8,311.5,1,1,0,0,0,34.8,41.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(8));

	// fondo
	this.instance_7 = new lib.candelabro();
	this.instance_7.setTransform(676.55,65.15);

	this.instance_8 = new lib.VelaLlamaBlanca();
	this.instance_8.setTransform(402,35,0.5,0.5);

	this.instance_9 = new lib.Fondo();
	this.instance_9.setTransform(0,-8,0.5008,0.5053);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7}]}).wait(8));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1690917044981", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1690917044982", id:"index_atlas_P_2"},
		{src:"sounds/Voice0.mp3?1690917045090", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1690917045090", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1690917045090", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1690917045090", id:"Voice3"},
		{src:"sounds/interaccion.mp3?1690917045090", id:"interaccion"},
		{src:"sounds/intro.mp3?1690917045090", id:"intro"},
		{src:"sounds/BGM.mp3?1690917045090", id:"BGM"}
	],
	preloads: []
};
