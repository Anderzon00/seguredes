...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,1516,1267,363],[0,0,1824,992],[0,994,1357,520]]},
		{name:"index_atlas_2", frames: [[1483,1223,466,90],[1275,1500,315,90],[0,1342,457,90],[0,0,1267,286],[805,1312,466,90],[817,1514,315,90],[459,1404,457,90],[1273,1315,466,90],[357,1602,315,90],[0,1434,457,90],[0,288,1183,286],[0,1036,927,242],[606,790,945,244],[1687,323,300,300],[918,1407,355,105],[0,1526,355,104],[1484,1131,552,90],[1643,1407,365,91],[929,1220,552,90],[1275,1407,366,91],[929,1036,553,90],[929,1128,553,90],[1687,625,356,105],[459,1496,356,104],[1484,1036,63,63],[357,1526,60,60],[1048,576,123,123],[1687,0,322,321],[0,576,604,397],[1553,790,434,339],[1269,0,368,243],[606,576,440,137],[1185,288,500,500],[0,1280,803,60]]}
];
...
(lib.FondoOscuropinocho = function() {
	this.initialize(img.FondoOscuropinocho);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2374,1135);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-599,116,0.5,0.5);

	this.instance_1 = new lib.formainferiorder();
	this.instance_1.setTransform(291,87,0.5,0.5);

	this.instance_2 = new lib.formasuperiorder();
	this.instance_2.setTransform(411,-284,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.Símbolo1, new cjs.Rectangle(-599,-284,1194,569.5), null);


(lib.siguientecopia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.Interpolación4copia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.Interpolación2copia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.cerrarcopia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.btnStopSonidocopia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.btn_sonidocopia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.anteriorcopia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	this.movieClip_9.setTransform(613.3,31.25);
	this.movieClip_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.movieClip_9).wait(1).to({_off:false},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-252.7,1208.3,569.5);


(lib.flechacopia2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.Interpolación2copia2();
	...
	this.instance_1 = new lib.Interpolación3copia2("synched",0);
	...
	this.instance_2 = new lib.Interpolación4copia2("synched",0);
...
(lib.ayudacopia = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.btn_sonido6.on('click', function(){
			createjs.Sound.stop();
			
			_this.btn_sonido6.visible=false;
			
			createjs.Sound.play("ayuda6").on("complete", function () {                    
			_this.btn_sonido6.visible=true; 
		                    }, this);; 
		});
		...
		_this.btnSiguiente6.on('click', function(){
		createjs.Sound.stop();
		_this.gotoAndStop(1);
		});
	...
	// btn_sonido5
	this.btn_sonido6 = new lib.btn_sonidocopia2();
	this.btn_sonido6.name = "btn_sonido6";
	this.btn_sonido6.setTransform(859.35,167.9,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido6, 0, 1, 2);

	this.btn_sonido1 = new lib.btn_sonidocopia2();
	this.btn_sonido1.name = "btn_sonido1";
	this.btn_sonido1.setTransform(861.35,167.9,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido1, 0, 1, 2);

	this.btn_sonido2 = new lib.btn_sonidocopia2();
	this.btn_sonido2.name = "btn_sonido2";
	this.btn_sonido2.setTransform(861.35,166.65,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido2, 0, 1, 2);

	this.btn_sonido3 = new lib.btn_sonidocopia2();
	...
	this.btn_sonido4 = new lib.btn_sonidocopia2();
	this.btn_sonido4.name = "btn_sonido4";
	this.btn_sonido4.setTransform(858.65,169,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido4, 0, 1, 2);

	this.btn_sonido5 = new lib.btn_sonidocopia2();
	this.btn_sonido5.name = "btn_sonido5";
	this.btn_sonido5.setTransform(862.3,172.05,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido5, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btn_sonido6}]}).to({state:[{t:this.btn_sonido1}]},1).to({state:[{t:this.btn_sonido2}]},1).to({state:[{t:this.btn_sonido3}]},1).to({state:[{t:this.btn_sonido4}]},1).to({state:[{t:this.btn_sonido5}]},1).wait(1));

	// navegacion
	this.instance = new lib.flechacopia2();
	this.instance.setTransform(740.3,-154.55,1,1,0,0,0,64.9,63.9);

	this.btnSiguiente6 = new lib.siguientecopia2();
	this.btnSiguiente6.name = "btnSiguiente6";
	this.btnSiguiente6.setTransform(965.25,426.1,1,1,0,0,0,89,26.2);
	new cjs.ButtonHelper(this.btnSiguiente6, 0, 1, 2);

	this.btnStopSonido6 = new lib.btnStopSonidocopia2();
	this.btnStopSonido6.name = "btnStopSonido6";
	this.btnStopSonido6.setTransform(861.35,167.9,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido6, 0, 1, 2);

	this.btnAnterior1 = new lib.anteriorcopia2();
	this.btnAnterior1.name = "btnAnterior1";
	this.btnAnterior1.setTransform(743.9,382.1,1,1,0,0,0,88.8,26.2);
	new cjs.ButtonHelper(this.btnAnterior1, 0, 1, 2);

	this.btnSiguiente1 = new lib.siguientecopia2();
	this.btnSiguiente1.name = "btnSiguiente1";
	this.btnSiguiente1.setTransform(965.25,382.1,1,1,0,0,0,89,26.2);
	new cjs.ButtonHelper(this.btnSiguiente1, 0, 1, 2);

	this.btnStopSonido1 = new lib.btnStopSonidocopia2();
	this.btnStopSonido1.name = "btnStopSonido1";
	this.btnStopSonido1.setTransform(861.35,167.9,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido1, 0, 1, 2);

	this.btnAnterior2 = new lib.anteriorcopia2();
	this.btnAnterior2.name = "btnAnterior2";
	this.btnAnterior2.setTransform(755.9,435.5,1,1,0,0,0,88.8,26.2);
	new cjs.ButtonHelper(this.btnAnterior2, 0, 1, 2);

	this.btnSiguiente2 = new lib.siguientecopia2();
	this.btnSiguiente2.name = "btnSiguiente2";
	this.btnSiguiente2.setTransform(965.25,435.5,1,1,0,0,0,89,26.2);
	new cjs.ButtonHelper(this.btnSiguiente2, 0, 1, 2);

	this.btnStopSonido2 = new lib.btnStopSonidocopia2();
	this.btnStopSonido2.name = "btnStopSonido2";
	this.btnStopSonido2.setTransform(861.35,166.65,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido2, 0, 1, 2);

	this.btnAnterior3 = new lib.anteriorcopia2();
	...
	this.btnSiguiente3 = new lib.siguientecopia2();
	...
	this.btnStopSonido3 = new lib.btnStopSonidocopia2();
	...
	this.btnAnterior4 = new lib.anteriorcopia2();
	this.btnAnterior4.name = "btnAnterior4";
	this.btnAnterior4.setTransform(753.2,355.5,1,1,0,0,0,88.8,26.2);
	new cjs.ButtonHelper(this.btnAnterior4, 0, 1, 2);

	this.btnSiguiente4 = new lib.siguientecopia2();
	this.btnSiguiente4.name = "btnSiguiente4";
	this.btnSiguiente4.setTransform(962.55,355.5,1,1,0,0,0,89,26.2);
	new cjs.ButtonHelper(this.btnSiguiente4, 0, 1, 2);

	this.btnStopSonido4 = new lib.btnStopSonidocopia2();
	this.btnStopSonido4.name = "btnStopSonido4";
	this.btnStopSonido4.setTransform(860,169,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido4, 0, 1, 2);

	this.btnAnterior5 = new lib.anteriorcopia2();
	this.btnAnterior5.name = "btnAnterior5";
	this.btnAnterior5.setTransform(756.85,365.3,1,1,0,0,0,88.8,26.2);
	new cjs.ButtonHelper(this.btnAnterior5, 0, 1, 2);

	this.btnStopSonido5 = new lib.btnStopSonidocopia2();
	this.btnStopSonido5.name = "btnStopSonido5";
	this.btnStopSonido5.setTransform(862.3,172.05,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido5, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido6},{t:this.btnSiguiente6},{t:this.instance,p:{x:740.3,skewY:0,y:-154.55,skewX:0,regY:63.9,rotation:0}}]}).to({state:[{t:this.btnStopSonido1},{t:this.btnSiguiente1},{t:this.instance,p:{x:963.3,skewY:0,y:-154.55,skewX:0,regY:63.9,rotation:0}},{t:this.btnAnterior1}]},1).to({state:[{t:this.btnStopSonido2},{t:this.btnSiguiente2},{t:this.instance,p:{x:1011.25,skewY:180,y:-153.9,skewX:0,regY:63.9,rotation:0}},{t:this.btnAnterior2}]},1).to({state:[{t:this.btnStopSonido3},{t:this.btnSiguiente3},{t:this.instance,p:{x:737.95,skewY:0,y:130.65,skewX:0,regY:63.9,rotation:0}},{t:this.btnAnterior3}]},1).to({state:[{t:this.btnStopSonido4},{t:this.btnSiguiente4},{t:this.instance,p:{x:166,skewY:19.7336,y:418,skewX:-160.2664,regY:63.9,rotation:0}},{t:this.btnAnterior4}]},1).to({state:[{t:this.btnStopSonido5},{t:this.instance,p:{x:877.85,skewY:0,y:445.95,skewX:0,regY:63.8,rotation:138.0647}},{t:this.btnAnterior5}]},1).wait(1));

	// cerrar
	this.btnCerrar6 = new lib.cerrarcopia2();
	this.btnCerrar6.name = "btnCerrar6";
	this.btnCerrar6.setTransform(1185.25,172.85,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar6, 0, 1, 2);

	this.btnCerrar1 = new lib.cerrarcopia2();
	this.btnCerrar1.name = "btnCerrar1";
	this.btnCerrar1.setTransform(1185.25,172.85,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar1, 0, 1, 2);

	this.btnCerrar2 = new lib.cerrarcopia2();
	this.btnCerrar2.name = "btnCerrar2";
	this.btnCerrar2.setTransform(1185.25,171.6,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar2, 0, 1, 2);

	this.btnCerrar3 = new lib.cerrarcopia2();
	...
	this.btnCerrar4 = new lib.cerrarcopia2();
	this.btnCerrar4.name = "btnCerrar4";
	this.btnCerrar4.setTransform(1181.4,171.2,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar4, 0, 1, 2);

	this.btnCerrar5 = new lib.cerrarcopia2();
	this.btnCerrar5.name = "btnCerrar5";
	this.btnCerrar5.setTransform(1178.45,182.3,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar5, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnCerrar6}]}).to({state:[{t:this.btnCerrar1}]},1).to({state:[{t:this.btnCerrar2}]},1).to({state:[{t:this.btnCerrar3}]},1).to({state:[{t:this.btnCerrar4}]},1).to({state:[{t:this.btnCerrar5}]},1).wait(1));

	// texto
	this.text = new cjs.Text("Antes de comenzar con la historia de Pinocho y el sexting, te recomendamos revisar la Sección de Contenidos. Aquí aprenderás sobre el sexting y sus riesgos, lo que te ayudará a tomar mejores decisiones a lo largo de la historia.", "25px 'Comic Sans MS'");
	this.text.textAlign = "center";
	this.text.lineHeight = 37;
	this.text.lineWidth = 629;
	this.text.parent = this;
	this.text.setTransform(877.5,210.55);

	this.instance_1 = new lib._1();
	this.instance_1.setTransform(545,207,0.5,0.5);

	this.instance_2 = new lib._2();
	this.instance_2.setTransform(545,221,0.5,0.5);

	this.instance_3 = new lib._3();
	this.instance_3.setTransform(579,206,0.5,0.5);

	this.instance_4 = new lib._4();
	this.instance_4.setTransform(644,211,0.5,0.5);

	this.instance_5 = new lib._5();
	this.instance_5.setTransform(627,217,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).wait(1));

	// cuadro
	this.instance_6 = new lib.FondoTexto();
	this.instance_6.setTransform(521,160,0.5177,0.6006);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({scaleX:0.5,scaleY:0.5237,x:522,y:161},0).wait(1).to({scaleY:0.6276,y:159},0).wait(1).to({scaleY:0.5356,x:524,y:160},0).wait(1).to({scaleY:0.4752,x:522},0).wait(1).to({scaleY:0.4936,y:163},0).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8dMAAAh3/MCEFAAAIgNgMMAgLgApIgDAAQh0AViuAIIA2ABQBkABDGgEQAtABAbAFQAfAGAXAOMAufAAAMAAAB3/gEgA8gzlMAjdAAAIAAmGMgjdAAAgEA7rg8LQgOgCgagHIgUgFICGgDQgdARggAAIgNAAg");
	this.shape.setTransform(575.1,103.225);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8AMAAAh3/MDVbAAAMAAAB3/gEAicgzxMAkYAAAIAAmjMgkYAAAg");
	this.shape_1.setTransform(575.1,106.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8AMAAAh3/MDVbAAAMAAAB3/gEBG5gzuIYcAAIAAmsI4cAAg");
	this.shape_2.setTransform(575.1,106.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8AMAAAh3/MDVbAAAMAAAB3/gAmJyxQkFEGAAFxQAAFyEFEEQEGEGFxAAQFxAAEGkGQEFkEAAlyQAAlxkFkGQkGkFlxAAQlxAAkGEFg");
	this.shape_3.setTransform(575.1,106.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8AMAAAh3/MDVbAAAMAAAB3/gEhmNA0+QhEBBAABeQAABdBEBBQBEBDBgAAIVbAAQBgAABEhDQBEhBAAhdQAAhehEhBQhEhChgAAI1bAAQhgAAhEBCg");
	this.shape_4.setTransform(575.1,106.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8AMAAAh3/MDVbAAAMAAAB3/gEA9IA1IQg+BCAABeQAABdA+BBQA+BCBYAAMAkaAAAQBXAAA9hCQA/hBAAhdQAAheg/hCQg9hBhXAAMgkaAAAQhYAAg+BBg");
	this.shape_5.setTransform(575.1,106.1);
...
p.nominalBounds = new cjs.Rectangle(-107.9,-283.6,1366,820.4);
...
if (reversed == null) { reversed = false; }
	...
	this.botones.setTransform(697.1,365.35,1,1,0,0,0,611.4,60.1);

	this.timeline.addTween(cjs.Tween.get(this.botones).wait(16));

	// ayuda
	this.ayuda = new lib.ayudacopia();
	this.ayuda.name = "ayuda";
	this.ayuda.setTransform(683,381.1,1,1,0,0,0,575.1,103.2);

	this.timeline.addTween(cjs.Tween.get(this.ayuda).to({_off:true},13).wait(3));
	...
	this.bntPlay.setTransform(711.7,332.3,1.262,1.262,0,0,0,1.6,2);
	...
	this.instance_1 = new lib.fondopapel1();
	this.instance_1.setTransform(101,52,0.6535,0.5726);

	this.instance_2 = new lib.fondoMorado();
	this.instance_2.setTransform(101,53,0.5016,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.bntPlay}]},9).to({state:[{t:this.bntPlay}]},3).to({state:[{t:this.bntPlay},{t:this.shape}]},1).to({state:[{t:this.bntPlay},{t:this.instance_1}]},1).to({state:[{t:this.bntPlay},{t:this.instance_2}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.bntPlay).wait(9).to({_off:false},0).to({regY:1.9,scaleX:1.4666,scaleY:1.4665,y:332.2},3).to({regX:0,regY:0,scaleX:1,scaleY:1,x:685,y:345},1).wait(1).to({scaleX:1.0011,x:685.6},0).wait(1).to({scaleX:1,x:685},0).wait(1));
	...
	// botones
	this.instance_3 = new lib.FondoOscuropinocho();
	this.instance_3.setTransform(100,54,0.5021,0.5009);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3}]}).to({state:[{t:this.btnVolver_1},{t:this.btnContenidos_1},{t:this.btnActividades_1}]},13).wait(3));

	// fondo
	this.instance_4 = new lib.titulopinocho();
	this.instance_4.setTransform(182,15,0.5,0.5);

	this.instance_5 = new lib.bannernegro1();
	this.instance_5.setTransform(100,621,0.5025,0.5);

	this.instance_6 = new lib.fondo11();
	this.instance_6.setTransform(-38,-37,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]}).wait(16));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/bannernegro1.png?1724081239783", id:"bannernegro1"},
		{src:"images/fondo11.png?1724081239783", id:"fondo11"},
		{src:"images/fondoMorado.png?1724081239783", id:"fondoMorado"},
		{src:"images/FondoOscuropinocho.png?1724081239783", id:"FondoOscuropinocho"},
		{src:"images/index_atlas_1.png?1724081239670", id:"index_atlas_1"},
		{src:"images/index_atlas_2.png?1724081239671", id:"index_atlas_2"},
		{src:"sounds/ayuda1.mp3?1724081239783", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1724081239783", id:"ayuda2"},
		{src:"sounds/ayuda3.mp3?1724081239783", id:"ayuda3"},
		{src:"sounds/ayuda4.mp3?1724081239783", id:"ayuda4"},
		{src:"sounds/ayuda5.mp3?1724081239783", id:"ayuda5"},
		{src:"sounds/ayuda6.mp3?1724081239783", id:"ayuda6"},
		{src:"sounds/sound2.mp3?1724081239783", id:"sound2"},
		{src:"sounds/SoundPlay.mp3?1724081239783", id:"SoundPlay"},
		{src:"sounds/sound1.mp3?1724081239783", id:"sound1"}
	],
	preloads: []
};
