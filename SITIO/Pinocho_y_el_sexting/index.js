...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1550,1745,466,90],[1515,994,466,90],[1515,1086,466,90],[1211,1637,708,106],[502,1927,707,107],[1108,1335,300,300],[1410,1397,552,90],[1410,1489,552,90],[1211,1884,553,90],[1410,1305,553,90],[0,0,1824,992],[502,1528,604,397],[709,994,434,339],[1145,994,368,243],[1108,1745,440,137],[0,1528,500,500],[1145,1239,803,64],[0,994,707,532]]},
		{name:"index_atlas_2", frames: [[459,0,315,90],[0,0,457,90],[459,92,315,90],[0,92,457,90],[459,184,315,90],[0,184,457,90],[368,276,365,91],[0,276,366,91],[776,0,87,87],[776,89,87,87],[776,178,87,87],[865,0,87,87],[735,276,140,139]]}
];
...
(lib.FondoOscuro = function() {
	this.initialize(img.FondoOscuro);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2377,1137);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("Ehc5AsXMAAAhYtMC5zAAAMAAABYtg");
	this.shape.setTransform(726.65,709.825);
...
p.nominalBounds = new cjs.Rectangle(132.1,426,1189.2,567.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(409,-284,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.Símbolo1, new cjs.Rectangle(-599,-284,1192,569.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.movieClip_9.setTransform(576.3,31.25);
...
p.nominalBounds = new cjs.Rectangle(-22.7,-252.7,1192,569.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-115},23).to({y:-108},24).wait(1));

	// Capa_1
	this.button_popup = new lib.btnAceptar();
	this.button_popup.name = "button_popup";
	this.button_popup.setTransform(0,135);
	new cjs.ButtonHelper(this.button_popup, 0, 1, 2);

	this.instance_1 = new lib.Notificacion();
	this.instance_1.setTransform(-176.75,-161.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.button_popup}]}).wait(48));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-176.7,-161.7,354,323.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		element.innerHTML = '<iframe  src= "./Contenidos/index.html"  id="i_cuento"   style="border:none" allow="autoplay"  >';
		...
		document.getElementById('i_cuento').style.width = 0 +'px';
		document.getElementById('i_cuento').style.height = 0 +'px';
		}
	...
	this.frame_13 = function() {
		...
		function embed() {	
		document.getElementById('i_cuento').src=  "./Cuento/E1AA/index.html";	
	...
	this.mute.name = "mute";
	this.mute.setTransform(680.45,711.6);
	new cjs.ButtonHelper(this.mute, 0, 1, 2, false, new lib.btnSound(), 3);

	this.unmute = new lib.btnMute();
	this.unmute.name = "unmute";
	this.unmute.setTransform(564.9,716.45);
	new cjs.ButtonHelper(this.unmute, 0, 1, 2, false, new lib.btnMute(), 3);

	this.botones = new lib.Símbolo2();
	this.botones.name = "botones";
	this.botones.setTransform(629.1,469.25,1,1,0,0,0,505.4,164);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.botones},{t:this.unmute},{t:this.mute}]}).wait(17));

	// mensaje
	this.popup = new lib.Simbologrupo();
	this.popup.name = "popup";
	this.popup.setTransform(689.95,341.75,1,1,0,0,0,0.2,0);
	...
	this.instance = new lib.Símbolo41("synched",0);
	this.instance.setTransform(697.05,337.05,1.0019,1,0,0,0,726.6,709.8);

	this.instance_1 = new lib.fondopapel1();
	this.instance_1.setTransform(101,53,0.6535,0.5726);

	this.instance_2 = new lib.fondoMorado();
	this.instance_2.setTransform(101,53,0.5016,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.popup}]}).to({state:[{t:this.popup}]},1).to({state:[{t:this.popup}]},10).to({state:[{t:this.bntPlay}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.bntPlay},{t:this.instance_1}]},1).to({state:[{t:this.bntPlay},{t:this.instance_2}]},1).to({state:[]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.popup).wait(1).to({regX:35.8,regY:32.3,scaleX:0.0028,scaleY:0.0031,x:683.1,y:352.4},10).to({_off:true,regX:0,regY:0,scaleX:1.5,scaleY:1.5,x:685,y:345},1).wait(5));
	this.timeline.addTween(cjs.Tween.get(this.bntPlay).wait(11).to({_off:false},1).to({_off:true,regX:726.6,regY:709.8,scaleX:1.0019,scaleY:1,x:697.05,y:337.05,mode:"synched",startPosition:0},1).wait(1).to({_off:false,regX:0,regY:0,scaleX:1.0011,x:685.6,y:346,mode:"independent"},0).wait(1).to({scaleX:1,x:685,y:345},0).to({_off:true},1).wait(1));
	...
	this.btnAyuda.setTransform(1214.1,32.5);
	...
	this.instance_4.setTransform(101,622,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(17));

	// tarjeta
	this.instance_5 = new lib.FondoOscuro();
	this.instance_5.setTransform(101,52,0.5021,0.5009);
	...
	// fondo
	this.instance_6 = new lib.NombreCuento();
	this.instance_6.setTransform(183,17,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6}]}).wait(17));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/bannernegro1.png?1695863571495", id:"bannernegro1"},
		{src:"images/barraseguredes.png?1695863571495", id:"barraseguredes"},
		{src:"images/fondo11.png?1695863571495", id:"fondo11"},
		{src:"images/fondoMorado.png?1695863571495", id:"fondoMorado"},
		{src:"images/FondoOscuro.png?1695863571495", id:"FondoOscuro"},
		{src:"images/index_atlas_1.png?1695863571422", id:"index_atlas_1"},
		{src:"images/index_atlas_2.png?1695863571422", id:"index_atlas_2"},
		{src:"sounds/sound2.mp3?1695863571495", id:"sound2"},
		{src:"sounds/SoundPlay.mp3?1695863571495", id:"SoundPlay"},
		{src:"sounds/sound1.mp3?1695863571495", id:"sound1"}
	],
	preloads: []
};
