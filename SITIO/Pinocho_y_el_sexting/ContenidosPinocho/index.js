...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,981,151,71],[1370,1314,147,95],[691,0,720,768],[298,1441,472,127],[772,1441,472,127],[1246,1443,448,125],[298,1570,448,125],[0,1058,854,125],[856,1058,854,125],[0,1185,760,127],[762,1185,760,127],[1458,906,534,125],[298,1314,534,125],[834,1314,534,125],[1696,1443,139,129],[1712,1033,143,149],[1899,1294,143,149],[691,770,1252,134],[1945,714,103,93],[1945,809,90,88],[1899,1033,133,259],[1413,0,557,712],[0,0,689,979],[0,1314,296,281],[1524,1185,373,256],[1413,714,382,25],[1837,1445,102,102],[691,906,765,150]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(147.95,113.4,0.928,0.928,0,0,0,54.7,49.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:54.8,regY:49.5,scaleX:1.2848,scaleY:1.2848,x:148.05,y:113.5},24).to({regX:54.7,regY:49.4,scaleX:0.928,scaleY:0.928,x:147.95,y:113.4},25).to({regX:54.8,regY:49.5,scaleX:1.2848,scaleY:1.2848,x:148.05,y:113.5},25).to({regX:54.7,regY:49.4,scaleX:0.928,scaleY:0.928,x:147.95,y:113.4},25).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-42.1,-32.3,239.6,164.5);
...
if (reversed == null) { reversed = false; }
	...
	this.interaccion.setTransform(-24.9,171.85,0.5,0.5,0,0,0,12,190);
	new cjs.ButtonHelper(this.interaccion, 0, 1, 2, false, new lib.pantallamov(), 3);

	this.mano = new lib.msj2();
	this.mano.name = "mano";
	this.mano.setTransform(7.2,83,1,1,0,0,0,93.2,64);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		iframeJ.src = './Ayuda/Contenidos/C3/index.html';
	...
	this.btnContenidoExtra.setTransform(238.65,446.45);
	...
	this.btnSiMeOcurre.setTransform(216.15,377.2);
	...
	this.btnComoEvitarlo.setTransform(146.65,305);
	...
	this.btnComoOcurre.setTransform(140.15,233.05);
	...
	this.btnQueEs.setTransform(190.15,166.75);
	new cjs.ButtonHelper(this.btnQueEs, 0, 1, 2, false, new lib.queES(), 3);

	this.instance_1 = new lib.Tituloindicecontenidos();
	this.instance_1.setTransform(95,39,0.5,0.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("A4eBxQqIgvAAhCQAAhBKIgwQKJguOVAAQOWAAKIAuQKJAwAABBQAABCqJAvQqIAvuWAAQuVAAqJgvg");
	this.shape.setTransform(840.5,405.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_1},{t:this.btnQueEs},{t:this.btnComoOcurre},{t:this.btnComoEvitarlo},{t:this.btnSiMeOcurre},{t:this.btnContenidoExtra},{t:this.instance}]}).wait(1));

	// enumeracion contenidos.png
	this.instance_2 = new lib.BarraContenidos();
	this.instance_2.setTransform(137,132,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// DIBUJO
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(102,102,102,0.659)").ss(1,1,1,3,true).p("EAobgANQAKAIAIAGEgosAAOQAGgIAIgG");
	this.shape_1.setTransform(832.225,471.9875);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	// imagen
	this.instance_3 = new lib.imagen();
	this.instance_3.setTransform(735.4,278.9,0.6921,0.6921,0,0,0,-94,154.1);
...
p.nominalBounds = new cjs.Rectangle(662.2,356.9,477.79999999999995,262);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1723345741385", id:"index_atlas_1"},
		{src:"sounds/CLOCKTick_Stopwatch2_ID2138_BSB.mp3?1723345741477", id:"CLOCKTick_Stopwatch2_ID2138_BSB"},
		{src:"sounds/sound.mp3?1723345741477", id:"sound"}
	],
	preloads: []
};
