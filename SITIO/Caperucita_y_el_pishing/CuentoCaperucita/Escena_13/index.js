...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,877,2377,64],[1585,131,80,80],[0,943,2377,64],[1667,131,80,80],[0,1009,2377,64],[1337,131,81,80],[1420,131,81,80],[351,676,2377,65],[1254,131,81,81],[1503,131,80,81],[351,743,2377,65],[1830,131,79,79],[1749,131,79,80],[0,810,2377,65],[1197,200,35,34],[2781,128,79,116],[654,131,138,75],[873,198,66,67],[2161,171,67,72],[2858,32,19,27],[2230,210,46,16],[0,131,349,664],[1970,131,46,133],[2313,131,31,124],[2858,0,19,30],[941,198,58,59],[2858,61,10,7],[1111,200,35,48],[351,131,301,520],[2018,131,72,80],[1001,198,35,79],[873,131,131,65],[1006,131,131,65],[1038,198,71,29],[2244,131,67,77],[2092,171,67,73],[1148,200,47,32],[2378,0,401,674],[1139,131,113,67],[794,131,77,116],[2781,0,75,126],[1911,131,57,108],[654,208,130,12],[2092,131,150,38],[0,0,2376,129]]}
];
...
(lib.AbuelaBocapngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(14);
}).prototype = p = new cjs.Sprite();
...
(lib.AbuelaBrazoIzqpngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(16);
}).prototype = p = new cjs.Sprite();
...
(lib.AbuelaMangaDerpngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(17);
}).prototype = p = new cjs.Sprite();
...
(lib.AbuelaMangaIzqpngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(18);
}).prototype = p = new cjs.Sprite();
...
(lib.AbuelaOjospngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(20);
}).prototype = p = new cjs.Sprite();
...
(lib.AbuelaSiluetapngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(21);
}).prototype = p = new cjs.Sprite();
...
(lib.CaperucitaMangaIzq1 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(25);
}).prototype = p = new cjs.Sprite();
...
(lib.Caperucitasiluetapngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(28);
}).prototype = p = new cjs.Sprite();
...
(lib.CazadorbrazoDerpngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(31);
}).prototype = p = new cjs.Sprite();
...
(lib.CazadorbrazoIzqpngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(32);
}).prototype = p = new cjs.Sprite();
...
(lib.CazadormangaDerpngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(34);
}).prototype = p = new cjs.Sprite();
...
(lib.CazadorSiluetapngcopia = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(37);
}).prototype = p = new cjs.Sprite();
...
(lib.FondoPlantaAguaOnda = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(42);
}).prototype = p = new cjs.Sprite();
...
p.nominalBounds = new cjs.Rectangle(0,0,2690,1493);
...
if (reversed == null) { reversed = false; }
	...
	this.instance = new lib.FondoPlantaAguaOnda();
	this.instance.setTransform(197,95,0.6231,1,0,180,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(29).to({_off:false},0).to({y:104},15).wait(15).to({_off:true},1).wait(15));

	// fondo-hoja1-onda.png
	this.instance_1 = new lib.FondoPlantaAguaOnda();
	this.instance_1.setTransform(197,103,0.6231,1,0,180,0);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({y:101},15).to({y:104},15).wait(15).to({_off:true},1).wait(15));

	// fondo-hoja1-onda.png
	this.instance_2 = new lib.FondoPlantaAguaOnda();
	this.instance_2.setTransform(280,114,0.6,1,180);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:113},14).to({y:111},15).to({y:114},15).wait(15).to({_off:true},1).wait(15));

	// fondo-hoja1-onda.png
	this.instance_3 = new lib.FondoPlantaAguaOnda();
	this.instance_3.setTransform(199,125,0.6077,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:126},14).to({y:128},15).to({y:125},15).wait(15).to({_off:true},1).wait(15));

	// fondo-hoja1-onda.png
	this.instance_4 = new lib.FondoPlantaAguaOnda();
	this.instance_4.setTransform(196,136,0.6385,1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(14).to({_off:false},0).to({y:138},15).to({y:135},15).wait(15).to({_off:true},1).wait(15));

	// fondo-hoja1-onda.png
	this.instance_5 = new lib.FondoPlantaAguaOnda();
	this.instance_5.setTransform(196,138,0.6385,1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(29).to({_off:false},0).to({y:135},15).wait(15).to({_off:true},1).wait(15));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,280,150);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.AbuelaMangaDerpngcopia();
	this.instance.setTransform(115,0,0.5,0.5);

	this.instance_1 = new lib.AbuelaBrazoIzqpngcopia();
	this.instance_1.setTransform(63.05,-6.85,0.5,0.5,14.9985);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mangaizq, new cjs.Rectangle(53.4,-6.8,94.6,54), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-8.75,-12,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-8.7,-12,17.5,24);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.FondoFlor2();
	this.instance.setTransform(-18.75,-31.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-18.7,-31.5,37.5,63);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.fondobasePlanta();
	this.instance.setTransform(-28.25,-16.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-28.2,-16.7,56.5,33.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Fondoflor1();
	this.instance.setTransform(-19.25,-29,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-19.2,-29,38.5,58);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.AbuelaSiluetapngcopia();
...
p.nominalBounds = new cjs.Rectangle(-97.5,-237.5,174.5,332);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.AbuelaBocapngcopia();
...
p.nominalBounds = new cjs.Rectangle(-19.7,-17.2,17.5,17);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.AbuelaOjospngcopia();
	this.instance.setTransform(231,89,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(231,89,23,8);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.FondoplantaAgua();
	this.instance.setTransform(-12,6,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-12,6,75,19);
...
(lib.brazoscaperucita = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.instance = new lib.CaperucitaMangaIzq1();
	this.instance.setTransform(33.75,2.5,0.5,0.5,-4.96);

	this.instance_1 = new lib.CaperucitaMangaIzq1();
	this.instance_1.setTransform(29,1.2,0.5,0.5,0,0,180);

	this.instance_2 = new lib.brazoDer();
	this.instance_2.setTransform(21,17.2,0.5,0.5);

	this.instance_3 = new lib.brazoIzq();
	this.instance_3.setTransform(29,21.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.brazoscaperucita, new cjs.Rectangle(0,0,65.2,83.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CazadormangaDerpngcopia();
	this.instance.setTransform(132,0,0.5,0.5);

	this.instance_1 = new lib.CazadorbrazoDerpngcopia();
	this.instance_1.setTransform(77,27,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.brazoizq, new cjs.Rectangle(77,0,88.5,59.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.AbuelaMangaIzqpngcopia();
	this.instance.setTransform(60,52,0.5,0.5);

	this.instance_1 = new lib.AbuelaBrazoDer_1();
	this.instance_1.setTransform(31.9,22.05,0.5,0.5,6.9747);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.brazoderecho, new cjs.Rectangle(24.9,22.1,68.6,65.9), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CazadormangaIzq();
	this.instance.setTransform(122,87.75,0.5,0.5);

	this.instance_1 = new lib.CazadorbrazoIzqpngcopia();
	this.instance_1.setTransform(64.55,107.35,0.5,0.5,6.211);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.brazoder, new cjs.Rectangle(61.1,87.8,94.4,59.000000000000014), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},5).wait(4));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:200.4},49).to({x:219.4},50).to({x:229.4},50).to({x:219.4},50).wait(1));

	// ondas
	this.instance_1 = new lib.ondas();
	this.instance_1.setTransform(219.45,143.8,1,1,0,0,0,214.5,103.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:202.45},49).to({x:215.45},50).to({x:224.45},50).to({x:232.45},50).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(187,142,111,35);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.instance = new lib.fondobasePlanta();
	this.instance.setTransform(-424,-127,0.5,0.5);

	this.instance_1 = new lib.fondobasePlanta();
	this.instance_1.setTransform(-476,-112,0.5,0.5);

	this.instance_2 = new lib.fondobasePlanta();
	this.instance_2.setTransform(-374,-127,0.5,0.5);

	this.instance_3 = new lib.fondobasePlanta();
	this.instance_3.setTransform(-328,-105,0.5,0.5);

	this.instance_4 = new lib.fondobasePlanta();
	this.instance_4.setTransform(-264,-71,0.5,0.5);

	this.instance_5 = new lib.fondobasePlanta();
	this.instance_5.setTransform(-194,-78,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(60));

	// Fondo-flor1.png
	this.instance_6 = new lib.Interpolación33("synched",0);
	this.instance_6.setTransform(-446.75,-93,1,1,0,0,0,0,29);

	this.instance_7 = new lib.Interpolación34("synched",0);
	this.instance_7.setTransform(-446.8,-93.1,1,1,5.9663,0,0,-0.1,28.9);
	this.instance_7._off = true;

	this.instance_8 = new lib.Interpolación35("synched",0);
	this.instance_8.setTransform(-446.75,-93,1,1,0,0,0,0,29);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6}]}).to({state:[{t:this.instance_7}]},29).to({state:[{t:this.instance_8}]},30).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true,regX:-0.1,regY:28.9,rotation:5.9663,x:-446.8,y:-93.1},29).wait(31));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:false},29).to({_off:true,regX:0,regY:29,rotation:0,x:-446.75,y:-93},30).wait(1));

	// Fondo-flor1.png
	this.instance_9 = new lib.Interpolación36("synched",0);
	this.instance_9.setTransform(-344.75,-108,1,1,0,0,0,0,29);

	this.instance_10 = new lib.Interpolación37("synched",0);
	this.instance_10.setTransform(-344.75,-108.05,1,1,-5.231,0,0,0,28.9);
	this.instance_10._off = true;

	this.instance_11 = new lib.Interpolación38("synched",0);
	this.instance_11.setTransform(-344.75,-108,1,1,0,0,0,0,29);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9}]}).to({state:[{t:this.instance_10}]},29).to({state:[{t:this.instance_11}]},30).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:true,regY:28.9,rotation:-5.231,y:-108.05},29).wait(31));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({_off:false},29).to({_off:true,regY:29,rotation:0,y:-108},30).wait(1));

	// Fondo-flor1.png
	this.instance_12 = new lib.Interpolación39("synched",0);
	this.instance_12.setTransform(-301.75,-93,1,1,0,0,0,0,29);

	this.instance_13 = new lib.Interpolación40("synched",0);
	this.instance_13.setTransform(-301.8,-93.1,1,1,4.9958,0,0,-0.1,28.9);
	this.instance_13._off = true;

	this.instance_14 = new lib.Interpolación41("synched",0);
	this.instance_14.setTransform(-301.75,-93,1,1,0,0,0,0,29);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12}]}).to({state:[{t:this.instance_13}]},29).to({state:[{t:this.instance_14}]},30).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true,regX:-0.1,regY:28.9,rotation:4.9958,x:-301.8,y:-93.1},29).wait(31));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:false},29).to({_off:true,regX:0,regY:29,rotation:0,x:-301.75,y:-93},30).wait(1));

	// Fondo-Flor2.png
	this.instance_15 = new lib.Interpolación42("synched",0);
	this.instance_15.setTransform(-167.25,-55,1,1,0,0,0,0,31.5);

	this.instance_16 = new lib.Interpolación43("synched",0);
	this.instance_16.setTransform(-167.25,-55,1,1,5.1924,0,0,0,31.5);
	this.instance_16._off = true;

	this.instance_17 = new lib.Interpolación44("synched",0);
	this.instance_17.setTransform(-167.25,-55,1,1,0,0,0,0,31.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_15}]}).to({state:[{t:this.instance_16}]},29).to({state:[{t:this.instance_17}]},30).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({_off:true,rotation:5.1924},29).wait(31));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({_off:false},29).to({_off:true,rotation:0},30).wait(1));

	// Fondo-Flor2.png
	this.instance_18 = new lib.Interpolación45("synched",0);
	this.instance_18.setTransform(-397.25,-97,1,1,0,0,0,0,31.5);

	this.instance_19 = new lib.Interpolación46("synched",0);
	this.instance_19.setTransform(-397.4,-97.05,1,1,-8.7398,0,0,-0.1,31.4);
	this.instance_19._off = true;

	this.instance_20 = new lib.Interpolación47("synched",0);
	this.instance_20.setTransform(-397.25,-97,1,1,0,0,0,0,31.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_18}]}).to({state:[{t:this.instance_19}]},29).to({state:[{t:this.instance_20}]},30).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({_off:true,regX:-0.1,regY:31.4,rotation:-8.7398,x:-397.4,y:-97.05},29).wait(31));
	this.timeline.addTween(cjs.Tween.get(this.instance_19).to({_off:false},29).to({_off:true,regX:0,regY:31.5,rotation:0,x:-397.25,y:-97},30).wait(1));

	// Fondo-flor1.png
	this.instance_21 = new lib.Interpolación48("synched",0);
	this.instance_21.setTransform(-235.75,-55,1,1,0,0,0,0,29);

	this.instance_22 = new lib.Interpolación49("synched",0);
	this.instance_22.setTransform(-235.75,-55.05,1,1,5.231,0,0,0,28.9);
	this.instance_22._off = true;

	this.instance_23 = new lib.Interpolación50("synched",0);
	this.instance_23.setTransform(-235.75,-55,1,1,0,0,0,0,29);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_21}]}).to({state:[{t:this.instance_22}]},29).to({state:[{t:this.instance_23}]},30).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({_off:true,regY:28.9,rotation:5.231,y:-55.05},29).wait(31));
	this.timeline.addTween(cjs.Tween.get(this.instance_22).to({_off:false},29).to({_off:true,regY:29,rotation:0,y:-55},30).wait(1));

	// fondo-basePlanta.png
	this.instance_24 = new lib.Interpolación51("synched",0);
	this.instance_24.setTransform(-213.75,-91.45,1,1,0,0,0,0,16.8);

	this.instance_25 = new lib.Interpolación52("synched",0);
	this.instance_25.setTransform(-213.75,-91.45,1,1,0,0,0,0,16.8);
	this.instance_25._off = true;

	this.instance_26 = new lib.Interpolación53("synched",0);
	this.instance_26.setTransform(-213.75,-91.45,1,1,0,0,0,0,16.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_24}]}).to({state:[{t:this.instance_25}]},29).to({state:[{t:this.instance_26}]},30).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_24).to({_off:true},29).wait(31));
	this.timeline.addTween(cjs.Tween.get(this.instance_25).to({_off:false},29).to({_off:true},30).wait(1));

	// Fondo-Flor2.png
	this.instance_27 = new lib.Interpolación54("synched",0);
	this.instance_27.setTransform(-213.25,-101,1,1,0,0,0,0,31.5);

	this.instance_28 = new lib.Interpolación55("synched",0);
	this.instance_28.setTransform(-213.3,-101,1,1,6.6955,0,0,-0.1,31.5);
	this.instance_28._off = true;

	this.instance_29 = new lib.Interpolación56("synched",0);
	this.instance_29.setTransform(-213.25,-101,1,1,0,0,0,0,31.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_27}]}).to({state:[{t:this.instance_28}]},29).to({state:[{t:this.instance_29}]},30).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_27).to({_off:true,regX:-0.1,rotation:6.6955,x:-213.3},29).wait(31));
	this.timeline.addTween(cjs.Tween.get(this.instance_28).to({_off:false},29).to({_off:true,regX:0,rotation:0,x:-213.25},30).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-476,-167.4,338.5,129.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_12
	this.instance = new lib.Cazadorboca();
	this.instance.setTransform(416,-93,0.25,0.25);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},9).wait(5).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},9).wait(20).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},9).wait(4).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},9).wait(31));

	// Cazador-Boca2.png
	this.instance_1 = new lib.CazadorBoca2();
	this.instance_1.setTransform(425,-92,0.25,0.25);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).wait(132));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(156.8,70,0.9999,0.9999,9.6403,0,0,142.7,11.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:142.6,rotation:1.9073},29).to({regX:142.7,rotation:9.6403},20).to({rotation:3.6993,x:156.85},20).to({rotation:9.6403,x:156.8},20).to({scaleX:1,scaleY:1,rotation:-0.3506,x:156.85},20).to({scaleX:0.9999,scaleY:0.9999,rotation:9.6403,x:156.8},30).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(62.8,37.3,101.2,69.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-283,-212.75);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50));

	// Abuela-Nariz.png
	this.instance_1 = new lib.AbuelaNariz();
	this.instance_1.setTransform(-39,-115,0.25,0.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50));

	// Abuela-Boca.png
	this.instance_2 = new lib.Interpolación6("synched",0);
	this.instance_2.setTransform(-22,-95.55);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(50));

	// brazo mov
	this.instance_3 = new lib.brazomov();
	this.instance_3.setTransform(-59.55,-43.75,1,1,4.4817,0,0,113.2,92.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(50));

	// Caperucita-ojos.png
	this.instance_4 = new lib.Interpolación57("synched",0);
	this.instance_4.setTransform(-106.35,-77);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:-107.35,y:-76.5},24).to({x:-106.35,y:-77},25).wait(1));

	// Caperucita-Nariz.png
	this.instance_5 = new lib.CaperucitaNariz();
	this.instance_5.setTransform(-113,-77,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(50));

	// Caperucita-Boca.png
	this.instance_6 = new lib.CaperucitaBoca();
	this.instance_6.setTransform(-123,-79,0.5,0.5);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-126.2072,-6.2661);

	// Caperucita-MangaIzq.png
	this.instance_7 = new lib.brazoscaperucita();
	this.instance_7.setTransform(-124.9,-51.2,1,1,0,0,0,32.6,0);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:32.5,rotation:5.4927,x:-125},24).to({regX:32.6,rotation:0,x:-124.9},25).wait(1));

	// Caperucita-silueta.png
	this.instance_8 = new lib.Caperucitasiluetapngcopia();
	this.instance_8.setTransform(-190,-115,0.5,0.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAADQQgNgBgLgDQgagGgXgQQgbgTgQgeQgIgPgFgQIgCgJQgHgUgBgUQgJgTgEgUIAAgBIgDgHQgQgfACgmQABgmATggQAbgwA1gSQA1gSAyAUQAhANAZAdQASAVAJAYQAPAVAHAZIACAGIACAJIACAEIACAEIADAGQAKAWACAXQAFAQABAQQABAagGAXQgFAZgPAWQgTAegdASIgPAHQgMAHgOADQgOAEgOABIgOAAIgOAAg");
	this.shape.setTransform(-118.7416,-28.8763);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_8}]}).wait(50));

	// Abuela-Silueta.png
	this.instance_9 = new lib.Interpolación7("synched",0);
	this.instance_9.setTransform(36.6,66);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(50));

	// brazo2
	this.instance_10 = new lib.brazoderecho();
	this.instance_10.setTransform(2.05,-71.15,1,1,-1.8346,0,0,120.5,63.7);
...
p.nominalBounds = new cjs.Rectangle(-190,-171.5,303.6,332);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		console.log ("VIENE DE" + paramString2);
		...
		*/
		window.open('../'+paramString2, '_self');
		});
		...
		*/
		...
		Carga la URL en una ventana nueva del navegador.
		*/
		window.open('../Escena_14/index.html#'+paramString2, '_self');
		});
	}
	this.frame_1 = function() {
	...
	this.frame_10 = function() {
		...
		_this.btnInteraccion.on('click', function () {
			...
			_this.abuela.gotoAndPlay(1);
			
			 
				_this.playSound("Voice8", "voice", true, { volume: 0.1  });
	...
	this.btnInteraccion.setTransform(991.1,425.15,1,1,0,0,0,-21.1,7.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnInteraccion,p:{x:991.1,y:425.15}}]},10).to({state:[{t:this.btnInteraccion,p:{x:995.65,y:429.05}},{t:this.nextEscenaFinal}]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},2).to({state:[{t:this.instance_1}]},3).to({state:[{t:this.instance_2}]},2).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3}]},3).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).wait(4));
	...
	this.instance_6.setTransform(593.8,472.15,1.0135,1,0,0,0,592.9,151.2);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({regX:594,regY:219.8,scaleX:1.0168,x:594.95,y:540.75,alpha:0.5},0).wait(1).to({scaleX:1.0201,alpha:1},0).wait(10));

	// Capa_3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(490.3665,422.196);

	// cosas
	this.instance_7 = new lib.hojasyondas();
	this.instance_7.setTransform(26.75,514,0.9,0.9,0,0,0,218.9,143.7);

	this.instance_8 = new lib.hojasyondas();
	this.instance_8.setTransform(39.25,467.5,0.9,0.9,0,0,0,218.9,143.7);

	this.instance_9 = new lib.hojasyondas();
	this.instance_9.setTransform(147.05,482.25,0.9,0.9,0,0,0,218.9,143.7);

	this.instance_10 = new lib.hojasyondas();
	this.instance_10.setTransform(202.65,510,1,1,0,0,0,219,143.8);

	this.instance_11 = new lib.humo();
	this.instance_11.setTransform(132.2,178,0.8105,0.8705,0,0,0,14.3,27);

	this.instance_12 = new lib.humo();
	this.instance_12.setTransform(192.2,140,1,1,0,0,0,14.2,27);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7}]}).wait(12));

	// boca casador
	this.instance_13 = new lib.boca();
	this.instance_13.setTransform(989.4,290.9,0.5,0.5,0,0,0,2.1,20.1);

	this.instance_14 = new lib.boca2();
	this.instance_14.setTransform(989.35,291,0.4999,0.4938,0,0,0,-159.8,50.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13}]}).to({state:[{t:this.instance_14}]},3).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_13}]},4).to({state:[]},1).wait(2));

	// personajes
	this.instance_15 = new lib.flores();
	this.instance_15.setTransform(418.95,501.95,1,1,0,0,0,-215.8,-2.5);
	...
	this.cazador.setTransform(691.3,611.95,1,1,0,0,0,127.5,239.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AgYAQIgDglIAFgEIAEAEIABAfIAtALQgNAFgPAAQgNgBgLgJg");
	this.shape_2.setTransform(766.025,199.725);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.cazador},{t:this.abuela},{t:this.instance_15}]}).wait(12));

	// fondo
	this.instance_16 = new lib.Fondo();
	this.instance_16.setTransform(-158,-105,0.505,0.5067);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(12));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(438,219.5,762.9000000000001,432);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/Fondo.png?1690130638423", id:"Fondo"},
		{src:"images/index_atlas_P_1.png?1690130638236", id:"index_atlas_P_1"},
		{src:"sounds/Voice0.mp3?1690130638423", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1690130638423", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1690130638423", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1690130638423", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1690130638423", id:"Voice4"},
		{src:"sounds/Voice5.mp3?1690130638423", id:"Voice5"},
		{src:"sounds/Voice6.mp3?1690130638423", id:"Voice6"},
		{src:"sounds/Voice7.mp3?1690130638423", id:"Voice7"},
		{src:"sounds/Voice8.mp3?1690130638423", id:"Voice8"},
		{src:"sounds/BGM.mp3?1690130638423", id:"BGM"},
		{src:"sounds/intro.mp3?1690130638423", id:"intro"}
	],
	preloads: []
};
