...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[1427,0,903,847],[0,0,1425,797]]},
		{name:"index_atlas_P_2", frames: [[1238,0,386,715],[0,801,2376,129],[2378,242,340,573],[1626,587,416,204],[1626,242,514,343],[2379,817,250,250],[1626,0,1009,240],[0,0,1236,420],[0,422,1087,377],[0,998,2377,63],[0,932,2377,64]]},
		{name:"index_atlas_P_3", frames: [[98,513,80,80],[337,518,80,80],[930,466,81,80],[769,470,81,80],[686,441,81,81],[255,505,80,81],[500,518,79,79],[419,518,79,80],[852,470,68,80],[0,511,96,67],[585,441,99,83],[378,442,97,74],[0,0,502,109],[504,0,502,108],[504,110,502,108],[777,552,44,11],[686,524,45,93],[180,513,52,95],[131,355,38,18],[475,111,23,19],[930,331,74,133],[629,526,40,62],[581,526,46,76],[922,548,55,42],[0,355,129,154],[733,552,42,41],[255,396,121,107],[780,331,148,137],[195,111,207,172],[1008,0,13,17],[131,375,35,15],[0,111,193,242],[404,111,69,105],[477,442,97,74],[131,396,122,115],[979,548,43,42],[404,220,194,109],[585,331,193,108],[195,285,193,109],[600,220,194,109],[796,220,194,109],[390,331,193,109]]}
];
...
(lib.CaperucitaCejaDer = function() {
	this.initialize(ss["index_atlas_P_3"]);
	this.gotoAndStop(18);
}).prototype = p = new cjs.Sprite();
...
(lib.CaperucitaCejaIzq = function() {
	this.initialize(ss["index_atlas_P_3"]);
	this.gotoAndStop(19);
}).prototype = p = new cjs.Sprite();
...
(lib.CaperucitaNarizojos = function() {
	this.initialize(ss["index_atlas_P_3"]);
	this.gotoAndStop(23);
}).prototype = p = new cjs.Sprite();
...
p.nominalBounds = new cjs.Rectangle(0,0,2428,1571);
...
(lib.NubepequeñaRecuerdo = function() {
	this.initialize(ss["index_atlas_P_3"]);
	this.gotoAndStop(35);
}).prototype = p = new cjs.Sprite();
...
(lib.PerfilDesconocido = function() {
	this.initialize(ss["index_atlas_P_2"]);
	this.gotoAndStop(5);
}).prototype = p = new cjs.Sprite();
...
(lib.Preguntainteraccion1_2 = function() {
	this.initialize(ss["index_atlas_P_2"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamabrazoIzq_1();
	this.instance.setTransform(69.85,18.7,0.5,0.5,8.2416);

	this.instance_1 = new lib.mamacesta();
...
}).prototype = getMCSymbolPrototype(lib.Símbolo1, new cjs.Rectangle(0,0,143.1,97.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.PerfilDesconocido();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Notificacion();
	this.instance.setTransform(-30.5,-28.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-30.5,-28.7,61,57.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CaperucitaNarizojos();
	this.instance.setTransform(-13.75,-10.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-13.7,-10.5,27.5,21);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CaperucitaCejaIzq();
	this.instance.setTransform(-5.75,-4.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-5.7,-4.7,11.5,9.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CaperucitaCejaDer();
	this.instance.setTransform(-9.5,-4.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-9.5,-4.5,19,9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-11,-2.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-11,-2.7,22,5.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Caperucitacelular();
	this.instance.setTransform(-18.5,-33.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-18.5,-33.2,37,66.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.CaperucitaBrazoDer_1();
	this.instance.setTransform(-11.25,-23.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-11.2,-23.2,22.5,46.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-13,-23.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-13,-23.7,26,47.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamaboca();
...
p.nominalBounds = new cjs.Rectangle(-10.5,-10.2,21,20.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamaojos();
	this.instance.setTransform(18.75,-4.25,0.5,0.5,0,0,180);

	this.instance_1 = new lib.mamaojos();
	this.instance_1.setTransform(-18.75,-3.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-18.7,-4.2,37.5,8.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamabrazoDer();
	this.instance.setTransform(-30.25,-26.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-30.2,-26.7,60.5,53.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-32.25,-38.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-32.2,-38.5,64.5,77);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_2 = new lib.ventanapregunta();
	this.instance_2.setTransform(-356.25,-184.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-286.7,-90,618,210);
...
p.nominalBounds = new cjs.Rectangle(0,-0.2,99.2,83);
...
if (reversed == null) { reversed = false; }
	...
	// Notificacion.png
	this.instance = new lib.Interpolación36("synched",0);
	this.instance.setTransform(250.9,38.65,1,1,0,0,0,-3.6,-22.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:23.4704},24).to({rotation:0},25).wait(1));

	// PerfilDesconocido.png
	this.instance_1 = new lib.Interpolación37("synched",0);
	this.instance_1.setTransform(62.5,62.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:54.2},24).to({y:62.5},25).wait(1));

	// Mensaje.png
	this.instance_2 = new lib.Mensaje();
	this.instance_2.setTransform(46,63,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(0,-8.3,285.7,173.3);


(lib.mamamc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// mama-peloArriba.png
	this.instance = new lib.mamapeloArriba();
	this.instance.setTransform(337,169,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(62));

	// mama-ojos.png
	this.instance_1 = new lib.Interpolación10("synched",0);
	this.instance_1.setTransform(364.75,219.25);

	this.instance_2 = new lib.Interpolación11("synched",0);
	this.instance_2.setTransform(364.75,216.65);
	this.instance_2._off = true;

	this.instance_3 = new lib.Interpolación12("synched",0);
	this.instance_3.setTransform(364.75,219.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},30).to({state:[{t:this.instance_3}]},31).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true,y:216.65},30).wait(32));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:false},30).to({_off:true,y:219.25},31).wait(1));

	// mama-nariz.png
	this.instance_4 = new lib.mamanariz();
	this.instance_4.setTransform(362,226,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(62));

	// mama-brazoIzq_1.png
	this.instance_5 = new lib.Símbolo1();
	this.instance_5.setTransform(405.3,259.6,1,1,0,0,0,132.3,38.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({rotation:11.2345,x:405.35,y:259.65},30).to({rotation:0,x:405.3,y:259.6},31).wait(1));

	// mama-boca.png
	this.instance_6 = new lib.Interpolación13("synched",0);
	this.instance_6.setTransform(372.5,238.25);

	this.instance_7 = new lib.Interpolación14("synched",0);
	this.instance_7.setTransform(372.5,235.65);
	this.instance_7._off = true;

	this.instance_8 = new lib.Interpolación15("synched",0);
	this.instance_8.setTransform(372.5,238.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6}]}).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_8}]},31).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true,y:235.65},30).wait(32));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:false},30).to({_off:true,y:238.25},31).wait(1));

	// mama-silueta.png
	this.instance_9 = new lib.mamasilueta();
	this.instance_9.setTransform(326,200,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(62));

	// mama-brazoDer.png
	this.instance_10 = new lib.Interpolación9("synched",0);
	this.instance_10.setTransform(394.45,252.95,1,1,0,0,0,30.2,-26.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({regY:-26.7,rotation:12.2489,y:253.05},30).to({regY:-26.8,rotation:0,y:252.95},31).wait(1));

	// mama-peloAtras.png
	this.instance_11 = new lib.mamapeloAtras();
	this.instance_11.setTransform(356,233,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(62));

	// Capa_2
	this.instance_12 = new lib.fondo1();
	this.instance_12.setTransform(98,123,0.505,0.5013);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(62));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(98,123,456,424.6);


(lib.imagennube = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-568.2731,-107.8511);

	// Capa_2
	this.instance = new lib.mamamc();
	this.instance.setTransform(-836,-172.85,1.5942,1.3738,0,0,0,408.7,235.3);
...
}).prototype = getMCSymbolPrototype(lib.imagennube, new cjs.Rectangle(-1273.3,-305.6,668.9,395.6), null);
...
p.nominalBounds = new cjs.Rectangle(-27,-19.1,52.6,41.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance_2 = new lib.Preguntainteraccion1_2();
	this.instance_2.setTransform(-265,-60,0.5,0.5);

	this.instance_3 = new lib.Interpolación3("synched",0);
	this.instance_3.setTransform(-41.6,26.45,0.9893,0.9966,0,0,0,-6.7,5);

	this.instance_4 = new lib.Interpolación10_1("synched",0);
	this.instance_4.setTransform(1,1.2,0.9893,0.9966,0,0,0,1,1.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-156.25,27,1,1,-14.9992,0,0,-7.5,36.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-7.4,regY:36.5,rotation:0,x:-156.15},44).to({regX:-7.5,regY:36.4,rotation:-14.9983,x:-156.25},45).wait(1));

	// Capa_3
	this.instance_1 = new lib.Interpolación27("synched",0);
	this.instance_1.setTransform(-311.65,84.15,1,1,-14.9992,0,0,-7.9,38.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:-7.8,rotation:0,x:-311.55,y:84.1},44).to({regX:-7.9,rotation:-14.9983,x:-311.65,y:84.15},45).wait(1));

	// Capa_1
	this.instance_2 = new lib.Interpolación28("synched",0);
	this.instance_2.setTransform(-233.65,58.65,1,1,0.9941,0,0,-7.9,40.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:-7.8,regY:40.1,rotation:-11.9824,x:-233.6,y:58.6},44).to({regX:-7.9,regY:40.2,rotation:0.9941,x:-233.65,y:58.65},45).wait(1));

	// Capa_2
	this.instance_3 = new lib.baseFlor();
	this.instance_3.setTransform(-184,0,0.5,0.5);

	this.instance_4 = new lib.baseFlor();
	this.instance_4.setTransform(-338,56,0.5,0.5);

	this.instance_5 = new lib.baseFlor();
	this.instance_5.setTransform(-259,32,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]}).wait(90));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-355.1,-55.6,238.90000000000003,146);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhuABIAAgBIACABIgBAEIgBgEgABtgEIACAAIgBAEIgBgEg");
	this.shape.setTransform(93.075,72.9875);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FACCA2").s().p("");
	this.shape_1.setTransform(91.3167,66.875);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1},{t:this.shape}]},28).wait(23));

	// Caperucita-Nariz-ojos.png
	this.instance = new lib.Interpolación35("synched",0);
	this.instance.setTransform(93.75,72.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:73.9},25).to({y:73.75},3).to({y:72.5},22).wait(1));

	// Caperucita-MangaIzq.png
	this.instance_1 = new lib.CaperucitaMangaIzq();
	this.instance_1.setTransform(116,124,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(51));

	// Caperucita-MangaDer.png
	this.instance_2 = new lib.CaperucitaMangaDer();
	this.instance_2.setTransform(68,124,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(51));

	// Caperucita-CejaIzq.png
	this.instance_3 = new lib.Interpolación34("synched",0);
	this.instance_3.setTransform(80.75,62.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:80.4,y:63.45},25).to({x:80.75,y:62.75},25).wait(1));

	// Caperucita-CejaDer.png
	this.instance_4 = new lib.Interpolación33("synched",0);
	this.instance_4.setTransform(111.5,59.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({y:60.55},25).to({y:59.5},25).wait(1));

	// Caperucita-BrazoIzq.png
	this.instance_5 = new lib.Interpolación29("synched",0);
	this.instance_5.setTransform(115,161.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:156.85},25).to({y:161.75},25).wait(1));

	// Caperucita-BrazoDer_1.png
	this.instance_6 = new lib.Interpolación30("synched",0);
	this.instance_6.setTransform(89.25,159.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({y:154.2},25).to({y:159.25},25).wait(1));

	// Caperucita-celular.png
	this.instance_7 = new lib.Interpolación31("synched",0);
	this.instance_7.setTransform(101.5,146.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({y:140.85},25).to({y:146.25},25).wait(1));

	// Caperucita-Boca.png
	this.instance_8 = new lib.Interpolación32("synched",0);
	this.instance_8.setTransform(91,92.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:92.75,y:93.1},25).to({x:91,y:92.75},25).wait(1));

	// Caperucita-Silueta.png
	this.instance_9 = new lib.CaperucitaSilueta();
	this.instance_9.setTransform(0,0,0.5,0.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAAASIgDgBIgEgDIAAgBQAFAAACgBQAAgBAAAAQAAgBAAAAQAAgBAAAAQAAgBAAAAQABgEgBgGQAAAAAAgBQAAAAAAgBQAAAAAAgBQAAAAAAAAIgFgBIgBgGIgBgCIABgBQACgCADAAQACAAACADQACABABAFQACAIgBAHIgBAGIgEAEIgCABIAAAAg");
	this.shape_2.setTransform(84.8531,71.4313);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9}]}).to({state:[{t:this.shape_2},{t:this.instance_9}]},28).to({state:[{t:this.instance_9}]},22).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,193,357.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.imagennube();
	this.instance.setTransform(121.05,-17.7,0.6334,0.7126,0,0,0,-604.2,-107.7);

	this.instance_1 = new lib.NubepequeñaRecuerdo();
	this.instance_1.setTransform(127,158,0.6904,0.6904);

	this.instance_2 = new lib.NubepequeñaRecuerdo();
	this.instance_2.setTransform(90,135,0.8544,0.8544);

	this.instance_3 = new lib.nubeRecuerdo();
	this.instance_3.setTransform(-315,-168,0.8474,0.825);

	this.instance_4 = new lib.NubepequeñaRecuerdo();
	this.instance_4.setTransform(49,92,1.1604,1.1604);
...
p.nominalBounds = new cjs.Rectangle(-339.5,-174,929.9,415.7);
...
if (reversed == null) { reversed = false; }
	...
	// MergedLayer_1
	this.instance = new lib.Interpolación38("synched",0);
	this.instance.setTransform(-344.35,47.25,0.0019,0.0028,0,0,0,157.3,214.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:156.7,regY:186.9,scaleX:0.6879,scaleY:0.7691,x:-344.45,y:48.8},26).to({startPosition:0},1).to({startPosition:0},203).to({alpha:0},16).wait(1));

	// mensaje
	this.instance_1 = new lib.mensaje();
	this.instance_1.setTransform(-73.5,-33.5,1,1,0,0,0,142.5,82.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(247));

	// caperucita
	this.instance_2 = new lib.caperucita();
	this.instance_2.setTransform(-264.5,97.8,1,1,0,0,0,96.5,178.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(247));

	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(102,102,102,0.278)").ss(1,1,1).p("EhgUgnXMDApAAAMAAABOvMjApAAAg");
	this.shape.setTransform(-344.45,55.025);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(26).to({_off:false},0).wait(221));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-961.9,-234.3,1234.9,542.3);
...
if (reversed == null) { reversed = false; }
	...
	this.actionFrames = [0,1,2,3,4,5,6,26,27,28];
	// timeline functions:
	this.frame_0 = function() {
	...
	this.frame_4 = function() {
		...
		_this.btnInteraccion.on('click', function(){	
			...
			_this.playSound("Voice4", "voice", true, { volume: 0.1  });
		 _this.caperucita.gotoAndPlay(1); 
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(1).call(this.frame_2).wait(1).call(this.frame_3).wait(1).call(this.frame_4).wait(1).call(this.frame_5).wait(1).call(this.frame_6).wait(20).call(this.frame_26).wait(1).call(this.frame_27).wait(1).call(this.frame_28).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.adelanteEscena,p:{y:607.1}},{t:this.atrasEscena}]}).to({state:[{t:this.adelanteEscena,p:{y:607.1}},{t:this.atrasEscena}]},1).to({state:[{t:this.adelanteEscena,p:{y:606.35}},{t:this.atrasEscena}]},4).wait(24));
	...
	this.instance_1 = new lib.retroalimentacionNO();
	this.instance_1.setTransform(294,187,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.prev,p:{x:97.3}},{t:this.next,p:{x:143.1}},{t:this.pressToStart}]}).to({state:[{t:this.playaudio,p:{x:38.65}},{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.pause,p:{x:31.65}},{t:this.prev,p:{x:97.2}},{t:this.next,p:{x:143}}]},1).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}},{t:this.nextescene}]},4).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}}]},1).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}},{t:this.btnSi},{t:this.btnNo}]},20).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}}]},1).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}},{t:this.instance_1}]},1).wait(1));

	// Capa_1
	this.btnInteraccion = new lib.btnInteractivo();
	this.btnInteraccion.name = "btnInteraccion";
	this.btnInteraccion.setTransform(673.55,436.05);
	new cjs.ButtonHelper(this.btnInteraccion, 0, 1, 2, false, new lib.btnInteractivo(), 3);

	this.instance_2 = new lib.Interpolación11_1("synched",0);
	this.instance_2.setTransform(582.2,280.05,0.0014,1,0,0,180,0,0.4);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(552.5,291);

	this.instance_4 = new lib.Interpolación10_1("synched",0);
	this.instance_4.setTransform(582.2,280.2,1.0215,0.9951,0,0,0,0.2,0.2);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnInteraccion}]},4).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_4,p:{regX:0.2,regY:0.2,scaleX:1.0215,scaleY:0.9951,x:582.2,y:280.2}},{t:this.instance_3},{t:this.escenaSi}]},1).to({state:[{t:this.instance_4,p:{regX:0,regY:0,scaleX:1.0214,scaleY:0.9954,x:582,y:280}},{t:this.escenaNo}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).wait(1).to({regY:14.7,scaleX:0.0503,scaleY:0.9999,skewY:0,y:294.35},0).wait(1).to({scaleX:0.102,scaleY:0.9998},0).wait(1).to({scaleX:0.1537,scaleY:0.9997},0).wait(1).to({scaleX:0.2054,scaleY:0.9996},0).wait(1).to({scaleX:0.2571,scaleY:0.9995},0).wait(1).to({scaleX:0.3088,scaleY:0.9994},0).wait(1).to({scaleX:0.3604,scaleY:0.9993},0).wait(1).to({scaleX:0.4121,scaleY:0.9992},0).wait(1).to({scaleX:0.4638,scaleY:0.9991},0).wait(1).to({scaleX:0.5155,scaleY:0.999},0).wait(1).to({scaleX:0.5672,scaleY:0.9989},0).wait(1).to({scaleX:0.6189,scaleY:0.9988},0).wait(1).to({scaleX:0.6706},0).wait(1).to({scaleX:0.7223,scaleY:0.9987},0).wait(1).to({scaleX:0.774,scaleY:0.9986},0).wait(1).to({scaleX:0.8257,scaleY:0.9985},0).wait(1).to({scaleX:0.8774,scaleY:0.9984},0).wait(1).to({scaleX:0.9291,scaleY:0.9983,y:294.3},0).wait(1).to({scaleX:0.9808,scaleY:0.9982},0).wait(1).to({scaleX:1.0325,scaleY:0.9981},0).to({_off:true},1).wait(2));

	// texto 1
	this.instance_5 = new lib.texto5();
	this.instance_5.setTransform(-1,510,0.5,0.5);
	...
	this.instance_6.setTransform(-1,537,0.5,0.5);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(3).to({_off:false},0).wait(26));

	// lago fondo blanco
	this.instance_7 = new lib.Símbolo9();
	this.instance_7.setTransform(594,472.2,1,1,0,0,0,594,151.2);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({regY:219.8,y:540.8,alpha:0.5},0).wait(1).to({alpha:1},0).wait(27));

	// Capa_3
	this.instance_8 = new lib.flores();
	this.instance_8.setTransform(210.15,489.55,1,1,0,0,0,-265.8,18.5);

	this.instance_9 = new lib.mariposas();
	this.instance_9.setTransform(337.05,370.05,1,1,0,0,0,0.2,-0.5);

	this.instance_10 = new lib.abeja_1();
	this.instance_10.setTransform(189.1,454.2,1,1,0,0,0,-189,-30);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]}).wait(29));

	// interacciones
	this.caperucita = new lib.Caperucita();
	this.caperucita.name = "caperucita";
	this.caperucita.setTransform(762.9,343,1,1,0,0,0,-66.8,67.5);

	this.timeline.addTween(cjs.Tween.get(this.caperucita).wait(29));

	// fondo
	this.instance_11 = new lib.fondo();
	this.instance_11.setTransform(-20,-154,0.5052,0.5118);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#666666").ss(2,1,1).p("APgprIAAIIAx/prIAAIIAhPprIAAIIAvpBkIAAIIASABkIAAIIABdBkIAAII");
	this.shape.setTransform(164.85,568.725);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_11}]}).wait(29));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(573.5,170.5,633.3,479.6);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/fondo.png?1689888374206", id:"fondo"},
		{src:"images/index_atlas_P_1.png?1689888373995", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1689888373996", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1689888373997", id:"index_atlas_P_3"},
		{src:"sounds/Voice7.mp3?1689888374206", id:"Voice7"},
		{src:"sounds/Voice6.mp3?1689888374206", id:"Voice6"},
		{src:"sounds/Voice4.mp3?1689888374206", id:"Voice4"},
		{src:"sounds/BGM.mp3?1689888374206", id:"BGM"},
		{src:"sounds/intro.mp3?1689888374206", id:"intro"},
		{src:"sounds/Voice0.mp3?1689888374206", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1689888374206", id:"Voice1"},
		{src:"sounds/Voice10.mp3?1689888374206", id:"Voice10"},
		{src:"sounds/Voice5.mp3?1689888374206", id:"Voice5"},
		{src:"sounds/Message.mp3?1689888374206", id:"Message"}
	],
	preloads: []
};
