...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,1022,2377,76],[2378,0,443,680],[0,891,2376,129],[0,0,603,889],[605,0,500,500],[605,502,948,208]]},
...
p.nominalBounds = new cjs.Rectangle(-28.2,-70.4,78.5,111.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(594.05,472.2,1.0083,1,0,0,0,593.5,151.2);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:594,regY:219.8,scaleX:1.0042,x:594.55,y:540.8,alpha:0.5},0).wait(1).to({scaleX:1,x:594.5,alpha:1},0).wait(4));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1730077380534", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1730077380534", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1730077380536", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1730077380678", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1730077380678", id:"Voice1"},
		{src:"sounds/BGM.mp3?1730077380678", id:"BGM"},
		{src:"sounds/Voice2.mp3?1730077380678", id:"Voice2"},
		{src:"sounds/intro.mp3?1730077380678", id:"intro"}
	],
	preloads: []
};
