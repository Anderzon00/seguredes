...
lib.ssMetadata = [
		...
		{name:"index_atlas_P_2", frames: [[0,1022,2377,76],[2378,0,443,680],[0,891,2376,129],[0,0,603,889],[605,309,500,500],[1107,309,948,208],[605,0,1181,307]]},
		{name:"index_atlas_P_3", frames: [[0,0,2377,66],[2130,68,80,80],[2212,68,80,80],[1784,68,81,80],[1867,68,81,80],[1701,68,81,81],[1950,68,80,81],[2032,137,79,79],[2294,68,79,80],[1784,150,62,41],[1033,68,201,132],[455,68,243,161],[0,68,213,326],[1236,68,118,195],[2113,150,29,20],[1356,68,136,163],[2710,0,161,274],[700,68,186,205],[1494,68,114,185],[2379,0,329,291],[215,68,238,248],[1885,150,45,23],[1848,150,35,34],[1610,68,89,88],[888,68,143,224],[2032,68,96,67]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.mamafloras();
	this.instance_1.setTransform(48,20,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo5, new cjs.Rectangle(0,0,167,144), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-34,-40.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-34,-40.7,68,81.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamacabelloatras();
	this.instance.setTransform(-28.5,-46.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-28.5,-46.2,57,92.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamabrazoIzq();
	this.instance.setTransform(-46.5,-51.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-46.5,-51.2,93,102.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamasilueta();
	this.instance.setTransform(-150.75,-222.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-150.7,-222.2,301.5,444.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamacabeza();
	this.instance.setTransform(-78.05,-77.25,0.5,0.5,3.2277);
...
p.nominalBounds = new cjs.Rectangle(-86.2,-77.2,172.4,154.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamasonrisa();
	this.instance.setTransform(-22.25,-22,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-22.2,-22,44.5,44);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamaojoIzq();
	this.instance.setTransform(-8.75,-8.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-8.7,-8.5,17.5,17);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.mamaojoDer();
	this.instance.setTransform(-11.25,-5.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-11.2,-5.7,22.5,11.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-47.4,-37.05,0.5,0.5,4.6948);
...
p.nominalBounds = new cjs.Rectangle(-52.8,-37,105.6,74);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.caperucitaflores();
	this.instance.setTransform(-29.5,-48.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-29.5,-48.7,59,97.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.Caperucitasilueta();
	this.instance.setTransform(-110.75,-170,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-110.7,-170,221.5,340);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-61.95,-38.45,0.5,0.5,-1.7086);
...
p.nominalBounds = new cjs.Rectangle(-61.9,-42,123.8,84);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.caparucitaboca();
	this.instance.setTransform(-15.5,-10.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-15.5,-10.2,31,20.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-18,-8,0.5,0.5);

	this.instance_1 = new lib.caperucitaojos();
...
p.nominalBounds = new cjs.Rectangle(-18,-8,33.5,18);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.caperucitacapa();
	this.instance.setTransform(-53.25,-81.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-53.2,-81.5,106.5,163);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.matera();
	this.instance.setTransform(-35.75,-56,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-35.7,-56,71.5,112);
...
(lib.matera_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(237.85,-0.1,1,1,-0.2396,0,0,0.1,-56);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,rotation:-9.2372,x:237.75,y:0},49).to({rotation:21.9597,x:237.8,y:-0.05},89).to({regX:0.1,rotation:-0.2396,x:237.85,y:-0.1},52).wait(1));

	// matera.png
	this.instance_1 = new lib.Interpolación4("synched",0);
	this.instance_1.setTransform(53.9,16.05,1,1,1.0038,0,0,0.2,-45.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0,regY:-46,rotation:-14.9992,x:53.75,y:16},49).to({regX:0.1,rotation:23.4521,x:53.85,y:16.05},89).to({regX:0.2,regY:-45.9,rotation:1.0038,x:53.9},52).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-19.6,-13.4,310.6,137.6);


(lib.interacciones = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-24.75,-153.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:-0.5176,x:-24,y:-154},37).to({rotation:0,x:-24.75,y:-153.5},36).wait(1));

	// caperucita-ojos.png
	this.instance_1 = new lib.Interpolación8("synched",0);
	this.instance_1.setTransform(-64.5,-266);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-66.75},37).to({x:-64.5},36).wait(1));

	// caparucita-boca.png
	this.instance_2 = new lib.Interpolación13("synched",0);
	this.instance_2.setTransform(-70,-244.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-69.25,y:-247.55},37).to({x:-70,y:-244.75},36).wait(1));

	// caperucita-brazoIzq.png
	this.instance_3 = new lib.Interpolación14("synched",0);
	this.instance_3.setTransform(-38.25,-191.05,1,1,0,0,0,61.9,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:14.9992,x:-38.15,y:-191.1},37).to({rotation:0,x:-38.25,y:-191.05},36).wait(1));

	// Caperucita-silueta.png
	this.instance_4 = new lib.Interpolación15("synched",0);
	this.instance_4.setTransform(-7.25,-142);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:0},37).to({startPosition:0},13).to({startPosition:0},23).wait(1));

	// caperucita-flores.png
	this.instance_5 = new lib.Interpolación16("synched",0);
	this.instance_5.setTransform(-140.5,-235.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:-128.75,y:-261.25},37).to({x:-140.5,y:-235.25},36).wait(1));

	// caperucita-brazoDer.png
	this.instance_6 = new lib.Interpolación19("synched",0);
	this.instance_6.setTransform(-50.75,-206.5,1,1,0,0,0,52.8,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:52.6,rotation:18.7319,x:-50.85,y:-206.55},37).to({regX:52.8,rotation:0,x:-50.75,y:-206.5},36).wait(1));

	// mama-ojoDer.png
	this.instance_7 = new lib.Interpolación20("synched",0);
	this.instance_7.setTransform(-267.25,-350.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:-264.85,y:-347.9},37).to({x:-267.25,y:-350.2},36).wait(1));

	// mama-ojoIzq.png
	this.instance_8 = new lib.Interpolación21("synched",0);
	this.instance_8.setTransform(-294.1,-361.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:-292.85,y:-360.8},37).to({x:-294.1,y:-361.9},36).wait(1));

	// mama-sonrisa.png
	this.instance_9 = new lib.Interpolación22("synched",0);
	this.instance_9.setTransform(-290.75,-338);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:-291.2,y:-335},37).to({x:-290.75,y:-338},36).wait(1));

	// mama-cabeza.png
	this.instance_10 = new lib.Interpolación23("synched",0);
	this.instance_10.setTransform(-314.9,-311.4,1,1,-3.212,0,0,9,34);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({rotation:0.9915,x:-315},37).to({rotation:-3.212,x:-314.9},36).wait(1));

	// mama-brazoDer.png
	this.instance_11 = new lib.Símbolo5();
	this.instance_11.setTransform(-338.2,-302,1,1,-8.7451,0,0,17.8,20);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regY:19.9,rotation:-17.6954,x:-338.25,y:-302.1},37).to({regY:20,rotation:-8.7451,x:-338.2,y:-302},36).wait(1));

	// mama-silueta-.png
	this.instance_12 = new lib.Interpolación24("synched",0);
	this.instance_12.setTransform(-287.75,-197.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({startPosition:0},37).to({startPosition:0},36).wait(1));

	// mama-brazoIzq.png
	this.instance_13 = new lib.Interpolación25("synched",0);
	this.instance_13.setTransform(-330,-305.95,1,1,10.6877,0,0,-46.5,-51.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({regX:-46.6,regY:-51.3,rotation:1.9482,x:-330.05,y:-306.1},37).to({regX:-46.5,regY:-51.2,rotation:10.6877,x:-330,y:-305.95},36).wait(1));

	// mama-cabello-atras.png
	this.instance_14 = new lib.Interpolación26("synched",0);
	this.instance_14.setTransform(-259.5,-327.25,1,1,0,0,0,25,-40.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({rotation:3.7051},37).to({rotation:0},36).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-815,-589,1366,768);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(510,155.55,1,1,0,0,0,0,40.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:-14.9992,y:155.5},50).to({rotation:0,y:155.55},42).wait(1));

	// flor.png
	this.instance_1 = new lib.Interpolación52("synched",0);
	this.instance_1.setTransform(437,101.55,1,1,0,0,0,0,40.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0.1,rotation:14.9992,x:437.1,y:101.6},50).to({regX:0,rotation:0,x:437,y:101.55},42).wait(1));

	// flor.png
	this.instance_2 = new lib.Interpolación53("synched",0);
	this.instance_2.setTransform(873,92.55,1,1,0,0,0,0,40.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:14.9992},50).to({rotation:0},42).wait(1));

	// flor.png
	this.instance_3 = new lib.Interpolación54("synched",0);
	this.instance_3.setTransform(873,210.55,1,1,0,0,0,0,40.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:0.1,rotation:-14.9992,x:873.1,y:210.45},50).to({regX:0,rotation:0,x:873,y:210.55},42).wait(1));

	// flor.png
	this.instance_4 = new lib.Interpolación55("synched",0);
	this.instance_4.setTransform(729,92.55,1,1,0,0,0,0,40.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({rotation:14.9992},50).to({rotation:0},42).wait(1));

	// flor.png
	this.instance_5 = new lib.Interpolación56("synched",0);
	this.instance_5.setTransform(772,188.55,1,1,0,0,0,0,40.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.1,rotation:-14.9992,x:772.1,y:188.45},50).to({regX:0,rotation:0,x:772,y:188.55},42).wait(1));

	// flor.png
	this.instance_6 = new lib.Interpolación57("synched",0);
	this.instance_6.setTransform(163,188.55,1,1,0,0,0,0,40.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({rotation:14.9992},50).to({rotation:0},42).wait(1));

	// flor.png
	this.instance_7 = new lib.Interpolación58("synched",0);
	this.instance_7.setTransform(34,81.55,1,1,0,0,0,0,40.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:0.1,rotation:-14.9994,x:34.1},50).to({regX:0,rotation:0,x:34},42).wait(1));

	// tallos
	this.instance_8 = new lib.talloPlanta();
	this.instance_8.setTransform(496,128,0.5,0.5);

	this.instance_9 = new lib.talloPlanta();
	this.instance_9.setTransform(423,74,0.5,0.5);

	this.instance_10 = new lib.talloPlanta();
	this.instance_10.setTransform(859,65,0.5,0.5);

	this.instance_11 = new lib.talloPlanta();
	this.instance_11.setTransform(859,183,0.5,0.5);

	this.instance_12 = new lib.talloPlanta();
	this.instance_12.setTransform(715,65,0.5,0.5);

	this.instance_13 = new lib.talloPlanta();
	this.instance_13.setTransform(758,161,0.5,0.5);

	this.instance_14 = new lib.talloPlanta();
	this.instance_14.setTransform(149,161,0.5,0.5);

	this.instance_15 = new lib.talloPlanta();
	this.instance_15.setTransform(20,54,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]}).wait(93));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-19.9,-6,946.9,225.2);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_3
	this.instance = new lib.mano2();
	this.instance.setTransform(-123.85,16.05,0.3091,0.3091,-179.1147);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(21).to({y:40.05},0).wait(20));
...
p.nominalBounds = new cjs.Rectangle(-278.4,-140.9,156.99999999999997,220.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-16,-194,0.439,0.439);
...
p.nominalBounds = new cjs.Rectangle(-28.2,-194,530.7,235);
...
if (reversed == null) { reversed = false; }
	...
	// materas
	this.matera = new lib.matera_1();
	this.matera.name = "matera";
	this.matera.setTransform(753.8,158.5,1,1,0,0,0,136.8,58.5);

	this.timeline.addTween(cjs.Tween.get(this.matera).wait(6));
	...
	this.instance.setTransform(326,571,0.4184,0.4184);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.prev,p:{x:97.3}},{t:this.next,p:{x:143.1}},{t:this.pressToStart}]}).to({state:[{t:this.playaudio,p:{x:38.65}},{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.pause,p:{x:31.65}},{t:this.prev,p:{x:97.2}},{t:this.next,p:{x:143}}]},1).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance_1},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}},{t:this.nextescene},{t:this.instance}]},4).wait(1));
	...
	this.instance_3.setTransform(616.5,555.3,1,1,0,0,0,-378,43.8);
	...
	this.instance_4.setTransform(594,472.2,1.0083,1,0,0,0,593.5,151.2);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:594,regY:219.8,scaleX:1.0042,x:594.5,y:540.8,alpha:0.5},0).wait(1).to({scaleX:1,x:594.45,alpha:1},0).wait(4));

	// flores
	this.flores = new lib.flores();
	this.flores.name = "flores";
	this.flores.setTransform(482.5,450.2,1,1,0,0,0,453.5,108.2);

	this.timeline.addTween(cjs.Tween.get(this.flores).wait(6));

	// pata
	this.instance_5 = new lib.interacciones();
	this.instance_5.setTransform(682.05,393.8,1,1,0,0,0,-28.2,-152);
	...
	// fondo
	this.instance_6 = new lib.fondoEscena1();
	this.instance_6.setTransform(0,0,0.5008,0.5053);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("AgNAAIAAgCIABgBIAEgGIADgBQAFgCACAAIAEABIACABIADAEIACACIAAADQABAFgDAGIgRADQgEgIgDgFg");
	this.shape_1.setTransform(354.8,380.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.instance_6}]}).wait(6));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(580.8,324.5,630.2,353.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1720202825847", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1720202825847", id:"index_atlas_P_2"},
		{src:"images/index_atlas_P_3.png?1720202825848", id:"index_atlas_P_3"},
		{src:"sounds/Voice0.mp3?1720202826015", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1720202826015", id:"Voice1"},
		{src:"sounds/BGM.mp3?1720202826015", id:"BGM"},
		{src:"sounds/Voice2.mp3?1720202826015", id:"Voice2"},
		{src:"sounds/intro.mp3?1720202826015", id:"intro"}
	],
	preloads: []
};
