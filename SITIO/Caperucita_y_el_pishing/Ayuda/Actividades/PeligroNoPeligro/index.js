...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido1.setTransform(918.7,-183.65,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btn_sonido1, 0, 1, 2);

	this.btn_sonido2 = new lib.btn_sonido();
	this.btn_sonido2.name = "btn_sonido2";
	this.btn_sonido2.setTransform(797.4,-119.45,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.instance.setTransform(793,82.1,0.9999,0.9999,0,-135,45,78.5,72);

	this.btnSiguiente1 = new lib.siguiente();
	this.btnSiguiente1.name = "btnSiguiente1";
	this.btnSiguiente1.setTransform(918.6,30.95,1,1,0,0,0,89,26.2);
	...
	this.btnStopSonido1.setTransform(920.05,-183.65,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido1, 0, 1, 2);

	this.btnAnterior2 = new lib.anterior();
	this.btnAnterior2.name = "btnAnterior2";
	this.btnAnterior2.setTransform(797.2,76.4,1,1,0,0,0,88.8,26.2);
	...
	this.btnStopSonido2.setTransform(798.75,-119.45,1.8208,1.8208,0,0,0,15.8,15.7);
	new cjs.ButtonHelper(this.btnStopSonido2, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1},{t:this.btnSiguiente1},{t:this.instance,p:{regX:78.5,regY:72,scaleX:0.9999,scaleY:0.9999,skewX:-135,skewY:45,x:793,y:82.1}}]}).to({state:[{t:this.btnStopSonido2},{t:this.instance,p:{regX:64.9,regY:63.9,scaleX:1,scaleY:1,skewX:-165.0008,skewY:14.9992,x:494.75,y:128.7}},{t:this.btnAnterior2}]},1).wait(1));

	// cerrar
	this.btnCerrar1 = new lib.cerrar();
	this.btnCerrar1.name = "btnCerrar1";
	this.btnCerrar1.setTransform(1214,-178.7,1,1,0,0,0,30.8,30.8);
	new cjs.ButtonHelper(this.btnCerrar1, 0, 1, 2);

	this.btnCerrar2 = new lib.cerrar();
	this.btnCerrar2.name = "btnCerrar2";
	this.btnCerrar2.setTransform(1061.9,-114.5,1,1,0,0,0,30.8,30.8);
	...
	this.instance_1.setTransform(645,-148,0.5,0.5);

	this.instance_2 = new lib._2_4();
	this.instance_2.setTransform(574,-65,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},1).wait(1));

	// cuadro
	this.instance_3 = new lib.FondoTexto();
	this.instance_3.setTransform(607,-189,0.4587,0.5001);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({scaleX:0.4116,scaleY:0.4917,x:518,y:-125},0).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8rMAAAh3/MCGeAAAIAAhWIB/AEQBmADDKAAIahADIAoAHQApAJBnAaQBcAYA1AJIAEABMAogAAAMAAAB3/gEg9agYIIAAfPQAADIDIAAMBR2AAAQDIAAAAjIIAA/PQAAjIjIAAMhR2AAAQjIAAAADIg");
	this.shape.setTransform(577.1,103.825);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.698)").s().p("");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1722461542529", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1722461542574", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1722461542574", id:"ayuda2"}
	],
	preloads: []
};
