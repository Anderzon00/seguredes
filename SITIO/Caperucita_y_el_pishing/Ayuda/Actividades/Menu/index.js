...
(lib.screencapturemasterd2ovn6qahf2n97amplifyapp2024042018_04_28 = function() {
	this.initialize(ss["index_atlas_P_1"]);
	this.gotoAndStop(12);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido2.setTransform(-272.85,151.95,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.btnAnterior2.setTransform(-378.3,378.8,1,1,0,0,0,88.8,26.2);
	new cjs.ButtonHelper(this.btnAnterior2, 0, 1, 2);

	this.btnSiguiente2 = new lib.siguiente();
	this.btnSiguiente2.name = "btnSiguiente2";
	this.btnSiguiente2.setTransform(-168.95,378.8,1,1,0,0,0,89,26.2);
	...
	this.btnStopSonido2.setTransform(-271.5,151.95,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnStopSonido1},{t:this.btnSiguiente1},{t:this.instance,p:{regX:64.9,skewX:0,skewY:0,x:-602.8,y:273.15,regY:63.9,rotation:0}}]}).to({state:[{t:this.btnStopSonido2},{t:this.btnSiguiente2},{t:this.instance,p:{regX:65,skewX:-157.7594,skewY:22.2406,x:-624.45,y:436.3,regY:63.9,rotation:0}},{t:this.btnAnterior2}]},1).to({state:[{t:this.btnStopSonido3},{t:this.instance,p:{regX:129.8,skewX:0,skewY:0,x:-601.2,y:328.6,regY:127.7,rotation:-165.0008}},{t:this.btnAnterior3}]},1).wait(1));
	...
	this.btnCerrar2.setTransform(51.05,156.9,1,1,0,0,0,30.8,30.8);
	...
	this.instance_2.setTransform(-525,199,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({scaleY:0.5527,x:-612,y:145},0).wait(1).to({scaleY:0.4531,x:-704,y:119},0).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.698)").s().p("");
	this.shape.setTransform(-456,324.95);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.698)").s().p("EhqtA8GMAAAh3/MCoxAAAIAAACIFkgCIAAAAIdAgMIAqAMIJcAAMAAAB3/gEgq9AUhQhEBKAABqQAABqBEBKQBFBMBggBQBhABBEhMQBEhKgBhqQABhqhEhKQhEhMhhABQhggBhFBMgEBengzqIvGACIg5ABIQtAAIAAgDIguAAg");
	this.shape_1.setTransform(-459,320.45);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.698)").s().p("");
	this.shape_2.setTransform(-459,320.45);
...
p.nominalBounds = new cjs.Rectangle(-1142,-64.2,1369,773.8000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.ayuda.setTransform(1142,63.6,1,0.9983);

	this.timeline.addTween(cjs.Tween.get(this.ayuda).wait(1));

	// Capa_1
	this.instance = new lib.screencapturemasterd2ovn6qahf2n97amplifyapp2024042018_04_28();
...
p.nominalBounds = new cjs.Rectangle(683,384,686,388);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1722461558675", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1722461558727", id:"ayuda1"},
		{src:"sounds/ayuda2.mp3?1722461558727", id:"ayuda2"},
		{src:"sounds/ayuda3.mp3?1722461558727", id:"ayuda3"},
		{src:"sounds/ayuda4.mp3?1722461558727", id:"ayuda4"},
		{src:"sounds/ayuda5.mp3?1722461558727", id:"ayuda5"}
	],
	preloads: []
};
