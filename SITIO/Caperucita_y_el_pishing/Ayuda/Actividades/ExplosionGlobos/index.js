...
if (reversed == null) { reversed = false; }
	...
	this.btn_sonido1.setTransform(861.55,-53.35,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.instance.setTransform(528.3,116.7,0.9999,0.9999,-89.9983,0,0,78.5,72);

	this.btnStopSonido1 = new lib.btnStopSonido();
	this.btnStopSonido1.name = "btnStopSonido1";
	this.btnStopSonido1.setTransform(862.9,-53.35,1.8208,1.8208,0,0,0,15.8,15.7);
	...
	this.btnCerrar1.setTransform(1150.65,-40.7,1,1,0,0,0,30.8,30.8);
	...
	this.instance_1.setTransform(584,-10,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// cuadro
	this.instance_2 = new lib.FondoTexto();
	this.instance_2.setTransform(553,-59,0.4541,0.4567);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// transparencia_copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.698)").s().p("");
	this.shape.setTransform(614.386,103.825);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ayuda, new cjs.Rectangle(-105.9,-284.4,1440.6000000000001,776.5), null);
...
p.nominalBounds = new cjs.Rectangle(683,375.5,757.5999999999999,392.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1722461177355", id:"index_atlas_P_1"},
		{src:"sounds/ayuda1.mp3?1722461177390", id:"ayuda1"}
	],
	preloads: []
};
