...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[0,0,2765,1134]]},
		{name:"index_atlas_P_2", frames: [[460,218,2377,64],[2745,498,80,80],[460,131,2377,85],[2615,499,80,80],[460,284,2377,64],[2745,416,81,80],[2532,470,81,80],[460,350,2377,64],[2662,416,81,81],[1824,496,80,81],[2118,513,79,79],[2037,513,79,80],[2037,416,97,95],[2136,416,97,95],[2235,416,97,95],[2334,416,97,95],[1606,416,107,103],[2433,416,97,95],[2838,0,42,58],[725,416,278,157],[1005,416,237,140],[460,416,263,430],[2838,60,24,24],[1497,416,107,118],[1824,416,140,78],[2864,60,14,10],[0,0,458,751],[2532,416,128,52],[1966,416,69,142],[460,0,2376,129],[1715,416,107,103],[1244,416,251,119]]}
];
...
(lib.BMP_550c9f25_00eb_410d_8dfc_fe4a80e9f897 = function() {
	this.initialize(ss["index_atlas_P_2"]);
	this.gotoAndStop(14);
}).prototype = p = new cjs.Sprite();
...
(lib.caperucitacelularnotificacion = function() {
	this.initialize(ss["index_atlas_P_2"]);
	this.gotoAndStop(23);
}).prototype = p = new cjs.Sprite();
...
}).prototype = getMCSymbolPrototype(lib.texto3mc, new cjs.Rectangle(-972,26,1188.5,32), null);
...
}).prototype = getMCSymbolPrototype(lib.texto2mc, new cjs.Rectangle(-972,26,1188.5,42.5), null);
...
p.nominalBounds = new cjs.Rectangle(-594,-17.7,1188.5,32);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-59.25,-35,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-59.2,-35,118.5,70);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-114.5,-187.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-114.5,-187.7,229,375.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-65.75,-107.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-65.7,-107.5,131.5,215);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-10.5,-14.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-10.5,-14.5,21,29);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.caperucitaojo();
	this.instance.setTransform(-3.5,-2.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-3.5,-2.5,7,5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-6,-6,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.caperucitacelularnotificacion();
	this.instance.setTransform(-26.75,-29.5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-26.7,-29.5,53.5,59);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(1082.5,85,0.3167,0.3167,0,0,180);
	...
	this.instance_10.setTransform(-74.5,83,0.3167,0.3167,0,0,180);
...
p.nominalBounds = new cjs.Rectangle(-354,42,2245.5,80.7);
...
(lib.celularybrazoderecho = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(83,30,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.celularybrazoderecho, new cjs.Rectangle(0,-4,153,78.5), null);
...
}).prototype = getMCSymbolPrototype(lib.texto1mc, new cjs.Rectangle(-775,12,1188.5,32), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.BMP_550c9f25_00eb_410d_8dfc_fe4a80e9f897();
	this.instance_1.setTransform(3.1,6.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(7.45,34.4,0.5,0.5,0,0,0,53.5,51.5);

	this.instance_1 = new lib.PuppetShape_1copiacopia2("synched",1,false);
	this.instance_1.setTransform(-213.25,45.75,0.5,0.5,0,0,0,53.5,51.5);

	this.instance_2 = new lib.mariposa();
	this.instance_2.setTransform(235,-7,0.5,0.5);

	this.instance_3 = new lib.mariposa();
	this.instance_3.setTransform(-388,6,0.5,0.5);

	this.instance_4 = new lib.PuppetShape_1copiacopia3("synched",1,false);
	this.instance_4.setTransform(262.75,17.75,0.5,0.5,0,0,0,53.5,51.5);

	this.instance_5 = new lib.PuppetShape_1copia("synched",1,false);
	this.instance_5.setTransform(-359.25,30.75,0.5,0.5,0,0,0,53.5,51.5);

	this.instance_6 = new lib.PuppetShape_1("synched",1,false);
	this.instance_6.setTransform(-359.25,30.75,0.5,0.5,0,0,0,53.5,51.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3,p:{x:-388,y:6}},{t:this.instance_2,p:{x:235,y:-7}},{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3,p:{x:-239,y:19}},{t:this.instance_2,p:{x:-19,y:9}}]},14).wait(14));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-388,-7,676.5,77.7);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_28 = function() {
		playSound("notificationsound7062");
	}
	this.frame_78 = function() {
		...
		_this.gotoAndPlay(36);
	}

	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(28).call(this.frame_28).wait(50).call(this.frame_78).wait(34));

	// caperucita-celular-notificacion.png
	this.instance = new lib.Interpolación1("synched",0);
	this.instance.setTransform(22.75,-63.35);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(25).to({_off:false},0).to({alpha:1},11).to({y:-69.35},9).to({y:-63.35},8).to({y:-69.35},8).to({y:-63.35},8).to({startPosition:0},9).to({_off:true},1).wait(33));

	// caperucita-ceja.png
	this.instance_1 = new lib.Interpolación4("synched",0);
	this.instance_1.setTransform(-63,-88);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},24).to({x:-62,y:-89.15},33).to({x:-63,y:-88},21).to({startPosition:0},33).wait(1));

	// caperucita-ojo.png
	this.instance_2 = new lib.Interpolación5("synched",0);
	this.instance_2.setTransform(-65.5,-81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},24).to({x:-65,y:-82},33).to({x:-65.5,y:-81.5},21).to({startPosition:0},33).wait(1));

	// caperucita-boca.png
	this.instance_3 = new lib.Interpolación6("synched",0);
	this.instance_3.setTransform(-73.6,-61.8,1,1,0,0,0,8.9,13.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({startPosition:0},24).to({scaleY:1.0536},33).to({scaleY:1},21).to({startPosition:0},33).wait(1));

	// caperucita-capa.png
	this.instance_4 = new lib.Interpolación7("synched",0);
	this.instance_4.setTransform(-119.25,41.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:0},24).to({startPosition:0},54).to({startPosition:0},33).wait(1));

	// Caperucita-brazoDer.png
	this.instance_5 = new lib.celularybrazoderecho();
	this.instance_5.setTransform(-112.5,-26.8,1,1,0,0,0,11.5,9.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({rotation:-14.9992,y:-26.75},24).wait(54).to({rotation:0,y:-26.8},33).wait(1));

	// caperucita-silueta.png
	this.instance_6 = new lib.Interpolación8("synched",0);
	this.instance_6.setTransform(-41.5,44.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({startPosition:0},24).to({startPosition:0},33).to({startPosition:0},21).to({startPosition:0},33).wait(1));

	// caperucita-brazoIzq.png
	this.instance_7 = new lib.Interpolación9("synched",0);
	this.instance_7.setTransform(-112.55,-26.8,1,1,0,0,0,-47.8,-9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({rotation:-14.9992,y:-26.75},24).to({startPosition:0},54).to({rotation:0,y:-26.8},33).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-185,-143,258,375.5);
...
p.nominalBounds = new cjs.Rectangle(-1577.4,-31,3406.8,80.7);
...
if (reversed == null) { reversed = false; }
	...
	// timeline functions:
	this.frame_0 = function() {
		//Sound Effect from <a href="https://pixabay.com/?utm_source=link-attribution&amp;utm_medium=referral&amp;utm_campaign=music&amp;utm_content=7062">Pixabay</a>
	...
	this.btnInteraccion.setTransform(666.6,285.15,1,1,0,0,0,-21.1,7.5);
	this.btnInteraccion._off = true;
	new cjs.ButtonHelper(this.btnInteraccion, 0, 1, 2, false, new lib.btnInteractivo(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btnInteraccion).wait(6).to({_off:false},0).wait(1).to({y:284.15},0).wait(1));

	// Capa_1 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(592.15,47.6);

	// nubes y mariposas
	this.instance = new lib.nubes();
	this.instance.setTransform(947.15,134.5,1,1,0,0,0,519.5,97.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.prev,p:{x:97.3}},{t:this.next,p:{x:143.1}},{t:this.pressToStart}]}).to({state:[{t:this.playaudio,p:{x:38.65}},{t:this.muteMC,p:{x:308.5}},{t:this.unmuteMC,p:{x:308.5}},{t:this.pause,p:{x:31.65}},{t:this.prev,p:{x:97.2}},{t:this.next,p:{x:143}}]},1).to({state:[{t:this.playaudio,p:{x:38.7}},{t:this.instance_1},{t:this.muteMC,p:{x:308.35}},{t:this.unmuteMC,p:{x:308.35}},{t:this.pause,p:{x:31.7}},{t:this.prev,p:{x:97.35}},{t:this.next,p:{x:143.15}},{t:this.nextescene}]},6).wait(1));

	// Capa_2
	this.instance_2 = new lib.texto1mc();
	this.instance_2.setTransform(773.25,500);

	this.instance_3 = new lib.texto3mc();
	this.instance_3.setTransform(971.25,484.35);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_3}]},2).wait(4));

	// textos
	this.instance_4 = new lib.texto2mc();
	this.instance_4.setTransform(593.25,553.8,1,1,0,0,0,-378,43.8);

	this.instance_5 = new lib._4();
	this.instance_5.setTransform(-1,537,0.5,0.5);
	...
	this.instance_6.setTransform(594,472.2,1,1,0,0,0,594,151.2);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({regY:219.8,y:540.8,alpha:0.5},0).wait(1).to({x:594.05,y:540.85,alpha:1},0).wait(6));

	// caperucita
	this.caperucita = new lib.caperucita();
	this.caperucita.name = "caperucita";
	this.caperucita.setTransform(547.55,342.1,1,1,0,0,0,-56,44.8);

	this.timeline.addTween(cjs.Tween.get(this.caperucita).wait(8));

	// mariposas
	this.instance_7 = new lib.mariposas();
	this.instance_7.setTransform(542.55,402.2,1,1,0,0,0,-49.8,31.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(8));

	// fondo
	this.instance_8 = new lib.Cesped();
	this.instance_8.setTransform(666,509,0.5,0.5);

	this.instance_9 = new lib.flor1();
	this.instance_9.setTransform(710.45,459.75,0.5,0.5,0,6.7494,-173.2506);

	this.instance_10 = new lib.flor1();
	this.instance_10.setTransform(735.5,461.65,0.5,0.5,0,14.9985,-165.0015);

	this.instance_11 = new lib.flor1();
	this.instance_11.setTransform(652,458.15,0.5,0.5,-14.9985);

	this.instance_12 = new lib.fondo1();
	this.instance_12.setTransform(-56,-4,0.5058,0.5096);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#666666").ss(2,1,1).p("Aw8kEIAAIHAASkCIAAIHAQ9kEIAAIH");
	this.shape.setTransform(170.325,607.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("AgNAAIAAgBIABgCIAEgGIADgBQAFgBACAAIAEAAIACABIAEAEIABACIABADQAAAEgDAHIgRADQgFgIgCgFg");
	this.shape_1.setTransform(349.925,363.85);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]}).wait(8));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(537.5,320.5,805.0999999999999,314.29999999999995);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1689887232436", id:"index_atlas_P_1"},
		{src:"images/index_atlas_P_2.png?1689887232437", id:"index_atlas_P_2"},
		{src:"sounds/Voice0.mp3?1689887232579", id:"Voice0"},
		{src:"sounds/Voice1.mp3?1689887232579", id:"Voice1"},
		{src:"sounds/Voice2.mp3?1689887232579", id:"Voice2"},
		{src:"sounds/Voice3.mp3?1689887232579", id:"Voice3"},
		{src:"sounds/Voice4.mp3?1689887232579", id:"Voice4"},
		{src:"sounds/intro.mp3?1689887232579", id:"intro"},
		{src:"sounds/notificationsound7062.mp3?1689887232579", id:"notificationsound7062"},
		{src:"sounds/BGM.mp3?1689887232579", id:"BGM"}
	],
	preloads: []
};
