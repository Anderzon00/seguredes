...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:14.9983},35).to({rotation:0},39).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({rotation:-14.9983},35).to({rotation:0},39).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.btnStopSonido3.setTransform(320.2,646.7);
	...
	this.instance_1.setTransform(282,0,0.5,0.5);
	...
	this.instance_4.setTransform(378,820,0.5,0.5);

	this.instance_5 = new lib.Diapositiva1texto2();
	this.instance_5.setTransform(357,287,0.543,0.5);
...
p.nominalBounds = new cjs.Rectangle(586,487,439.29999999999995,474.9);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/iframe_atlas_1.png?1721426491172", id:"iframe_atlas_1"},
		{src:"sounds/audio1.mp3?1721426491251", id:"audio1"},
		{src:"sounds/audio2.mp3?1721426491251", id:"audio2"},
		{src:"sounds/audio3.mp3?1721426491251", id:"audio3"},
		{src:"sounds/audio4.mp3?1721426491251", id:"audio4"}
	],
	preloads: []
};
