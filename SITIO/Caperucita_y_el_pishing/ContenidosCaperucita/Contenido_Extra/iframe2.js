...
lib.ssMetadata = [
		{name:"iframe2_atlas_1", frames: [[0,399,1442,372],[1780,0,63,63],[1845,0,60,60],[1404,0,374,374],[1444,750,499,215],[1437,1184,271,38],[1710,1184,271,38],[1437,1224,271,38],[1444,967,499,215],[0,1147,1435,355],[1444,376,372,372],[0,0,1402,397],[0,1504,1400,291],[0,773,1442,372]]}
];
...
(lib.borde = function() {
	this.initialize(ss["iframe2_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.iframe2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
