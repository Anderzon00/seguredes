...
if (reversed == null) { reversed = false; }
	...
	this.interaccion.setTransform(95.9,172.5,0.5,0.5,0,0,0,12,190);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		window.parent.document.getElementById('mi_iframe').src = './Ayuda/Contenidos/C2/index.html';
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_1.png?1723345901077", id:"index_atlas_1"},
		{src:"sounds/CLOCKTick_Stopwatch2_ID2138_BSB.mp3?1723345901160", id:"CLOCKTick_Stopwatch2_ID2138_BSB"},
		{src:"sounds/sound.mp3?1723345901160", id:"sound"}
	],
	preloads: []
};
