...
if (reversed == null) { reversed = false; }
	...
	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(51,51,51,0.91)").s().p("EhesAoQMAAAhQfMC9ZAAAMAAABQfg");
	this.shape.setTransform(68.1,100.05);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/index_atlas_P_1.png?1686888032843", id:"index_atlas_P_1"},
		{src:"sounds/drop.mp3?1686888033052", id:"drop"},
		{src:"sounds/error.mp3?1686888033052", id:"error"},
		{src:"sounds/win.mp3?1686888033052", id:"win"},
		{src:"sounds/SoundBoton.mp3?1686888033052", id:"SoundBoton"},
		{src:"sounds/sound.mp3?1686888033052", id:"sound"},
		{src:"sounds/retroalimentacion.mp3?1686888033052", id:"retroalimentacion"}
	],
	preloads: []
};
