...
lib.ssMetadata = [
		{name:"indexOriginal_atlas_1", frames: [[1245,600,286,85],[1245,513,287,85],[1349,777,27,10],[1349,764,33,11],[1349,789,25,9],[1245,791,27,8],[947,802,604,397],[1553,1030,434,339],[1672,0,368,243],[0,1063,440,137],[1245,0,425,511],[1553,513,388,515],[442,1063,382,25],[1349,687,37,75],[1245,687,102,102],[0,0,1243,800],[0,802,945,259]]}
];
...
(lib.btnIndiceContenidosHover = function() {
	this.initialize(ss["indexOriginal_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.indexOriginal = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/indexOriginal_atlas_1.png?1677698223006", id:"indexOriginal_atlas_1"},
		{src:"sounds/generales.mp3?1677698223086", id:"generales"},
		{src:"sounds/indice.mp3?1677698223086", id:"indice"},
		{src:"sounds/QuestionSoundEffect.mp3?1677698223086", id:"QuestionSoundEffect"}
	],
	preloads: []
};
